        ...
        return (
            <section
                className={classNames('section', 'hero', {
                    ...
                    'inverse bg-blue': _.get(section, 'has_background', null) && background_color === 'blue',
                    'bg-gray': _.get(section, 'has_background', null) && background_color === 'gray',
                    'section--padding': _.get(section, 'has_background', null) || _.get(section, 'image', null)
                })}
            >
                ...
                <div className="container container--lg">
                    ...
                    >
                        {_.get(section, 'image', null) && (
                            <div
                                className={classNames('cell', 'section__media', {
                                    'section__media--right': _.get(section, 'image_position', null) === 'right'
                                })}
                            >
                        ...
                        <div className="cell section__body">
                            {_.get(section, 'title', null) && <h1 className="section__title">{_.get(section, 'title', null)}</h1>}
