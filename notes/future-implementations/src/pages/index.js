...
export default function IndexPage({ data }) {
    ...
    return (
        <>
            ...
            <PageBody>
                <Img fixed={janosh.img.fixed} css="border-radius: 50%; justify-self: center;" />
...
export const query = graphql`
    {
        ...
        posts: allMdx(filter: { fileAbsolutePath: { regex: "/posts/" } }, sort: { fields: frontmatter___date, order: DESC }, limit: 5) {
            nodes {
                ...page
            }
        }
