...
import { Atom, Brain, ChalkboardTeacher, Database, Robot, ToggleOff, ToggleOn } from 'styled-icons/fa-solid';
...
export const Tag = styled.button`
    ...
    font-weight: 300;
    border-radius: 0.2em;
    background: ${(p) => (p.active ? `var(--color-a)` : `var(--color-accentBackground)`)};
    ${mediaQueries.maxPhablet} {
