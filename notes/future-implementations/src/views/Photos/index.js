...
export default function Photos({ tab, photos, modal, setModal }) {
    ...
    return (
        <>
            ...
            <Modal open={currentPhoto} {...{ modal, setModal }} fullScreenDefault showArrows css="background: black; overflow: hidden;">
                <Img alt={currentPhoto.caption} fluid={currentPhoto.fluid} imgStyle={{ objectFit: `contain` }} css="height: 100%;" />
                <Caption>
