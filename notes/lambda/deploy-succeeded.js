                        ...
                        (c.request = function (e, o) {
                            return (
                                'string' == typeof e
                                    ...
                                    : (e = Object.assign({ protocol: s, maxRedirects: t.maxRedirects, maxBodyLength: t.maxBodyLength }, e)),
                                (e.nativeProtocols = r),
            ...
            t.handler = async (e) => {
                try {
                    ...
                    return n && 'ready' === r && 'production' === s
                        ...
                        : (console.log('Conditions not met, not submitting'), { statusCode: 200, body: 'Conditions not met, not submitting' });
                } catch (e) {
                ...
                return new Promise(function (t, r) {
                    ...
                    if (!S && !1 !== S) {
                        ...
                        if (T) {
                            ...
                            if (q && ((S = { host: k.hostname, port: k.port }), k.auth)) {
                                var L = k.auth.split(':');
                    ...
                    var M = j.request(A, function (t) {
                        if (!M.aborted) {
                            ...
                            var n = t.req || M,
                                s = { status: t.statusCode, statusText: t.statusMessage, headers: t.headers, config: e, request: n };
