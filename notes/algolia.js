        ...
        return (() => {
            var e = {
                    948: (e, t, r) => {
                        ...
                        r.r(t), r.d(t, { autocomplete: () => br, getAlgoliaFacets: () => Rr, getAlgoliaResults: () => Lr });
                        var p = 0;
                        function f() {
                            ...
                            var t = e
                                .reduce(function (e, t) {
                                    ...
                                    if (o) {
                                        ...
                                        var a = { execute: n, items: u, searchClient: r };
                                        e.push(a);
                                    }
                                    return e;
                                }, [])
                                                                  ...
                                                                  null === (t = e.hits) || void 0 === t
                                                                      ...
                                                                      : t.map(function (t) {
                                                                            return F(
                                                                                F({}, t),
                                                                                {},
                                                                                { __autocomplete_indexName: e.index, __autocomplete_queryID: e.queryID }
                                                                            );
                                                                        })
                                                          }
                                                      );
                        ...
                        function z(e) {
                            ...
                            return (
                                ...
                                $(
                                    u.getSources(M({ query: o, refresh: a, state: c.getState() }, l)).then(function (e) {
                                        return Promise.all(
                                            e.map(function (e) {
                                                return Promise.resolve(e.getItems(M({ query: o, refresh: a, state: c.getState() }, l))).then(function (t) {
                                            ...
                                            .then(function (e) {
                                                return (function (e) {
                                                    ...
                                                    return i(r.reshape({ sources: Object.values(u), sourcesBySourceId: u, state: n }))
                                                        .filter(Boolean)
                                                        .map(function (e) {
                                                            return { source: e, items: e.getItems() };
                                                        });
                                                })({ collections: e, props: u, state: c.getState() });
                                            });
                                    })
                                )
                                    .then(function (e) {
                                        ...
                                        if (null !== c.getState().activeItemId && f) {
                                            var d = f.item,
                                                ...
                                                h = f.itemUrl,
                                                D = f.source;
                                            D.onActive(M({ event: t, item: d, itemInputValue: v, itemUrl: h, refresh: a, source: D, state: c.getState() }, l));
                                        }
                                    })
                                    .finally(function () {
                                        Q && u.environment.clearTimeout(Q);
                        ...
                        function le(e) {
                            ...
                            return {
                                        ...
                                        ie(
                                            {
                                                ...
                                                onSubmit: function (o) {
                                                    var i;
                                                    o.preventDefault(),
                                                        t.onSubmit(ie({ event: o, refresh: r, state: n.getState() }, u)),
                                                ...
                                                onReset: function (o) {
                                                    var i;
                                                    o.preventDefault(),
                                                        t.onReset(ie({ event: o, refresh: r, state: n.getState() }, u)),
                                ...
                                getLabelProps: function (e) {
                                    return ie({ htmlFor: ''.concat(t.id, '-input'), id: ''.concat(t.id, '-label') }, e);
                                },
                                getInputProps: function (e) {
                                    function o(e) {
                                        (t.openOnFocus || Boolean(n.getState().query)) &&
                                            z(ie({ event: e, props: t, query: n.getState().completion || n.getState().query, refresh: r, store: n }, u)),
                                    ...
                                    return ie(
                                        {
                                            ...
                                            type: 'search',
                                            onChange: function (e) {
                                                z(ie({ event: e, props: t, query: e.currentTarget.value.slice(0, l), refresh: r, store: n }, u));
                                            },
                                            onKeyDown: function (e) {
                                                    ...
                                                    if ('ArrowUp' === t.key || 'ArrowDown' === t.key) {
                                                        ...
                                                        t.preventDefault(),
                                                            !1 === u.getState().isOpen && (r.openOnFocus || Boolean(u.getState().query))
                                                                ? z(X({ event: t, props: r, query: u.getState().query, refresh: n, store: u }, o)).then(
                                                                      function () {
                                                                          u.dispatch(t.key, { nextActiveItemId: r.defaultActiveItemId }), a(), setTimeout(i, 0);
                                                                      }
                                                                  )
                                                        ...
                                                        if (t.metaKey || t.ctrlKey)
                                                            void 0 !== p &&
                                                                ...
                                                                r.navigator.navigateNewTab({ itemUrl: p, item: l, state: u.getState() }));
                                                        else if (t.shiftKey)
                                                            void 0 !== p &&
                                                                (f.onSelect(
                                                                    X(
                                                                ...
                                                                r.navigator.navigateNewWindow({ itemUrl: p, item: l, state: u.getState() }));
                                                        else if (t.altKey);
                                                        else {
                                                            if (void 0 !== p)
                                                                return (
                                                                    ...
                                                                    void r.navigator.navigate({ itemUrl: p, item: l, state: u.getState() })
                                                                );
                                                            z(X({ event: t, nextState: { isOpen: !1 }, props: r, query: s, refresh: n, store: u }, o)).then(
                                                                function () {
                                                                    f.onSelect(
                                                                        X(
                                                                            {
                                                ...
                                                })(ie({ event: e, props: t, refresh: r, store: n }, u));
                                            },
                                            onFocus: o,
                                            onBlur: function () {
                                ...
                                getListProps: function (e) {
                                    return ie({ role: 'listbox', 'aria-labelledby': ''.concat(t.id, '-label'), id: ''.concat(t.id, '-list') }, e);
                                },
                                    ...
                                    return ie(
                                        {
                                            ...
                                            onClick: function (e) {
                                                var a = i.getItemInputValue({ item: o, state: n.getState() }),
                                                    c = i.getItemUrl({ item: o, state: n.getState() });
                                                (c
                                                    ? Promise.resolve()
                                                    : z(ie({ event: e, nextState: { isOpen: !1 }, props: t, query: a, refresh: r, store: n }, u))
                                                ).then(function () {
                                                    i.onSelect(
                                                        ie({ event: e, item: o, itemInputValue: a, itemUrl: c, refresh: r, source: i, state: n.getState() }, u)
                                                    );
                                                });
                                            }
                                        },
                        ...
                        var se = '1.5.0',
                            pe = [{ segment: 'autocomplete-core', version: se }];
                        function fe(e, t) {
                            var r = Object.keys(e);
                            if (Object.getOwnPropertySymbols) {
                                var n = Object.getOwnPropertySymbols(e);
                        ...
                        function ve(e) {
                            ...
                            return {
                                ...
                                options: de({ 'autocomplete-core': Object.keys(i) }, c),
                        ...
                        var _e = function (e, t) {
                            switch (t.type) {
                                ...
                                case 'setQuery':
                                    return ge(ge({}, e), {}, { query: t.payload, completion: null });
                                case 'setCollections':
                                ...
                                case 'setContext':
                                    return ge(ge({}, e), {}, { context: ge(ge({}, e.context), t.payload) });
                                case 'ArrowDown':
                                    var r = ge(
                                        ge({}, e),
                                        {},
                                ...
                                case 'ArrowUp':
                                    var n = ge(ge({}, e), {}, { activeItemId: De(-1, e.activeItemId, s(e), t.props.defaultActiveItemId) });
                                    return ge(ge({}, n), {}, { completion: he({ state: n }) });
                                case 'Escape':
                                    return e.isOpen
                                        ? ge(ge({}, e), {}, { activeItemId: null, isOpen: !1, completion: null })
                                        : ge(ge({}, e), {}, { activeItemId: null, query: '', status: 'idle', collections: [] });
                                case 'submit':
                                    return ge(ge({}, e), {}, { activeItemId: null, isOpen: !1, status: 'idle' });
                                case 'reset':
                                    return ge(
                                        ge({}, e),
                                        {},
                                        { activeItemId: !0 === t.props.openOnFocus ? t.props.defaultActiveItemId : null, status: 'idle', query: '' }
                                    );
                                case 'focus':
                                    return ge(
                                        ge({}, e),
                                ...
                                case 'blur':
                                    return t.props.debug ? e : ge(ge({}, e), {}, { isOpen: !1, activeItemId: null });
                                case 'mousemove':
                                    return ge(ge({}, e), {}, { activeItemId: t.payload });
                                case 'mouseleave':
                                    return ge(ge({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
                                default:
                        ...
                        function Ce(e) {
                            var t = [],
                                ...
                                n = o(_e, r, function (e) {
                                    var t = e.prevState,
                                        n = e.state;
                                    r.onStateChange(Ae({ prevState: t, state: n, refresh: l }, u));
                                }),
                                u = (function (e) {
                                    var t = e.store;
                                    return {
                                                    ...
                                                    return c(
                                                        ...
                                                        {},
                                                        {
                                                            items: i(e.items).map(function (e) {
                                                                return c(c({}, e), {}, { __autocomplete_id: r++ });
                                                            })
                                                        }
                                                    );
                                                });
                                ...
                                a = le(Ae({ props: r, refresh: l, store: n }, u));
                            function l() {
                                return z(
                                    Ae(
                                        {
                            ...
                            return (
                                ...
                                })({ metadata: ve({ plugins: r.plugins, options: e }), environment: r.environment }),
                                Ae(Ae({ refresh: l }, a), u)
                            );
                        }
                        function Fe(e) {
                        ...
                        function Ge(e) {
                            var t = e.autocomplete,
                                ...
                                p = e.translations,
                                f = Ue(u),
                                d = c.getRootProps(ze({ state: s, props: t.getRootProps({}) }, r)),
                                m = f('div', ze({ class: n.root }, d)),
                                v = f('div', {
                                ...
                                D = c.getLabelProps(ze({ state: s, props: t.getLabelProps({}) }, r)),
                                y = f('button', { class: n.submitButton, type: 'submit', title: p.submitButtonTitle, children: [je({ environment: u })] }),
                                g = f('label', ze({ class: n.label, children: [y] }, D)),
                                b = f('button', { class: n.clearButton, type: 'reset', title: p.clearButtonTitle, children: [we({ environment: u })] }),
                                _ = f('div', { class: n.loadingIndicator, children: [Se({ environment: u })] }),
                                O = (function (e) {
                                    var t = e.autocompleteScopeApi,
                                        ...
                                        a = Qe(e, He),
                                        c = Ue(r)('input', a),
                                        l = n(Ve({ state: i, props: u({ inputElement: c }), inputElement: c }, t));
                                    return (
                                        Ne(
                                            c,
                                            Ve(
                                ...
                                A = f('div', { class: n.inputWrapperPrefix, children: [g, _] }),
                                E = f('div', { class: n.inputWrapperSuffix, children: [b] }),
                                C = f('div', { class: n.inputWrapper, children: [O] }),
                                F = c.getFormProps(ze({ state: s, props: t.getFormProps({ inputElement: O }) }, r)),
                                P = f('form', ze({ class: n.form, children: [A, C, E] }, F)),
                                j = c.getPanelProps(ze({ state: s, props: t.getPanelProps({}) }, r)),
                                w = f('div', ze({ class: n.panel }, j));
                            if (o) {
                                var S = f('div', { class: n.detachedSearchButtonIcon, children: [je({ environment: u })] }),
                                    B = f('div', { class: n.detachedSearchButtonPlaceholder, textContent: a }),
                                    I = f('button', {
                                    ...
                                    x = f('div', { class: n.detachedFormContainer, children: [P, k] });
                        ...
                        function Wt(e) {
                            return e.some(function (e) {
                                ...
                                ? e.map(function (t, r) {
                                      return Ut(Ut({}, t), {}, { isHighlighted: !Lt(e, r) });
                                  })
                                : e.map(function (e) {
                                      return Ut(Ut({}, e), {}, { isHighlighted: !1 });
                                  });
                        }
                        function Vt(e) {
                            ...
                            return function (e) {
                                ...
                                return t(
                                    r,
                                    {},
                                    ((n = { hit: u, attribute: o }), Wt(xt(n))).map(function (e, r) {
                        ...
                        function zt(e) {
                            ...
                            return function (e) {
                                ...
                                return t(
                                    r,
                                    {},
                                    ((n = { hit: u, attribute: o }), Wt($t(n))).map(function (e, r) {
                                        return e.isHighlighted ? t(a, { key: r }, e.value) : e.value;
                                    })
                                );
                            };
                        ...
                        function Kt(e) {
                            ...
                            return function (e) {
                                ...
                                return t(
                                    r,
                                    {},
                                    $t({ hit: n, attribute: u }).map(function (e, r) {
                        ...
                        function ir(e) {
                            ...
                            switch (t) {
                                ...
                                case 'end':
                                    return { top: i, right: u.document.documentElement.clientWidth - (o.left + o.width) };
                                case 'full-width':
                                    ...
                                    return (function (e) {
                                                ...
                                                Highlight:
                                                    ...
                                                    function (e) {
                                                        ...
                                                        return C(
                                                            F,
                                                            {},
                                                            xt({ hit: t, attribute: r }).map(function (e, t) {
                                                                return e.isHighlighted ? C(u, { key: t }, e.value) : e.value;
                                                            })
                                                        );
                                                    }),
                                        ...
                                        return {
                                            renderer: {
                                                ...
                                                translations: er(
                                                    er({}, { clearButtonTitle: 'Clear', detachedCancelButtonText: 'Cancel', submitButtonTitle: 'Submit' }),
                                                    b
                                                )
                                            },
                                            core: er(er({}, _), {}, { id: null !== (t = _.id) && void 0 !== t ? t : f(), environment: O })
                                        };
                                    })(p.current);
                                }),
                                v = a(function () {
                                    ...
                                    return Ce(
                                        yr(
                                            ...
                                            {},
                                            {
                                                ...
                                                __autocomplete_metadata: { userAgents: pr, options: e }
                                            }
                                        )
                                    );
                                }),
                            ...
                            function O(e) {
                                ...
                                !(function (e) {
                                    var t = e.autocomplete,
                                        ...
                                        u = e.propGetters,
                                        o = e.state;
                                    Te(n.root, u.getRootProps(lr({ state: o, props: t.getRootProps({}) }, r))),
                                        Te(
                                            n.input,
                                            u.getInputProps(lr({ state: o, props: t.getInputProps({ inputElement: n.input }), inputElement: n.input }, r))
                                        ),
                                        Ne(n.label, { hidden: 'stalled' === o.status }),
                                        Ne(n.loadingIndicator, { hidden: 'stalled' !== o.status }),
                                        ...
                                        if (s.isOpen) {
                                            ...
                                            var f = s.collections
                                                    ...
                                                    .map(function (e, t) {
                                                        ...
                                                        return o(
                                                            'section',
                                                            { key: t, className: u.source, 'data-autocomplete-source-id': i.sourceId },
                                                            i.templates.header &&
                                                                o(
                                                                    'div',
                                                            ...
                                                            i.templates.noResults && 0 === c.length
                                                                ...
                                                                : o(
                                                                      'ul',
                                                                      ar({ className: u.list }, l.getListProps(lr({ state: s, props: r.getListProps({}) }, n))),
                                                                      c.map(function (e) {
                                                                          var t = r.getItemProps({ item: e, source: i });
                                                                          return o(
                                                                              'li',
                                                                              ar(
                                                                                  { key: t.id, className: u.item },
                                                                                  l.getItemProps(lr({ state: s, props: t }, n))
                                                                              ),
                                                                              i.templates.item({
                                                                                  components: p,
                                                                                  createElement: o,
                                                ...
                                                d = o(a, null, o('div', { className: u.panelLayout }, f), o('div', { className: 'aa-GradientBottom' })),
                                                m = f.reduce(function (e, t) {
                                                    return (e[t.props['data-autocomplete-source-id']] = t), e;
                                                }, {});
                                            e(
                                                lr({ children: d, state: s, sections: f, elements: m, createElement: o, Fragment: a, components: p }, n),
                                                i.panel
                                            );
                                        ...
                                        .search(
                                            r.map(function (e) {
                                                ...
                                                return Fr(
                                                    Fr({}, jr(e, Er)),
                                                    {},
                                                    { params: Fr({ hitsPerPage: 5, highlightPreTag: wt, highlightPostTag: St }, t) }
                                                );
                                            })
                                        )
                                        .then(function (e) {
                        ...
                        e.exports = (function () {
                                    ...
                                    : {
                                          get: function (e, n) {
                                              ...
                                              return r.get(e, n, u).catch(function () {
                                                  return a({ caches: t }).get(e, n, u);
                                              });
                                          },
                                          set: function (e, n) {
                                              return r.set(e, n).catch(function () {
                                                  return a({ caches: t }).set(e, n);
                                              });
                                          },
                                          delete: function (e) {
                            ...
                            function A(e, t, n, u) {
                                var i = [],
                                    ...
                                    p = r(r(r({ 'x-algolia-agent': e.userAgent.value }, e.queryParameters), s), u.queryParameters),
                                    f = 0,
                                    d = function t(r, o) {
                                        var s = r.pop();
                                        if (void 0 === s)
                                        ...
                                        var d = {
                                            ...
                                            m = function (e) {
                                                var t = { request: d, response: e, host: s, triesLeft: r.length };
                                                return i.push(t), t;
                                            },
                                            v = {
                            ...
                            var w = function (e) {
                                ...
                                B = function (e) {
                                    return function (t) {
                                        ...
                                        return s({ transporter: e.transporter, appId: e.appId, indexName: t }, r.methods);
                                    };
                                },
                                I = function (e) {
                                    return function (t, n) {
                                        ...
                                        return e.transporter.read({ method: _, path: '1/indexes/*/queries', data: { requests: u }, cacheable: !0 }, n);
                                    };
                                },
                                k = function (e) {
                                    return function (t, u) {
                                        return Promise.all(
                                            t.map(function (t) {
                                                ...
                                                return B(e)(t.indexName, { methods: { searchForFacetValues: T } }).searchForFacetValues(i, a, r(r({}, u), c));
                                            })
                                        );
                                    };
                                },
                                ...
                                N = function (e) {
                                    return function (t, r) {
                                        return e.transporter.read(
                                            { method: _, path: p('1/indexes/%s/query', e.indexName), data: { query: t }, cacheable: !0 },
                                            r
                                        );
                                    };
                                },
                                T = function (e) {
                                    return function (t, r, n) {
                                        return e.transporter.read(
                                            { method: _, path: p('1/indexes/%s/facets/%s/query', e.indexName, t), data: { facetQuery: r }, cacheable: !0 },
                                            n
                                        );
                                    };
                                },
                            ...
                            function M(e, t, n) {
                                var u,
                                    o = {
                                            ...
                                            send: function (e) {
                                                return new Promise(function (t) {
                                                    ...
                                                    (r.onreadystatechange = function () {
                                                        ...
                                                        (r.onload = function () {
                                                            clearTimeout(o), clearTimeout(n), t({ content: r.responseText, status: r.status, isTimedOut: !1 });
                                                        }),
                                                        r.send(e.data);
                                                });
                                            }
                                        ...
                                        hostsCache: a({ caches: [i({ key: ''.concat('4.11.0', '-').concat(e) }), c()] }),
                                        userAgent: E('4.11.0').add({ segment: 'Browser', version: 'lite' }),
                                        ...
                                        {},
                                        {
                                            methods: {
                                                ...
                                                initIndex: function (e) {
                                                    return function (t) {
                                                        return B(e)(t, { methods: { search: N, searchForFacetValues: T, findAnswers: x } });
                                                    };
                                                }
                                            }
                                        }
                    ...
                    756: (e, t, r) => {
                        ...
                        var o = r(369),
                            i = { analytics: !0, hitsPerPage: 5, debug: !1, poweredBy: !0, placeholder: 'Search...', openOnFocus: !1 },
                                                            ...
                                                            queries: [
                                                                {
                                                                    ...
                                                                    query: r,
                                                                    params: { analytics: e.options.analytics, hitsPerPage: e.options.hitsPerPage }
                                                                }
                                                            ]
                                                        });
                                                    },
                        ...
                        function u(e, t) {
                            ...
                            for (var o = 1; o < 7 && u < 3; ++o) {
                                ...
                                e.hierarchy[i] &&
                                    ...
                                    (u > 0 && r.push(' > '), r.push((0, n.jsx)(t.Highlight, { hit: e.hierarchy, attribute: i }, void 0)), ++u);
                            }
                            return r;
                        }
                        function o(e, t) {
                                                                ...
                                                                'div',
                                                                {
                                                                    children: [
                                                                            ...
                                                                            Object.assign(
                                                                                { className: 'aa-ItemTitle' },
                                                                                {
                                                                                    children:
                                                                                        ...
                                                                                        void 0 !== i
                                                                                            ? i
                                                                                            : (0, n.jsx)(t.Highlight, { hit: e, attribute: 'title' }, void 0)
                                                                                }
                                                                            ),
                                                                            void 0
                                                                        ),
                                                                        e.hierarchy &&
                                                                            (0, n.jsx)(
                                                                                'div',
                                                                                Object.assign({ className: 'aa-ItemHierarchy' }, { children: u(e, t) }),
                                                                                void 0
                                                                            ),
                                                                        (0, n.jsx)(
                                                                            'div',
                                                                            Object.assign({ className: 'aa-ItemDescription' }, { children: o(e, t) }),
                                                                            void 0
                                                                        )
                                                                    ]
                                                                },
                    ...
                    275: (e, t, r) => {
                        'use strict';
                        r.r(t), r.d(t, { Fragment: () => v, jsx: () => N, jsxDEV: () => N, jsxs: () => N });
                        var n,
                            u,
                            o,
                            i,
