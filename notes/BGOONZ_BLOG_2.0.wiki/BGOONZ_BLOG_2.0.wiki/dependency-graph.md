...
[Dependencies](https://github.com/BGOOONZ-BLOG/BGOONZ_BLOG_2.0/network/dependencies)[Dependents](https://github.com/BGOOONZ-BLOG/BGOONZ_BLOG_2.0/network/dependents)[Dependabot](https://github.com/BGOOONZ-BLOG/BGOONZ_BLOG_2.0/network/updates)

These dependencies are defined in BGOONZ_BLOG_2.0's manifest files, such as [package.json](https://github.com/BGOOONZ-BLOG/BGOONZ_BLOG_2.0/network/dependencies#package.json "package.json").

 Dependencies defined in [package.json](https://github.com/BGOOONZ-BLOG/BGOONZ_BLOG_2.0/blob/master/package.json "package.json") 25
