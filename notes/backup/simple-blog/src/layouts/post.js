                    ...
                    <div className="container container--md">
                        ...
                        <header className="post__header">
                            ...
                            <div className="post__meta">
                                <span>
                                    On{' '}
                                    <time dateTime={moment(_.get(this.props, 'page.frontmatter.date', null)).strftime('%Y-%m-%d %H:%M')}>
                        ...
                        <div className="post__copy">{markdownify(_.get(this.props, 'page.markdown', null))}</div>
