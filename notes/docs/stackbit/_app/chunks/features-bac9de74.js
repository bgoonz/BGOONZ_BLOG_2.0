...
function w(m) {
    ...
    return (
        (n = new d({ props: { feature: m[1] } })),
        {
            ...
            p(m, i) {
                const o = {};
                1 & i && (o.feature = m[1]), n.$set(o);
            },
            i(m) {
                i || (t(n.$$.fragment, m), (i = !0));
            },
            o(m) {
                p(n.$$.fragment, m), (i = !1);
            },
...
function k(m) {
    ...
    let o = m[0];
    let e = [];
    for (let t = 0; t < o.length; t += 1) e[t] = w(h(m, o, t));
    const l = (m) =>
        p(e[m], 1, 1, () => {
            e[m] = null;
        });
    return {
        ...
        l(m) {
            for (let n = 0; n < e.length; n += 1) e[n].l(m);
            n = g();
        },
        m(m, o) {
            for (let n = 0; n < e.length; n += 1) e[n].m(m, o);
            r(m, n, o), (i = !0);
        },
        p(m, [i]) {
            if (1 & i) {
                let p;
                for (o = m[0], p = 0; p < o.length; p += 1) {
                    const l = h(m, o, p);
                    e[p] ? (e[p].p(l, i), t(e[p], 1)) : ((e[p] = w(l)), e[p].c(), t(e[p], 1), e[p].m(n.parentNode, n));
                }
                for (s(), p = o.length; p < e.length; p += 1) l(p);
                v();
            }
        },
        i(m) {
            if (!i) {
                for (let m = 0; m < o.length; m += 1) t(e[m]);
                i = !0;
            }
        },
        o(m) {
...
function y(m, n, i) {
    ...
    return (
        (m.$$set = (m) => {
            'features' in m && i(0, (o = m.features));
        }),
        [o]
    );
}
class b extends m {
    constructor(m) {
        super(), n(this, m, y, k, i, { features: 0 });
    }
}
export { b as F, f as l, u as t };
