...
export default class SectionGrid extends React.Component {
        render() {
            ...
            return ( <
                section id = {
                    _.get(section, 'section_id', null)
                }
                className = {
                    classNames('block', 'block-grid', 'outer', {
                ...
                div className = "inner" > {
                    (_.get(section, 'title', null) || _.get(section, 'subtitle', null)) && ( <
                        div className = "block-header inner-sm" > {
                            _.get(section, 'title', null) && < h2 className = "block-title" > {
                                _.get(section, 'title', null)
                            } < /h2>} {
                            _.get(section, 'subtitle', null) && < p className = "block-subtitle" > {
                        ...
                        _.get(section, 'grid_items', null) && ( <
                            ...
                            div className = {
                                classNames('grid', {
                                    'grid-col-2': _.get(section, 'col_number', null) === 'three',
                                ...
                                _.map(_.get(section, 'grid_items', null), (item, item_idx) => ( <
                                    ...
                                    div className = "grid-item-inside" > {
                                        _.get(item, 'image', null) && ( <
                                            ...
                                            <
                                            img src = {
                                                withPrefix(_.get(item, 'image', null))
                                            }
                                            alt = {
                                                _.get(item, 'image_alt', null)
                                            }
                                            /> < /
                                            div >
                                        )
                                        ...
                                        _.get(item, 'title', null) && ( <
                                            h3 className = "grid-item-title line-left" > {
                                                _.get(item, 'title_url', null) ? ( <
                                                    Link to = {
                                                        withPrefix(_.get(item, 'title_url', null))
                                                    } > {
                                                        _.get(item, 'title', null)
                                                    } < /Link>
                                                ) : (
