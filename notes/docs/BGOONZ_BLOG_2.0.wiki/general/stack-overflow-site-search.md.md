...
With this in mind, first learn how to read entire pages (i.e. webpages) into a string: <a href="http://php.net/manual/en/function.file-get-contents.php" class="uri">http://php.net/manual/en/function.file-get-contents.php</a>
