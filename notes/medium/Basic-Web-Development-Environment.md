...
01.  <span id="110a">In the application search box in the bottom bar, type “PowerShell” to find the application named “Windows PowerShell”</span>
02.  <span id="54fd">Right-click on “Windows PowerShell” and choose “Run as administrator” from the popup menu</span>
03.  <span id="a018">In the blue PowerShell window, type the following: `Enable-WindowsOptionalFeature -Online -FeatureName Microsoft-Windows-Subsystem-Linux`</span>
04.  <span id="6269">Restart your computer</span>
05.  <span id="6dd9">In the application search box in the bottom bar, type “Store” to find the application named “Microsoft Store”</span>
06.  <span id="eb4e">Click “Microsoft Store”</span>
07.  <span id="74c1">Click the “Search” button in the upper-right corner of the window</span>
08.  <span id="9d35">Type in “Ubuntu”</span>
09.  <span id="4205">Click “Run Linux on Windows (Get the apps)”</span>
...
01.  <span id="8cfe">You need to configure Git, so type `git config --global user.name "Your Name"` with replacing "Your Name" with your real name.</span>
02.  <span id="0e0d">You need to configure Git, so type `git config --global user.email your@email.com` with replacing "<a href="mailto:your@email.com" class="markup--anchor markup--li-anchor">your@email.com</a>" with your real email.</span>
...
01.  <span id="9098">In the Ubuntu terminal, type `sudo apt update` and press Enter</span>
02.  <span id="806b">In the Ubuntu terminal, type `sudo apt install build-essential` and press Enter</span>
03.  <span id="5f3a">In the Ubuntu terminal, type `curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.35.2/install.sh | bash` and press Enter</span>
04.  <span id="2abd">In the Ubuntu terminal, type `. ./.bashrc` and press Enter</span>
05.  <span id="3c16">In the Ubuntu terminal, type `nvm install --lts` and press Enter</span>
06.  <span id="d567">Confirm that **node** is installed by typing `node --version` and seeing it print something that is not "Command not found"!</span>
