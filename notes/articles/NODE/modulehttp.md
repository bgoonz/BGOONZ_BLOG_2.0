...
template: docs
excerpt: 'The http module of Node.js provides useful functions and classes to build an HTTP server'
---
...
This property lists all the HTTP status codes and their template: docs
excerpt:
