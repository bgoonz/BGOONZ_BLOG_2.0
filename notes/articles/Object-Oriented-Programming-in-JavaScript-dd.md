...
<figure>
<img src="https://cdn-images-1.medium.com/max/800/0*56wmllZ_9pRe28TK.jpg" class="graf-image" />
</figure>### Overview:
...
</figure>-   <span id="8fac">When JavaScript uses a property (or method) from a prototype that it found through prototypal inheritance, then the this property points to the original object on which the first call was made.</span>
...
on [March 14, 2021](https://medium.com/p/d45007d06333).

object-oriented-programming-in-javascript-d45007d06333"
