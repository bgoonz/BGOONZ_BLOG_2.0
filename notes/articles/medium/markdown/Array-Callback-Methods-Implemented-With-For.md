...
*App Academy Open is the first free, online web development course that’s meant to get you hired as a developer. Get…*open.appacademy.io<a href="https://open.appacademy.io/learn" class="js-mixtapeImage mixtapeImage u-ignoreBlock"></a>

**MDN Web Docs**  

*Read more at hacks.mozilla.org Roughly a year ago at Mozilla we started an effort to improve Firefox stability on…*developer.mozilla.org<a href="https://developer.mozilla.org/en-US/" class="js-mixtapeImage mixtapeImage u-ignoreBlock"></a>

**Introduction: callbacks**  

*To demonstrate the use of callbacks, promises and other abstract concepts, we’ll be using some browser methods…*javascript.info<a href="https://javascript.info/callbacks" class="js-mixtapeImage mixtapeImage u-ignoreBlock"></a>
