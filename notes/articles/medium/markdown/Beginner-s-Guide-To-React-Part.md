...
*A JavaScript library for building user interfaces React makes it painless to create interactive UIs. Design simple…*github.com<a href="https://github.com/bgoonz/React_Notes_V3" class="js-mixtapeImage mixtapeImage u-ignoreBlock"></a>
...
*A React repl by bgoonz*replit.com<a href="https://replit.com/@bgoonz/react-tutorial-1" class="js-mixtapeImage mixtapeImage u-ignoreBlock"></a>

React Boilerplate:

**React.js + Babel + Webpack Boilerplate**  

*Created by <span class="citation" data-cites="eankeen">@eankeen</span> | The ultimate trifecta - React, Babel, and Webpack - complete with hot module reloading and a…*replit.com<a href="https://replit.com/@bgoonz/Reactjs-Babel-Webpack-Boilerplate#index.js" class="js-mixtapeImage mixtapeImage u-ignoreBlock"></a>
