...
\`\`\` ├── ./functions │   └── ./functions/deploy-succeeded.js ├── ./gatsby-browser.js ├── ./gatsby-config.js ├── ./gatsby-node.js ├── ./gatsby-ssr.js ├── ./googled2b1865dedd985a4.html ├── ./lambda    └── ./lambda/deploy-succeeded.js \`\`\`
