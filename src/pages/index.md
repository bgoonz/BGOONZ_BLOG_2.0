...
sections:
  ...
  - section_id: features
    ...
    grid_items:
      ...
      - title_url: 'https://bgoonz-blog.netlify.app/docs/react/'
      ...
      - title_url: 'https://bgoonz-blog.netlify.app/docs/articles/basic-web-dev/'
        image_alt: call stack
  ...
  - title: Current Interests
    ...
    grid_items:
      ...
      - title: Jamstack
        ...
        image_alt: jamstack
        content: >
          ## Why Jamstack Jamstack is the new standard architecture for the web.
          Using Git workflows and modern build tools, pre-rendered content is
          served to a CDN and made dynamic through APIs and serverless
