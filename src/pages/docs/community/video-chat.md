...
<iframe src="https://zumzi-chat-messenger.vercel.app/web/login.html" height="1000px" width="1400px" style="zoom:0.69; align-self:center;display:auto;display: block;border:12px solid gold;"> </iframe>
