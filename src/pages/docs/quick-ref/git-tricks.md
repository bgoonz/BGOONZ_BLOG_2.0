...
-   $ git pull -r fetches changes from the _remote_ and ["rebases the current branch on top of the upstream branch after fetching"](https://git-scm.com/docs/git-pull#git-pull--r)
