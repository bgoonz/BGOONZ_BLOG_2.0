...
*   **Communities Around Projects**: Successful open source projects attract many developers who produce plugins, libraries, tutorials and other resources. This section collects such resources.
    ...
    *   [**jQuery**](https://jquery.com/): jQuery is a fast, small, and feature-rich JavaScript library. It makes things like HTML document traversal and manipulation, event handling, animation, and Ajax much simpler.
        ...
        *   [**jQuery UI**](http://jqueryui.com/): jQuery UI is a curated set of user interface interactions, effects, widgets, and themes built on top of the jQuery JavaScript Library.
            ...
            *   [**Learning jQuery UI**](http://learn.jquery.com/jquery-ui/): Series of articles about jQuery UI on [learn.jquery.com](http://learn.jquery.com/).
...
*   [**Charles Max Wood**](https://twitter.com/cmaxw): Podcaster at [Devchat.tv](http://devchat.tv/), organizer of remote confs such as Angular RC, React RC, Rails RC. Software consultant and developer.
...
*   [**HyperText Markup Language (HTML)**](https://www.w3.org/html/): HTML is the standard markup language used to create web pages and its elements form the building blocks of all websites.
    ...
    *   [**HEAD**](https://github.com/joshbuchea/HEAD): A list of everything that could go in the of your document.
...
*   **Rich Text Editors**: A rich text editor is the interface for editing rich text within web browsers. The aim is to reduce the effort for users trying to express their formatting directly as valid HTML markup.
    ...
    *   **Inspired by Medium**: [Medium.com](http://medium.com/) has a great and simple rich text editor built in. This libraries try to clone its behavior.
        ...
        *   [**medium-editor**](https://github.com/yabwe/medium-editor): [Medium.com](http://medium.com/) WYSIWYG editor clone. Uses contenteditable API to implement a rich text solution.
    ...
    *   [**Quill**](https://github.com/quilljs/quill/): Quill is a modern rich text editor built for compatibility and extensibility. It was created by Jason Chen and Byron Milligan and open sourced by [Salesforce.com](http://salesforce.com/).
...
: Gulp is a toolkit that helps you automate painful or time-consuming tasks in your development workflow. It's very fast, platform-agnostic and simple.
...
*   **Documentation**: Writing, generating, publishing and consuming documentation for web deliverables.
    ...
    *   [**Daux**](http://daux.io/): [Daux.io](http://daux.io/) is a documentation generator that uses a simple folder structure and Markdown files to create custom documentation on the fly.
...
*   **Fonts for Programmers**: Programmers need special fonts, which help align the code and distinguish between characters, that look alike.
    ...
    *   [**Free Programming Fonts**](http://cdn.sixrevisions.com/0441-01\_programming-fonts/demo/programming-fonts.html): A demonstration of beautiful fonts for people who love to code.
