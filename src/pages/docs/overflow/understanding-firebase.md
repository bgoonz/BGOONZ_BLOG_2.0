...
-   **Application ID ("AppID")**: the unique identifier for the Firebase app across all of Firebase with a platform-specific format:
    ...
    -   Firebase iOS apps: GOOGLE*APP_ID (example value: 1:1234567890:ios:321abc456def7890)
        This is \_not* an Apple bundle ID.

    -   Firebase Android apps: mobilesdk*app_id (example value: 1:1234567890:android:321abc456def7890)
        This is \_not* an Android package name or Android application ID.
