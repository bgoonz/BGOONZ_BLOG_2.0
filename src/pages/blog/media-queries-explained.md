...
[![The Divi Theme](https://s3.buysellads.com/1250418/293805-1444204566.png)](https://srv.buysellads.com/ads/click/x/GTND42JICEBICKQUCVYLYKQNCKBDC27UF6AITZ3JCY7IVK7MCKBD5K7KC67DV53MCASIC53YFTSDTKJMCTAI62QWHEYIKK7WCW7DL2JECTNCYBZ52K)[The Divi ThemeDownload the Ultimate WordPress Theme including our advanced Drag & Drop builder](https://srv.buysellads.com/ads/click/x/GTND42JICEBICKQUCVYLYKQNCKBDC27UF6AITZ3JCY7IVK7MCKBD5K7KC67DV53MCASIC53YFTSDTKJMCTAI62QWHEYIKK7WCW7DL2JECTNCYBZ52K)

[![Frontend Masters logo](https://res.cloudinary.com/css-tricks/image/upload/f_auto,q_auto/v1577457025/FEM-footer-CSS_s96vdh.png)](https://frontendmasters.com/courses/css-grids-flexbox/?utm_source=css-tricks&utm_medium=website&utm_campaign=css-tricks-tags-sidebar?utm_source=css-tricks&utm_medium=website&utm_campaign=css-tricks-tags-sidebar)

#### Wanna learn modern CSS layout?

Laying out designs on the web with CSS has gotten a lot more powerful in recent years. CSS grid and flexbox are incredibly powerful tools for that, and [Frontend Masters](https://frontendmasters.com/?utm_source=css-tricks&utm_medium=website&utm_campaign=css-tricks-tags-sidebar) has [a complete learning course on them](https://frontendmasters.com/courses/css-grids-flexbox/?utm_source=css-tricks&utm_medium=website&utm_campaign=css-tricks-tags-sidebar) from Jen Kramer.
...
1.  Arul
    ...
    [Permalink to comment#](https://css-tricks.com/a-complete-guide-to-css-media-queries/#comment-1763579) October 3, 2020

    I recently learnt that add Listener is deprecated, and we should instead use addeventListener.

2.  Lucy Kuijk

    [Permalink to comment#](https://css-tricks.com/a-complete-guide-to-css-media-queries/#comment-1763692) October 6, 2020

    Thank you for your excellent explanation. On implementing I encountered a missing '.matches' after 'if ( mediaQuery' in your Javascript example:\
    // Check if the media query is true\
    if ( mediaQuery ) {\
    // Then log the following message to the console\
    console.log('Media Query Matched!')\
...
3.  Onaolapo Olufowokan

    [Permalink to comment#](https://css-tricks.com/a-complete-guide-to-css-media-queries/#comment-1765349) November 24, 2020

    Thanks for this!

4.  havajsky

    [Permalink to comment#](https://css-tricks.com/a-complete-guide-to-css-media-queries/#comment-1771880) May 10, 2021
...
5.  Tzoor Rozental
    ...
    [Permalink to comment#](https://css-tricks.com/a-complete-guide-to-css-media-queries/#comment-1773953) June 14, 2021
...
CSS-Tricks is created by [Chris](https://chriscoyier.net/) and a [team](https://css-tricks.com/about) of swell people.
...
-   [Jetpack](https://css-tricks.com/jetpack/)(Search, Backup)
-   [WooCommerce](https://woocommerce.com/?aff=8638)(eCommerce)
-   [Local](https://localwp.com/)(Development)

##### HOSTING

-   [Flywheel](https://share.getf.ly/k96n2f)
