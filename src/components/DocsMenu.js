                ...
                <div className="docs-nav-menu">
                  <ul id="docs-menu" className="docs-menu">
                    ...
                    {_.map(_.get(site, 'data.doc_sections.sections', null), (section, section_idx) => {
                        ...
                        const section_page = getPage(this.props.pageContext.pages, section_path);
                        const child_pages = _.orderBy(getPages(this.props.pageContext.pages, section_path), 'frontmatter.weight');
