...
e = window, t = function () {
  return function ( e ) {
    ...
    var p = n( 14 );
    for ( var u in p )[ "default" ].indexOf( u ) < 0 && function ( e ) {
      n.d( t, e, ( function () {
        return p[ e ]
      } ) )
    }( u );
    var d = n( 15 );
    for ( var u in d )[ "default" ].indexOf( u ) < 0 && function ( e ) {
      n.d( t, e, ( function () {
        return d[ e ]
      } ) )
    }( u );
    var v = n( 16 );
    for ( var u in v )[ "default" ].indexOf( u ) < 0 && function ( e ) {
      n.d( t, e, ( function () {
        return v[ e ]
      } ) )
    }( u );
    var m = n( 17 );
    for ( var u in m )[ "default" ].indexOf( u ) < 0 && function ( e ) {
      n.d( t, e, ( function () {
        return m[ e ]
      } ) )
    }( u );
    ...
    var h = n( 19 );
    for ( var u in h )[ "default" ].indexOf( u ) < 0 && function ( e ) {
      n.d( t, e, ( function () {
        return h[ e ]
      } ) )
    }( u )
    ...
    function h( e, t ) {
      ...
      return Promise.resolve( e( t ) ).then( ( function ( e ) {
        return Array.isArray( e ), "The `getSources` function must return an array of sources but returned type ".concat( JSON.stringify( D( e ) ), ":\n\n" ).concat( JSON.stringify( e, null, 2 ) ), Promise.all( e.filter( ( function ( e ) {
          return Boolean( e )
        } ) ).map( ( function ( e ) {
    ...
    function k( e, t ) {
      return n = e, Boolean( null == n ? void 0 : n.execute ) ? S( S( {}, e ), {}, {
    ...
    function H( e ) {
      ...
      var l, s = c.setCollections,
        f = c.setIsOpen,
        p = c.setQuery,
        d = c.setActiveItemId,
        v = c.setStatus;
      return p( o ), d( u.defaultActiveItemId ), o || !1 !== u.openOnFocus ? ( v( "loading" ), U = u.environment.setTimeout( ( function () {
        v( "stalled" )
      } ), u.stallThreshold ), u.getSources( R( {
        query: o,
        refresh: i,
        state: a.getState()
      }, c ) ).then( ( function ( e ) {
        return v( "loading" ), Promise.all( e.map( ( function ( e ) {
          return Promise.resolve( e.getItems( R( {
            query: o,
            refresh: i,
            state: a.getState()
          }, c ) ) ).then( ( function ( t ) {
      ...
      } ) ) ) : ( v( "idle" ), s( a.getState().collections.map( ( function ( e ) {
        return R( R( {}, e ), {}, {
          items: []
        } )
      } ) ) ), f( null !== ( l = r.isOpen ) && void 0 !== l ? l : u.shouldPanelOpen( {
        state: a.getState()
      } ) ), Promise.resolve() )
    }
    ...
    function Y( e ) {
      ...
      return {
        getEnvironmentProps: function ( e ) {
          ...
          return K( {
            onTouchStart: function ( e ) {
              !1 !== r.getState().isOpen && e.target !== n && !1 === [ u, o ].some( ( function ( n ) {
        ...
        getFormProps: function ( e ) {
          return e.inputElement, K( {
            action: "",
            noValidate: !0,
            role: "search",
            onSubmit: function ( o ) {
              var i;
              o.preventDefault(), t.onSubmit( K( {
                event: o,
                refresh: n,
                state: r.getState()
        ...
        getInputProps: function ( e ) {
          function o( e ) {
            ( t.openOnFocus || Boolean( r.getState().query ) ) && H( K( {
              event: e,
              props: t,
            ...
            onKeyDown: function ( e ) {
              ! function ( e ) {
                ...
                if ( "ArrowUp" === t.key || "ArrowDown" === t.key ) {
                  var i = function () {
                      var e = n.environment.document.getElementById( "".concat( n.id, "-item-" ).concat( u.getState().activeItemId ) );
                  ...
                  t.preventDefault(), !1 === u.getState().isOpen && ( n.openOnFocus || Boolean( u.getState().query ) ) ? H( V( {
                    event: t,
                    props: n,
                  ...
                  var c = T( u.getState() ),
                    ...
                    f = c.itemUrl,
                    p = c.source;
                  if ( t.metaKey || t.ctrlKey ) void 0 !== f && ( p.onSelect( V( {
                    event: t,
                    item: l,
                    itemInputValue: s,
                    itemUrl: f,
                  ...
                  else if ( t.shiftKey ) void 0 !== f && ( p.onSelect( V( {
                    event: t,
                    item: l,
                    itemInputValue: s,
                    itemUrl: f,
                    ...
                    if ( void 0 !== f ) return p.onSelect( V( {
                      event: t,
                      item: l,
                      itemInputValue: s,
                      itemUrl: f,
    ...
    var ue = function ( e, t ) {
      switch ( t.type ) {
        ...
        case "ArrowDown":
          var n = ne( ne( {}, e ), {}, {
            activeItemId: t.payload.hasOwnProperty( "nextActiveItemId" ) ? t.payload.nextActiveItemId : ee( 1, e.activeItemId, s( e ), t.props.defaultActiveItemId )
          } );
          return ne( ne( {}, n ), {}, {
            completion: Z( {
              state: n
    ...
    function ce( e ) {
        ...
        n = function ( e, t ) {
          ...
          return _( _( {
            ...
            getSources: function ( n ) {
              return Promise.all( [].concat( y( u.map( ( function ( e ) {
                return e.getSources
      ...
      return n.plugins.forEach( ( function ( e ) {
        var n;
        return null === ( n = e.subscribe ) || void 0 === n ? void 0 : n.call( e, ie( ie( {}, u ), {}, {
          refresh: l,
          onSelect: function ( e ) {
            t.push( {
              onSelect: e
    ...
    function De( e, t, n ) {
      ...
      if ( "style" === t )
        ...
        for ( t in n ) o && n[ t ] === o[ t ] || ve( e.style, t, n[ t ] );
      else "o" === t[ 0 ] && "n" === t[ 1 ] ? ( r = t !== ( t = t.replace( /Capture$/, "" ) ), ( u = t.toLowerCase() ) in e && ( t = u ), t = t.slice( 2 ), e._listeners || ( e._listeners = {} ), e._listeners[ t ] = n, n ? o || e.addEventListener( t, me, r ) : e.removeEventListener( t, me, r ) ) : "list" !== t && "tagName" !== t && "form" !== t && "type" !== t && "size" !== t && "download" !== t && "href" !== t && t in e ? e[ t ] = null == n ? "" : n : "function" != typeof n && "dangerouslySetInnerHTML" !== t && ( null == n || !1 === n && !/^ar/.test( t ) ? e.removeAttribute( t ) : e.setAttribute( t, n ) )
    }
      ...
      var t = e.autocomplete,
        ...
        O = function ( e ) {
          var t = e.autocompleteScopeApi,
            ...
            i = e.state,
            a = Pe( e, [ "autocompleteScopeApi", "environment", "classNames", "getInputProps", "getInputPropsCore", "onDetachedEscape", "state" ] ),
            c = Ae( n )( "input", a ),
            l = r( Ce( {
              state: i,
              props: u( {
    ...
    function ze() {
      for ( var e; ze.__r = ke.length; ) e = ke.sort( ( function ( e, t ) {
        return e.__v.__b - t.__v.__b
      } ) ), ke = [], e.some( ( function ( e ) {
        var t, n, r, u, o, i;
        e.__d && ( o = ( u = ( t = e ).__v ).__e, ( i = t.__P ) && ( n = [], ( r = Le( {}, u ) ).__v = u.__v + 1, nt( i, u, r, t.__n, void 0 !== i.ownerSVGElement, null != u.__h ? [ o ] : null, n, null == o ? Je( u ) : o, u.__h ), rt( n, u ), u.__e != o && Qe( u ) ) )
      } ) )
    }

    function Ke( e, t, n, r, u, o, i, a, c, l ) {
      var s, f, p, d, v, m, D, h = r && r.__k || qe,
        y = h.length;
      for ( n.__k = [], s = 0; s < t.length; s++ )
        if ( null != ( d = n.__k[ s ] = null == ( d = t[ s ] ) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? He( null, d, null, null, d ) : Array.isArray( d ) ? He( We, {
            children: d
          ...
          nt( e, d, p = p || Te, u, o, i, a, c, l ), v = d.__e, ( f = d.ref ) && p.ref != f && ( D || ( D = [] ), p.ref && D.push( p.ref, null, d ), D.push( f, d.__c || v, d ) ), null != v ? ( null == m && ( m = v ), "function" == typeof d.type && null != d.__k && d.__k === p.__k ? d.__d = c = Ge( d, c, e ) : c = Xe( e, d, p, h, v, c ), l || "option" !== n.type ? "function" == typeof n.type && ( n.__d = c ) : e.value = "" ) : c && p.__e == c && c.parentNode != e && ( c = Je( p ) )
        } for ( n.__e = m, s = y; s--; ) null != h[ s ] && ( "function" == typeof n.type && null != h[ s ].__e && h[ s ].__e == n.__d && ( n.__d = Je( r, s + 1 ) ), it( h[ s ], h[ s ] ) );
      if ( D )
        for ( s = 0; s < D.length; s++ ) ot( D[ s ], D[ ++s ], D[ ++s ] )
    }

    function Ge( e, t, n ) {
      var r, u;
      for ( r = 0; r < e.__k.length; r++ )( u = e.__k[ r ] ) && ( u.__ = e, t = "function" == typeof u.type ? Ge( u, t, n ) : Xe( n, u, u, e.__k, u.__e, t ) );
      return t
    }
    ...
    function Xe( e, t, n, r, u, o ) {
      ...
      else if ( null == n || u != o || null == u.parentNode ) e: if ( null == o || o.parentNode !== e ) e.appendChild( u ), i = null;
        else {
          for ( a = o, c = 0;
      ...
      e: if ( "style" === t )
        if ( "string" == typeof n ) e.style.cssText = n;
          ...
          if ( "string" == typeof r && ( e.style.cssText = r = "" ), r )
            for ( t in r ) n && t in n || Ye( e.style, t, "" );
          if ( n )
            for ( t in n ) r && n[ t ] === r[ t ] || Ye( e.style, t, n[ t ] )
        }
      else if ( "o" === t[ 0 ] && "n" === t[ 1 ] ) o = t !== ( t = t.replace( /Capture$/, "" ) ), t = t.toLowerCase() in e ? t.toLowerCase().slice( 2 ) : t.slice( 2 ), e.l || ( e.l = {} ), e.l[ t + o ] = n, n ? r || e.addEventListener( t, o ? tt : et, o ) : e.removeEventListener( t, o ? tt : et, o );
    ...
    function nt( e, t, n, r, u, o, i, a, c ) {
      var l, s, f, p, d, v, m, D, h, y, g, b = t.type;
      if ( void 0 !== t.constructor ) return null;
      null != n.__h && ( c = n.__h, a = t.__e = n.__e, t.__h = null, o = [ a ] ), ( l = Ie.__b ) && l( t );
      try {
        e: if ( "function" == typeof b ) {
          if ( D = t.props, h = ( l = b.contextType ) && r[ l.__c ], y = l ? h ? h.props.value : l.__ : r, n.__c ? m = ( s = t.__c = n.__c ).__ = s.__E : ( "prototype" in b && b.prototype.render ? t.__c = s = new b( D, y ) : ( t.__c = s = new Ve( D, y ), s.constructor = b, s.render = at ), h && h.sub( s ), s.props = D, s.state || ( s.state = {} ), s.context = y, s.__n = r, f = s.__d = !0, s.__h = [] ), null == s.__s && ( s.__s = s.state ), null != b.getDerivedStateFromProps && ( s.__s == s.state && ( s.__s = Le( {}, s.__s ) ), Le( s.__s, b.getDerivedStateFromProps( D, s.__s ) ) ), p = s.props, d = s.state, f ) null == b.getDerivedStateFromProps && null != s.componentWillMount && s.componentWillMount(), null != s.componentDidMount && s.__h.push( s.componentDidMount );
          else {
            if ( null == b.getDerivedStateFromProps && D !== p && null != s.componentWillReceiveProps && s.componentWillReceiveProps( D, y ), !s.__e && null != s.shouldComponentUpdate && !1 === s.shouldComponentUpdate( D, s.__s, y ) || t.__v === n.__v ) {
              s.props = D, s.state = s.__s, t.__v !== n.__v && ( s.__d = !1 ), s.__v = t, t.__e = n.__e, t.__k = n.__k, t.__k.forEach( ( function ( e ) {
                e && ( e.__ = t )
          ...
          s.context = y, s.props = D, s.state = s.__s, ( l = Ie.__r ) && l( t ), s.__d = !1, s.__v = t, s.__P = e, l = s.render( s.props, s.state, s.context ), s.state = s.__s, null != s.getChildContext && ( r = Le( Le( {}, r ), s.getChildContext() ) ), f || null == s.getSnapshotBeforeUpdate || ( v = s.getSnapshotBeforeUpdate( p, d ) ), g = null != l && l.type === We && null == l.key ? l.props.children : l, Ke( e, Array.isArray( g ) ? g : [ g ], t, n, r, u, o, i, a, c ), s.base = t.__e, t.__h = null, s.__h.length && i.push( s ), m && ( s.__E = s.__ = null ), s.__e = !1
    ...
    function ut( e, t, n, r, u, o, i, a ) {
      ...
      if ( null === v ) p === d || a && e.data === d || ( e.data = d );
        ...
        if ( function ( e, t, n, r, u ) {
            ...
            for ( o in t ) u && "function" != typeof t[ o ] || "children" === o || "key" === o || "value" === o || "checked" === o || n[ o ] === t[ o ] || Ze( e, o, t[ o ], n[ o ], r )
          }( e, d, p, u, a ), s ) t.__k = [];
        else if ( m = t.props.children, Ke( e, Array.isArray( m ) ? m : [ m ], t, n, r, u && "foreignObject" !== v, o, i, e.firstChild, a ), null != o )
          for ( m = o.length; m--; ) null != o[ m ] && Me( o[ m ] );
        a || ( "value" in d && void 0 !== ( m = d.value ) && ( m !== e.value || "progress" === v && !m ) && Ze( e, "value", m, p.value, !1 ), "checked" in d && void 0 !== ( m = d.checked ) && m !== e.checked && Ze( e, "checked", m, p.checked, !1 ) )
      }
      return e
    }
    ...
    function it( e, t, n ) {
      var r, u, o;
      if ( Ie.unmount && Ie.unmount( e ), ( r = e.ref ) && ( r.current && r.current !== e.__e || ot( r, null, t ) ), n || "function" == typeof e.type || ( n = null != ( u = e.__e ) ), e.__e = e.__d = void 0, null != ( r = e.__c ) ) {
      ...
      if ( r = e.__k )
        for ( o = 0; o < r.length; o++ ) r[ o ] && it( r[ o ], t, n );
      null != u && Me( u )
    }
    ...
    function ct( e, t, n ) {
      var r, u, o;
      Ie.__ && Ie.__( e, t ), u = ( r = "function" == typeof n ) ? null : n && n.__k || t.__k, o = [], nt( t, e = ( !r && n || t ).__k = Ue( We, null, [ e ] ), u || Te, Te, void 0 !== t.ownerSVGElement, !r && n ? [ n ] : u ? null : t.firstChild ? qe.slice.call( t.childNodes ) : null, o, !r && n ? n : u ? u.__e : t.firstChild, r ), rt( o, e )
    }
    ...
    Ie = {
      __e: function ( e, t ) {
        for ( var n, r, u; t = t.__; )
          if ( ( n = t.__c ) && !n.__ ) try {
            if ( ( r = n.constructor ) && null != r.getDerivedStateFromError && ( n.setState( r.getDerivedStateFromError( e ) ), u = n.__d ), null != n.componentDidCatch && ( n.componentDidCatch( e ), u = n.__d ), u ) return n.__E = n
          } catch ( t ) {
            e = t
          }
        throw e
      ...
      var n;
      n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = Le( {}, this.state ), "function" == typeof e && ( e = e( Le( {}, n ), this.props ) ), e && Le( n, e ), null != e && this.__v && ( t && this.__h.push( t ), $e( this ) )
    }, Ve.prototype.forceUpdate = function ( e ) {
      this.__v && ( this.__e = !0, e && this.__h.push( e ), $e( this ) )
    }, Ve.prototype.render = We, ke = [], xe = "function" == typeof Promise ? Promise.prototype.then.bind( Promise.resolve() ) : setTimeout, ze.__r = 0;
    var st = n( 2 );
    ...
    function vt( e ) {
      ...
      return "string" != typeof u && ( u = lt( t, r ) || "" ), ft( {
        highlightedValue: u
      } )
    }
    var mt = {
    ...
    function gt( e, t ) {
      ...
      return Dt.test( ( u = o.value ) && yt.test( u ) ? u.replace( ht, ( function ( e ) {
        return mt[ e ]
    ...
    function Lt( e ) {
      ...
      switch ( t ) {
        ...
        case "end":
          return {
            top: i, right: u.document.documentElement.clientWidth - ( o.left + o.width )
          };
        case "full-width":
          return {
            top: i, left: 0, right: 0, width: "unset", maxWidth: "unset"
          };
        case "input-wrapper-width":
          var a = r.getBoundingClientRect();
          return {
            top: i, left: a.left, right: u.document.documentElement.clientWidth - ( a.left + a.width ), width: "unset", maxWidth: "unset"
          };
        default:
    ...
    function Yt( e ) {
      var t, n = function () {
        ...
        v = a( ( function () {
          return function ( e ) {
            var t, n = e.classNames,
              ...
              g = e.components,
              b = e.translations,
              _ = Nt( e, [ "classNames", "container", "getEnvironmentProps", "getFormProps", "getInputProps", "getItemProps", "getLabelProps", "getListProps", "getPanelProps", "getRootProps", "panelContainer", "panelPlacement", "render", "renderNoResults", "renderer", "detachedMediaQuery", "components", "translations" ] ),
              O = "undefined" != typeof window ? window : {},
              A = St( O, r );
            A.tagName;
            var E, C, F, P = null != h ? h : Rt,
              j = {
        ...
        D = a( ( function () {
          return ce( Gt( Gt( {}, v.value.core ), {}, {
            onStateChange: function ( e ) {
              var t, n, r;
              l.current = e.state.collections.some( ( function ( e ) {
                return e.source.templates.noResults
              } ) ), null === ( t = d.current ) || void 0 === t || t.call( d, e ), null === ( n = ( r = v.value.core ).onStateChange ) || void 0 === n || n.call( r, e )
            },
            shouldPanelOpen: f.current.shouldPanelOpen || function ( e ) {
              var t = e.state;
              if ( m.value ) return !0;
              var n = s( t ) > 0;
      ...
      function O( e ) {
        ...
        ! function ( e ) {
          var t = e.autocomplete,
            ...
            u = e.propGetters,
            o = e.state;
          ge( r.root, u.getRootProps( Ht( {
            state: o,
            props: t.getRootProps( {} )
          }, n ) ) ), ge( r.input, u.getInputProps( Ht( {
            state: o,
        ...
        function ( e, t ) {
          ...
          if ( s.isOpen ) {
            ...
            var p = s.collections.filter( ( function ( e ) {
                var t = e.source,
                  n = e.items;
      ...
      function A() {
        var e = arguments.length > 0 && void 0 !== arguments[ 0 ] ? arguments[ 0 ] : {};
        u(), f.current = zt( v.value.renderer, v.value.core, {
      ...
      return r( ( function () {
        ...
        return ye( v.value.core.environment, e ),
          function () {
            ye( v.value.core.environment, Object.keys( e ).reduce( ( function ( e, t ) {
        ...
        return d.current = function ( t ) {
            var n = t.state,
              r = t.prevState;
            m.value && r.isOpen !== n.isOpen && E( n.isOpen ), m.value || !n.isOpen || r.isOpen || _(), n.query !== r.query && v.value.core.environment.document.querySelectorAll( ".aa-Panel--scrollable" ).forEach( ( function ( e ) {
        ...
        var n = v.value.core.environment.matchMedia( getComputedStyle( v.value.core.environment.document.documentElement ).getPropertyValue( "--aa-detached-modal-media-query" ) );
        e( n.matches );
    ...
    var h = function ( e ) {
      ...
      } ), n = t.searchClient, r = t.queries, u = t.userAgents, o = void 0 === u ? [] : u, "function" == typeof n.addAlgoliaAgent && [ {
        segment: "autocomplete-core",
        version: a
      } ].concat( p( o ) ).forEach( ( function ( e ) {
        var t = e.segment,
          r = e.version;
        n.addAlgoliaAgent( t, r )
      } ) ), n.search( r.map( ( function ( e ) {
        var t = e.params;
        return l( l( {}, f( e, [ "params" ] ) ), {}, {
          params: l( {
            hitsPerPage: 5,
            highlightPreTag: i.b,
    ...
    t.algoliasearchNetlify = function ( e ) {
      var t, n = Object.assign( Object.assign( {}, i ), e ),
        u = r( a );
      try {
        for ( u.s(); !( t = u.n() ).done; ) {
          var l = t.value;
      ...
      l = function () {
        ...
        return t = e, ( n = [ {
          ...
          value: function () {
            ...
            if ( t ) {
              var n = void 0;
              void 0 !== this.options.detached && ( n = !0 === this.options.detached ? "" : !1 === this.options.detached ? "none" : this.options.detached.mediaQuery );
            ...
            if ( e && this.options.theme ) {
              ...
              this.$themeNode = function ( e ) {
                var t, n = arguments.length > 1 && void 0 !== arguments[ 1 ] ? arguments[ 1 ] : null,
                  r = null !== ( t = null != n ? n : document.querySelector( 'link[rel=stylesheet][href*="algoliasearchNetlify"]' ) ) && void 0 !== t ? t : document.getElementsByTagName( "head" )[ 0 ].lastChild,
                  u = document.createElement( "style" );
                return u.setAttribute( "type", "text/css" ), u.appendChild( document.createTextNode( e ) ), r.parentNode.insertBefore( u, r.nextSibling )
    ...
    var o = n( 5 );
    for ( var i in o )[ "default", "autocomplete", "getAlgoliaFacets", "getAlgoliaResults" ].indexOf( i ) < 0 && function ( e ) {
      n.d( t, e, ( function () {
        return o[ e ]
      } ) )
    }( i )
    ...
    e.exports = function () {
      ...
      function n( n ) {
        for ( var r = 1; r < arguments.length; r++ ) {
          ...
          r % 2 ? t( Object( u ), !0 ).forEach( ( function ( t ) {
            e( n, t, u[ t ] )
          } ) ) : Object.getOwnPropertyDescriptors ? Object.defineProperties( n, Object.getOwnPropertyDescriptors( u ) ) : t( Object( u ) ).forEach( ( function ( e ) {
          ...
          d = function t( n, o ) {
            ...
            var d = {
              ...
              m = {
                ...
                onRetry: function ( r ) {
                  var u = v( r );
                  return r.isTimedOut && p++, Promise.all( [ e.logger.info( "Retryable failure", j( u ) ), e.hostsCache.set( s, y( s, r.isTimedOut ? h : D ) ) ] ).then( ( function () {
                    return t( n, o )
                  } ) )
                },
                onFail: function ( e ) {
                ...
                f = {
                  ...
                  read: function ( e, t ) {
                    var n = d( t, f.timeouts.read ),
                      r = function () {
                        return A( f, f.hosts.filter( ( function ( e ) {
    ...
    function u( e, t ) {
      ...
      for ( var o = 1; o < 7 && u < 3; ++o ) e.hierarchy[ "lvl".concat( o ) ] && e.hierarchy[ "lvl".concat( o ) ].length > 0 && ( u > 0 && n.push( " > " ), n.push( r.jsx( t.Highlight, {
        hit: e,
    ...
    function o( e, t ) {
      var n, u, o = null === ( n = e._snippetResult ) || void 0 === n ? void 0 : n.description,
        i = null === ( u = e._snippetResult ) || void 0 === u ? void 0 : u.content;
      return o && "full" === o.matchLevel ? r.jsx( t.Snippet, {
        hit: e,
        attribute: "description"
      }, void 0 ) : i && "full" === i.matchLevel ? r.jsx( t.Snippet, {
        hit: e,
        attribute: "content"
      }, void 0 ) : o && !i ? r.jsx( t.Snippet, {
        hit: e,
        attribute: "description"
      }, void 0 ) : i ? r.jsx( t.Snippet, {
        hit: e,
        attribute: "content"
    ...
    t.templates = {
      poweredBy: function ( e ) {
        ...
        return r.jsxs( "div", Object.assign( {
          ...
          children: [ "Search by", r.jsx( "a", Object.assign( {
        ...
        return r.jsx( "a", Object.assign( {
          ...
          children: r.jsxs( "div", Object.assign( {
            ...
            children: [ r.jsx( "div", Object.assign( {
              ...
              children: r.jsx( "svg", Object.assign( {
                width: "20",
                height: "20",
                viewBox: "0 0 20 20"
              }, {
              ...
              children: [ r.jsx( "div", Object.assign( {
                ...
                children: null !== ( i = null === ( n = e.hierarchy ) || void 0 === n ? void 0 : n.lvl0 ) && void 0 !== i ? i : r.jsx( t.Highlight, {
                  hit: e,
                  attribute: "title"
                }, void 0 )
              } ), void 0 ), e.hierarchy && r.jsx( "div", Object.assign( {
    ...
    function b() {
      for ( var e; b.__r = i.length; ) e = i.sort( ( function ( e, t ) {
        ...
        var t, n, r, u, o, i;
        e.__d && ( o = ( u = ( t = e ).__v ).__e, ( i = t.__P ) && ( n = [], ( r = p( {}, u ) ).__v = u.__v + 1, j( i, u, r, t.__n, void 0 !== i.ownerSVGElement, null != u.__h ? [ o ] : null, n, null == o ? h( u ) : o, u.__h ), w( n, u ), u.__e != o && y( u ) ) )
      } ) )
    }

    function _( e, t, n, r, u, o, i, a, c, f ) {
      var p, d, D, y, g, b, _, E = r && r.__k || s,
        C = E.length;
      for ( n.__k = [], p = 0; p < t.length; p++ )
        if ( null != ( y = n.__k[ p ] = null == ( y = t[ p ] ) || "boolean" == typeof y ? null : "string" == typeof y || "number" == typeof y || "bigint" == typeof y ? v( null, y, null, null, y ) : Array.isArray( y ) ? v( m, {
          ...
          j( e, y, D = D || l, u, o, i, a, c, f ), g = y.__e, ( d = y.ref ) && D.ref != d && ( _ || ( _ = [] ), D.ref && _.push( D.ref, null, y ), _.push( d, y.__c || g, y ) ), null != g ? ( null == b && ( b = g ), "function" == typeof y.type && null != y.__k && y.__k === D.__k ? y.__d = c = O( y, c, e ) : c = A( e, y, D, E, g, c ), f || "option" !== n.type ? "function" == typeof n.type && ( n.__d = c ) : e.value = "" ) : c && D.__e == c && c.parentNode != e && ( c = h( D ) )
        } for ( n.__e = b, p = C; p--; ) null != E[ p ] && ( "function" == typeof n.type && null != E[ p ].__e && E[ p ].__e == n.__d && ( n.__d = h( r, p + 1 ) ), I( E[ p ], E[ p ] ) );
      if ( _ )
        for ( p = 0; p < _.length; p++ ) B( _[ p ], _[ ++p ], _[ ++p ] )
    }

    function O( e, t, n ) {
      var r, u;
      for ( r = 0; r < e.__k.length; r++ )( u = e.__k[ r ] ) && ( u.__ = e, t = "function" == typeof u.type ? O( u, t, n ) : A( n, u, u, e.__k, u.__e, t ) );
      return t
    }
    ...
    function C( e, t, n, r, u ) {
      ...
      else if ( "o" === t[ 0 ] && "n" === t[ 1 ] ) o = t !== ( t = t.replace( /Capture$/, "" ) ), t = t.toLowerCase() in e ? t.toLowerCase().slice( 2 ) : t.slice( 2 ), e.l || ( e.l = {} ), e.l[ t + o ] = n, n ? r || e.addEventListener( t, o ? P : F, o ) : e.removeEventListener( t, o ? P : F, o );
      else if ( "dangerouslySetInnerHTML" !== t ) {
        if ( u ) t = t.replace( /xlink[H:h]/, "h" ).replace( /sName$/, "s" );
        else if ( "href" !== t && "list" !== t && "form" !== t && "tabIndex" !== t && "download" !== t && t in e ) try {
          e[ t ] = null == n ? "" : n;
    ...
    function j( e, t, n, r, o, i, a, c, l ) {
      var s, f, d, v, h, y, g, b, O, A, E, C = t.type;
      if ( void 0 !== t.constructor ) return null;
      null != n.__h && ( l = n.__h, c = t.__e = n.__e, t.__h = null, i = [ c ] ), ( s = u.__b ) && s( t );
      try {
        e: if ( "function" == typeof C ) {
          if ( b = t.props, O = ( s = C.contextType ) && r[ s.__c ], A = s ? O ? O.props.value : s.__ : r, n.__c ? g = ( f = t.__c = n.__c ).__ = f.__E : ( "prototype" in C && C.prototype.render ? t.__c = f = new C( b, A ) : ( t.__c = f = new D( b, A ), f.constructor = C, f.render = k ), O && O.sub( f ), f.props = b, f.state || ( f.state = {} ), f.context = A, f.__n = r, d = f.__d = !0, f.__h = [] ), null == f.__s && ( f.__s = f.state ), null != C.getDerivedStateFromProps && ( f.__s == f.state && ( f.__s = p( {}, f.__s ) ), p( f.__s, C.getDerivedStateFromProps( b, f.__s ) ) ), v = f.props, h = f.state, d ) null == C.getDerivedStateFromProps && null != f.componentWillMount && f.componentWillMount(), null != f.componentDidMount && f.__h.push( f.componentDidMount );
          else {
            if ( null == C.getDerivedStateFromProps && b !== v && null != f.componentWillReceiveProps && f.componentWillReceiveProps( b, A ), !f.__e && null != f.shouldComponentUpdate && !1 === f.shouldComponentUpdate( b, f.__s, A ) || t.__v === n.__v ) {
            ...
            null != f.componentWillUpdate && f.componentWillUpdate( b, f.__s, A ), null != f.componentDidUpdate && f.__h.push( ( function () {
              f.componentDidUpdate( v, h, y )
            } ) )
          }
          f.context = A, f.props = b, f.state = f.__s, ( s = u.__r ) && s( t ), f.__d = !1, f.__v = t, f.__P = e, s = f.render( f.props, f.state, f.context ), f.state = f.__s, null != f.getChildContext && ( r = p( p( {}, r ), f.getChildContext() ) ), d || null == f.getSnapshotBeforeUpdate || ( y = f.getSnapshotBeforeUpdate( v, h ) ), E = null != s && s.type === m && null == s.key ? s.props.children : s, _( e, Array.isArray( E ) ? E : [ E ], t, n, r, o, i, a, c, l ), f.base = t.__e, t.__h = null, f.__h.length && a.push( f ), g && ( f.__E = f.__ = null ), f.__e = !1
    ...
    function S( e, t, n, u, o, i, a, c ) {
      ...
      if ( null === D ) v === m || c && e.data === m || ( e.data = m );
        ...
        if ( function ( e, t, n, r, u ) {
            ...
            for ( o in t ) u && "function" != typeof t[ o ] || "children" === o || "key" === o || "value" === o || "checked" === o || n[ o ] === t[ o ] || C( e, o, t[ o ], n[ o ], r )
          }( e, m, v, o, c ), p ) t.__k = [];
        else if ( y = t.props.children, _( e, Array.isArray( y ) ? y : [ y ], t, n, u, o && "foreignObject" !== D, i, a, i ? i[ 0 ] : n.__k && h( n, 0 ), c ), null != i )
    ...
    function I( e, t, n ) {
      ...
      if ( r = e.__k )
        for ( o = 0; o < r.length; o++ ) r[ o ] && I( r[ o ], t, "function" != typeof e.type );
