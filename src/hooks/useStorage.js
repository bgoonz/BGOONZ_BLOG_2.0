...
export function useStorage( storage, key, initialValue, options = {} ) {
...
export const useLocalStorage = (...args) => useStorage(typeof window !== `undefined` && localStorage, ...args);
export const useSessionStorage = (...args) => useStorage(typeof window !== `undefined` && sessionStorage, ...args);
