...
def beg(target*function): @wraps(target*function) def wrapper(*args, \\*\*kwargs): msg, say*please = target*function(*args, \\*\*kwargs) if say\_please: return "{} {}".format(msg, "Please! I am poor :(") return msg
