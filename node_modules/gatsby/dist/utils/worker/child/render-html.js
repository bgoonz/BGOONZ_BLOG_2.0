...
const renderHTMLProd = async ({
  ...
  await _bluebird.default.map(paths, async pagePath => {
    try {
      ...
      return _fsExtra.default.outputFile((0, _pageHtml.getPageHtmlFilePath)(publicDir, pagePath), html);
    } catch (e) {
...
const renderHTMLDev = async ({
  ...
  return _bluebird.default.map(paths, async pagePath => {
    try {
      ...
      return _fsExtra.default.outputFile((0, _pageHtml.getPageHtmlFilePath)(outputDir, pagePath), htmlString);
    } catch (e) {
      // add some context to error so we can display more helpful message
      e.context = {
        path: pagePath
