...
function readFromCache() {
  ...
  const nodesChunks = (0, _glob.sync)(reduxChunkedNodesFilePrefix(reduxCacheFolder) + `*`).map(file => _v.default.deserialize((0, _fsExtra.readFileSync)(file)));
  ...
  const pagesChunks = (0, _glob.sync)(reduxChunkedPagesFilePrefix(reduxCacheFolder) + `*`).map(file => _v.default.deserialize((0, _fsExtra.readFileSync)(file)));
