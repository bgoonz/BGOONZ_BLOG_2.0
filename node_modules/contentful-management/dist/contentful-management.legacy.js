...
function createClient(params) {
  ...
  "".concat(sdkMain, "/").concat("7.25.0"), params.application, params.integration, params.feature);
...
function createClientApi(makeRequest) {
  ...
  return {
     ...
     * ```
     */
    getSpaceTeams: function getSpaceTeams(spaceId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return makeRequest({
        entityType: 'Team',
        action: 'getManyForSpace',
...
function createSpaceApi(makeRequest) {
  ...
  return {
     ...
     * ```
     */
    getSpaceTeams: function getSpaceTeams() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return makeRequest({
        entityType: 'Team',
