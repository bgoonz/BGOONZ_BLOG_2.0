...
export var get = function get(http, params) {
  return raw.get(http, "/spaces/".concat(params.spaceId, "/roles/").concat(params.roleId));
};
export var getMany = function getMany(http, params) {
  return raw.get(http, "/spaces/".concat(params.spaceId, "/roles"), {
    params: normalizeSelect(params.query)
  });
};
export var create = function create(http, params, data, headers) {
  return raw.post(http, "/spaces/".concat(params.spaceId, "/roles"), data, {
    headers: headers
  });
};
...
export var del = function del(http, params) {
  return raw.del(http, "/spaces/".concat(params.spaceId, "/roles/").concat(params.roleId));
};