            ...
            var _loop_2 = function (definitionName) {
                ...
                var addDefinition = function (definition) {
                    ...
                    if ('fields' in definition) {
                        ...
                        try {
                            for (var _b = (e_16 = void 0, __values(definition.fields)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var field = _c.value;
                                _loop_3(field);
                            }
                        }
                ...
                var dependenciesOfDefinition = dependenciesByDefinitionName.get(definitionName);
                try {
                    for (var dependenciesOfDefinition_2 = (e_15 = void 0, __values(dependenciesOfDefinition)), dependenciesOfDefinition_2_1 = dependenciesOfDefinition_2.next(); !dependenciesOfDefinition_2_1.done; dependenciesOfDefinition_2_1 = dependenciesOfDefinition_2.next()) {
