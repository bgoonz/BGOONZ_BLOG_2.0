...
On macOS or Linux this location could be /usr/local/lib/node*modules. On Windows it could be C:\\Users\\YOU\\AppData\\Roaming\\npm\\node*modules

If you use nvm to manage Node.js versions, however, that location would differ.

I for example use nvm and my packages location was shown as /Users/joe/.nvm/versions/node/v8.9.0/lib/node\_modules.
