...
savefig*options = dict(format="png", dpi=300, bbox*inches="tight")\# Computation packages  
...
dtw*distance, warp*path = fastdtw(x, y, dist=euclidean)
...
cost*matrix = compute*accumulated*cost*matrix(x, y)
