...
1. **Open the source code and start editing!**
    ...
    *Note: You'll also see a second link:*`https://localhost:8000/___graphql`_. This is a tool you can use to experiment with querying your data. Learn more about using this tool in the [Gatsby tutorial](https://www.gatsbyjs.com/tutorial/part-five/#introducing-graphiql)._
...
Now you can go to `https://localhost:8000` to see your new site, but what's extra cool is that Netlify CMS is pre-installed and you can access it at `https://localhost:8000/admin`
...
export default class Icon extends React.Component {
    render() {
        ...
        return (
            <svg className="icon" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                {icon === 'dev' ? (
