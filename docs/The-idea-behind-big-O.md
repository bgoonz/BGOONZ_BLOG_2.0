...
1.  <span id="775e">**Each item in the array is the *same size*** (takes up the same</span>

number of bytes).

1.  <span id="bdaa">**The array is *uninterrupted* (contiguous) in memory**. There can’t</span>
...
-   <span id="475a">A BFS on a binary tree *generally* requires more memory than a DFS.</span>
