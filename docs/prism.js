/* PrismJS 1.24.1
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+cpp+python+sql&plugins=line-numbers+autolinker+show-language+toolbar+download-button */
                ...
                i &&
                    ...
                    (Prism.languages.DFS(i, function (i, n, t) {
                        -1 < l.indexOf(t) &&
                            ...
                            'attr-value' == t ? Prism.languages.insertBefore('inside', 'punctuation', { 'url-link': e }, n) : (n.inside['url-link'] = e),
                ...
                if (a && /pre/i.test(a.nodeName)) {
                    var t,
                        s =
                            ...
                            i[e.language] ||
                            ((t = e.language) ? (t.substring(0, 1).toUpperCase() + t.substring(1)).replace(/s(?=cript)/, 'S') : t);
                    if (s) {
