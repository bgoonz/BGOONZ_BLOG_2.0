...
![](https://d33wubrfki0l68.cloudfront.net/39ae29831cdc864cd65d2e51fa7afa5f4ae7d72e/99348/images/pypath.jpeg)

![](https://d33wubrfki0l68.cloudfront.net/db256a2e232065718fc5ee7f0e1184f91ed6f9aa/b7e17/images/pypath2.png)
...
There is a pyenv plugin named [pyenv-virtualenv](https://github.com/pyenv/pyenv-virtualenv) which comes with various features to help pyenv users to manage virtual environments created by virtualenv or Anaconda. Because the activate script of those virtual environments are relying on mutating $PATH variable of user's interactive shell, it will intercept pyenv's shim style command execution hooks. We'd recommend to install pyenv-virtualenv as well if you have some plan to play with those virtual environments.![](https://i.imgur.com/0hQBL4d.png)![](https://i.imgur.com/0hQBL4d.png)![](https://d33wubrfki0l68.cloudfront.net/28137af6b1d2aeaf9246d748a42e89d90e6861a6/a0d0e/images/festive-zebra.png)
