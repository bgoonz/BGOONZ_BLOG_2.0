...
-   **local packages** are installed in the directory where you run npm install &lt;package-name&gt;, and they are put in the node\_modules folder under this directory
