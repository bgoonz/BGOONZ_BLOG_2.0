...
var module = require( './module.js.js' ); //? Loads the module module.js in the same directory.
...
assert.ok( value, [ message ] ); //? Tests if value is truthy, it is equivalent to assert.equal(true, !!value, message);
