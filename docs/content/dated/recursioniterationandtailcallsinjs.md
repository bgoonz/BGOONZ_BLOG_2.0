...
UPDATE Dec 1, 2017: The only major browser with tail call optimization is Safari.<sup>1</sup> V8 has an implentation<sup>2</sup> but has not shipped it yet<sup>3</sup> for the reasons listed.
