        ...
        return (
          ...
          ( n.render = function () {
            ...
            return g( m ) ?
              ...
              s.default.createElement( 'a', ( 0, u.default )( {
                href: m
              }, v ) );
          } ),
          e
      ...
      var r = n( 'QLaP' ),
        ...
        h = function ( t, e ) {
          return {
            route: t,
            score: t.default ?
              0 : m( t.path ).reduce( function ( t, e ) {
                return (
                  ( t += 4 ),
                  !( function ( t ) {
                    return '' === t;
      ...
      t.exports = ( function () {
        ...
        return (
          ...
          r.addEventListener(
            'DOMContentLoaded',
            ( e = function () {
              for ( r.removeEventListener( 'DOMContentLoaded', e ), a = 1;
                ( e = n.shift() ); ) e();
            } )
          ),
          function ( t ) {
                          ...
                          i.a.createElement(
                            ...
                            Object.assign( {
                                path: '/404.html' === r.page.path ?
                                  Object( T.a )( o.pathname, '' ) : encodeURI( r.page.matchPath || r.page.path )
                              },
                              n.props, {
                                location: o,
                                pageResources: r
        ...
        g = ( function () {
          ...
          return (
            ...
            ( e.prefetch = function ( t ) {
              ...
              if (
                ( this.prefetchTriggered.has( t ) || ( this.apiRunner( 'onPrefetchPathname', {
                    pathname: t
