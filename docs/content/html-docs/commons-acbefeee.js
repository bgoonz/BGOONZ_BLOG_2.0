  ...
  [ 1 ],
  {
    ...
    '7Qib': function ( t, e, r ) {
      ...
      function P( t ) {
        ...
        return /^\/(?!\/)/.test( r ) ?
          L.a.createElement( M.Link, Object.assign( {
            to: r,
            activeClassName: n,
            partiallyActive: i
          }, o ), e ) :
        ...
        return t ?
          j()( t, {
            transform: function ( t, e ) {
              if ( 'script' === t.type )
                return T()( t.children ) ?
                  L.a.createElement( R.a, Object.assign( {
                    key: e
                  }, t.attribs ) ) :
                  L.a.createElement( R.a, Object.assign( {
                    key: e
      ...
      ( function ( e ) {
        !( function ( e ) {
            ...
            for ( t = t.replace( /^ +$/gm, '' ); t; )
              if (
                ( ( o = this.rules.newline.exec( t ) ) &&
                  ( ( t = t.substring( o[ 0 ].length ) ), o[ 0 ].length > 1 && this.tokens.push( {
                    type: 'space'
                  } ) ),
          ...
          ( c.prototype.parse = function ( t ) {
            ...
            ( this.inlineText = new o( t.links, b( {}, this.options, {
              renderer: new s()
            } ) ) ),
    ...
    GIBT: function ( t, e, r ) {
      ...
      function l( t, e ) {
        'foreign' === e.xmlMode &&
          ( ( t.name = o.elementNames[ t.name ] || t.name ), t.parent && u.indexOf( t.parent.name ) >= 0 && ( e = Object.assign( {}, e, {
            xmlMode: !1
          } ) ) ),
            ...
            ( e.prototype.render = function () {
              ...
              return s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  o()( t, 'content', null ) && s.a.createElement( 'div', {
                    className: 'block-content'
                  }, Object( c.g )( o()( t, 'content', null ) ) ),
                  o()( t, 'actions', null ) &&
                  s.a.createElement(
