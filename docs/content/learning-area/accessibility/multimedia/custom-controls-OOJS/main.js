...
function PlayerController(player, playPauseBtn, stopBtn, rwdBtn, fwdBtn,
                          timeLabel) {
  this.player = player;
  ...
  this.rwdBtn.onclick = function() { player.currentTime -= 3; };
...
for (let i = 0; i < players.length; i++) {
  ...
  let playerInstance =
      new PlayerController(players[i], playpause, stop, rwd, fwd, time);
}
