...
class Gui:
    def __init__(self):
        ...
        Label(
            ...
            bg="white",
            fg="black",
        ).grid(row=0, padx=10, pady=3)
        Label(window, text="Find Saved Passwords:", fg="black", bg="white").grid(
            row=1, padx=10, pady=2, rowspan=2
        )
        Button(
            window,
            text="Generate",
        ...
        ).grid(row=3, column=1, pady=10, rowspan=2)
