...
Button(
    ...
    font="Times 14 bold",
    bg="dark gray",
    command=select_task_by_name,
    width=13,
).place(x=330, y=190)
Button(
    root, text="EXIT", font="Times 14 bold", bg="dark gray", command=EXIT, width=8
).place(x=200, y=280)
Button(
    root, text="RESET", font="Times 14 bold", bg="dark gray", command=RESET, width=8
).place(x=320, y=280)
root.mainloop()
