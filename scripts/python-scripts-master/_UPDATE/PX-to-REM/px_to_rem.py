...
def process_px_to_rem():
    px = get_input(
        "[PX to REM] Enter a number of px that need to convert to rem. Enter C to Change to [REM to PX] or Q to quit!\n"
    )
...
def process_rem_to_px():
    rem = get_input(
        "[REM to PX] Enter a number of rem that need to convert to px. Enter C to Change to [PX to REM] or Q to quit!\n"
    )
