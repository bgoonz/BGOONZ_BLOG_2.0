...
if __name__ == "__main__":
    ...
    original_price = Label(gui, text="Original Price", font=(None, 18))
    ...
    net_price = Label(gui, text="Net Price", font=(None, 18))
    ...
    find = Button(gui, text="Find", fg="Black", bg="light yellow", command=GST_Calc)
