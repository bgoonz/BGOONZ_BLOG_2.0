...
reset_button = tk.Button(
    window, text="Reset", font=("arial", 18, "bold"), width=12, command=Reset
)
...
result_button = tk.Button(
    window, text="Result", font=("arial", 18, "bold"), width=12, command=result
)
result_button.place(x=600, y=450)

Speed = tk.Label(
    window, text="Speed: 00 WPM", font=("arial", 15, "bold"), bg=bg_color, fg="#ffffff"
)
Speed.place(x=120, y=530)
Accuracy = tk.Label(
    window, text="Accuracy: 00", font=("arial", 15, "bold"), bg=bg_color, fg="#ffffff"
)
Accuracy.place(x=380, y=530)
Time = tk.Label(
    window, text="Time: 0 sec", font=("arial", 15, "bold"), bg=bg_color, fg="#ffffff"
)
