...
# heading
main_label = tk.Label(
    window, text="Url Shortener", font=("Helvetica", "25"), bg="#333333", fg="white"
)
main_label.grid(row=0, column=0, padx=20, pady=20)

# Input Section
label = tk.Label(window, text="URL:", font=("Arial", "10"), bg="#333333", fg="white")
...
# Output Section
out_label = tk.Label(
    window, text="Shortened link:", font=("Arial", "12"), bg="#333333", fg="yellow"
)
out_label.grid(row=2, column=0)
str_url = tk.StringVar(window)
shortened_url = tk.Entry(
    window, font="Arial", textvariable=str_url, fg="black", bg="cyan"
)
shortened_url.grid(row=2, column=1, padx=5, pady=10)

# copy button
copy_btn = tk.Button(window, text="Copy", command=copy_url, fg="white", bg="grey")
