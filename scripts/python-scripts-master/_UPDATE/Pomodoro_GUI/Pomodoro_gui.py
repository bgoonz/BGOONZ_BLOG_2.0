...
def show_report():
    ...
    tk.Label(
        popup_3,
        text=f"Number of Pomodoros completed: {pomo_count}",
        justify=tk.LEFT,
        bg="DodgerBlue4",
        fg="white",
        font=("Arial", 12, "bold"),
    ...
    tk.Label(
        popup_3,
        text=f"Number of breaks completed: {break_count}",
        justify=tk.LEFT,
        bg="DodgerBlue4",
        fg="white",
        font=("Arial", 12, "bold"),
    ...
    tk.Label(
        popup_3,
        text=f"Hours of work done: {pomo_time} hrs",
        justify=tk.LEFT,
        bg="DodgerBlue4",
        fg="white",
        font=("Arial", 12, "bold"),
    ...
    tk.Label(
        popup_3,
        text=f"Hours of break taken: {break_time} hrs",
        justify=tk.LEFT,
        bg="DodgerBlue4",
        fg="white",
        font=("Arial", 12, "bold"),
...
def main():
    ...
    intro1 = tk.Label(
        root, text="POMODORO TIMER", bg="snow", fg="maroon", font=("Arial", 25, "bold")
    )
    intro1.place(x=100, y=100)

    blocker_btn = tk.Button(
        root,
