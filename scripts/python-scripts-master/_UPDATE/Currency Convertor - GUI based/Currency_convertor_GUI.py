...
if __name__ == "__main__":
    ...
    main_label.config(
        font=("Lato", 15, "bold"), anchor="center", bg="#3500D3", fg="white"
    )
    ...
    to_amount = tk.Label(
        screen, anchor="center", bg="white", fg="black", width=16, font=("Lato", 12)
    )
    ...
    from_currency_menu = ttk.Combobox(
        screen,
        textvariable=from_currency_code,
