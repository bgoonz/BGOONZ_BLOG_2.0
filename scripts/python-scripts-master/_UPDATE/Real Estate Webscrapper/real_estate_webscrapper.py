...
r = requests.get(
    "https://www.magicbricks.com/ready-to-move-flats-in-new-delhi-pppfs",
    headers=headers,
)
c = r.content
...
for item in all_containers:
    ...
    try:
        Price = (
            item.find("div", {"class": "m-srp-card__price"})
            .text.replace("\n", "")
            .replace(" ", "")
            .replace("₹", "")
        )
        ...
        Price = (
            item.find("span", {"class": "luxury-srp-card__price"})
            .text.replace("\n", "")
            .replace(" ", "")
            .replace("₹", "")
        )
    ...
    try:
        ...
        try:
            Pricepersqft = (
                item.find("span", {"class": "luxury-srp-card__sqft"})
                .text.replace("\n", "")
                .replace(" ", "")
                .replace("₹", "")
            )
    ...
    try:
        ...
        item_data["Carpet Area"] = item.find(
            "div", {"class": "luxury-srp-card__area__value"}
        ).text
