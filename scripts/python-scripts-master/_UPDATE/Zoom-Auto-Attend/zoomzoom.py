...
class ZoomZoom:
    ...
    def meeting_link(self, data):
        while True:
            ...
            if meeting_url in meeting_url_list:
                system(self.clear)
                saved_meeting_url = data["meetings"][meeting_url_list[meeting_url]][
                    "id"
                ]
                saved_meeting_psw = data["meetings"][meeting_url_list[meeting_url]][
                    "psw"
                ]
    ...
    def automatic_join(self, meeting_info):
        ...
        browser = webdriver.Chrome(
            options=self.chrome_options, executable_path="webdriver/chromedriver"
        )
