    ...
    try:
        ...
        if entry_path != "":
            if os.path.isdir(entry_path):
                ...
                os.chdir(entry_path)
                cwd_files = [
                    file.lower() for file in os.listdir(os.getcwd())
                ]  # Get the CWD files
                ...
                if os.path.isfile(
                    file_name
                ):  # Exclude the main script in the cleaning process if it exists in the CWD
...
header_frm.config(
    highlightthickness=0, highlightcolor="#c6d166", highlightbackground="#c6d166"
)
...
entry.config(
    highlightthickness=2.5, highlightcolor="#97b0cf", highlightbackground="#97b0cf"
)
...
folder_btn.config(
    highlightthickness=2, highlightcolor="#2160ad", highlightbackground="#2160ad"
)
folder_btn.pack()
...
clean_btn.config(
    highlightthickness=2, highlightcolor="#c4d64f", highlightbackground="#c4d64f"
)
clean_btn.pack()
