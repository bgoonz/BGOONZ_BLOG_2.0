...
def random_names(number_of_names=1):
    first_names_file = Path(
        "CSV_Database_Of_First_And_Last_Names/CSV_Database_of_First_Names.csv"
    )
    last_names_file = Path(
        "CSV_Database_Of_First_And_Last_Names/CSV_Database_of_Last_Names.csv"
    )
