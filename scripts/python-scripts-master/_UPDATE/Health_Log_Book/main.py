...
def show_exercise():
    ...
    try:
        ...
        tv.pack()
        verscrlbar = ttk.Scrollbar(new, orient="vertical", command=tv.yview)
...
exercise_heading = tk.Label(
    root,
    text=" 1) Enter each exercise separated with commas",
...
food_heading = tk.Label(
    root,
    text="2) Enter each food separated with commas",
    font=("Helvetica", 11, "bold"),
)
