...
(e = self),
    ...
    var e = {
            948: (e, t, r) => {
                ...
                function h(e, t) {
                    var r = [];
                    return Promise.resolve(e(t)).then(e => (Array.isArray(e), Promise.all(
                        e
                            .filter(e => Boolean(e))
                            .map(e => {
                ...
                function z(e) {
                    ...
                    if ((f(o), d(u.defaultActiveItemId), !o && !1 === u.openOnFocus)) {
                        var v,
                            h = c.getState().collections.map(e => M(
                                M({}, e),
                                {},
                                {
                                    items: []
                                        ...
                                        !(e => {
                                            ...
                                            if ('ArrowUp' === t.key || 'ArrowDown' === t.key) {
                                                ...
                                                if (
                                                    ...
                                                    u.getState().collections.every(e => 0 === e.items.length)
                                                )
                                                    return;
                                                t.preventDefault();
                                                var c = q(u.getState()),
                ...
                function Vt(e) {
                    ...
                    return e => {
                        ...
                        return t(
                            ...
                            Wt(xt(n))).map((e, r) => e.isHighlighted
                                ? t(
                                      a,
                                      {
                                          key: r
                ...
                function zt(e) {
                    ...
                    return e => {
                        ...
                        return t(
                            ...
                            Wt($t(n))).map((e, r) => e.isHighlighted
                                ? t(
                                      a,
                                      {
                                          key: r
                ...
                function br(e) {
                    ...
                    n(() => {
                        ...
                        return v.value && D.current.isOpen && E(!0),
                        O(D.current),
                        () => {
                        ...
                        return void 0 === r
                            ...
                            : {
                                  get(e, n) {
                                      ...
                                      return r.get(e, n, u).catch(() => a({
                                          caches: t
                                      }).get(e, n, u));
                                  },
                                  set(e, n) {
                                      return r.set(e, n).catch(() => a({
                                          caches: t
                                      }).set(e, n));
                                  },
                                  delete(e) {
                                      return r.delete(e).catch(() => a({
                                          caches: t
                                      }).delete(e));
                                  },
                                  clear() {
                                      return r.clear().catch(() => a({
                                          caches: t
                                      }).clear());
                                  }
                              };
                    ...
                    function A(e, t, n, u) {
                        var i = [],
                            ...
                            d = function t(r, o) {
                                ...
                                return e.requester.send(d).then(e => ((e, t) => (e => {
                                    var t = e.status;
                                    return e.isTimedOut || (e => {
                                        var t = e.isTimedOut,
                                            r = e.status;
                                        return !t && 0 == ~~r;
                                    })(e) ||
                                    (2 != ~~(t / 100) && 4 != ~~(t / 100));
                                })(e) ? t.onRetry(e) : 2 == ~~(e.status / 100)
                                    ? t.onSuccess(e)
                                    : t.onFail(e))(e, v));
                            };
                                        ...
                                        p = {
                                            ...
                                            read(e, t) {
                                                ...
                                                return p.responsesCache.get(
                                                    o,
                                                    () => p.requestsCache.get(o, () => p.requestsCache
                                                        .set(o, n())
                                                        .then(
