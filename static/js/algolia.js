    ...
    (() => {
        var e = {
            948: (e, t, r) => {
                        ...
                        getInputProps(e) {
                            ...
                            return ie({
                                    ...
                                    'aria-activedescendant': n.getState().isOpen && null !== n.getState().activeItemId ?
                                        ''.concat(t.id, '-item-').concat(n.getState().activeItemId) : void 0,
                            ...
                            var r = ge(
                                ge({}, e), {}, {
                                    activeItemId: t.payload.hasOwnProperty('nextActiveItemId') ?
                                        t.payload.nextActiveItemId : De(1, e.activeItemId, s(e), t.props.defaultActiveItemId)
                                }
                            );
                            return ge(
                                ge({}, r), {}, {
                ...
                var vr = (e) => e && 'object' === mr(e) && '[object Object]' === Object.prototype.toString.call(e);
                function hr(...args) {
                    for (var e = args.length, t = new Array(e), r = 0; r < e; r++) t[r] = args[r];
                    return t.reduce(
                        (e, t) => (
                ...
                function br(e) {
                    var t,
                        ...
                        v = a(() => m.value.core.environment.matchMedia(m.value.renderer.detachedMediaQuery).matches),
                        h = a(() =>
                            Ce(
                                yr(
                                    yr({}, m.value.core), {}, {
                                        ...
                                        shouldPanelOpen: p.current.shouldPanelOpen ||
                                            ((e) => {
                                                var t = e.state;
                                                if (v.value) return !0;
                                                var r = s(t) > 0;
                ...
                var xr = ((e) => {
                    ...
                    ((e) => {
                        var t = e.searchClient,
                            ...
                            u = void 0 === n ? [] : n;
                        return (
                            'function' == typeof t.addAlgoliaAgent && [].concat(wr(pe), wr(u)).forEach((e) => {
                                var r = e.segment,
                                    n = e.version;
                ...
                e.exports = (() => {
                        ...
                        return (
                            ...
                            ((e, t) => {
                                if (Symbol.iterator in Object(e) || '[object Arguments]' === Object.prototype.toString.call(e)) {
                                    ...
                                    try {
                                        for (
                                            var i, a = e[Symbol.iterator](); !(n = (i = a.next()).done) && (r.push(i.value), !t || r.length !== t); n = !0
                                        );
                                    } catch (e) {
                                        (u = !0), (o = e);
                                    } finally {
                    ...
                    function i(e) {
                        var t,
                            ...
                            n = () => (void 0 === t && (t = e.localStorage || window.localStorage), t),
                    ...
                    function O(e, t) {
                        return Promise.all(t.map((t) => e.get(t, () => Promise.resolve(y(t))))).then((e) => {
                            var r = e.filter((e) => ((e) => e.status === v || Date.now() - e.lastUpdate > 12e4)(e)),
