                        ...
                        e =
                            {
                              948 : (e, t, r) => {
                                ...
                                function N(e) {
                                  var t =
                                      e.reduce((e, t) => {
                                         if (!k(t))
                                           return e.push(t), e;
                                         var r = t.searchClient, n = t.execute,
                                             u = t.requests,
                                             o = e.find(
                                                 (e) => k(t) && k(e) &&
                                                        e.searchClient === r &&
                                ...
                                function q(e) {
                                  var t = ((e) => {
                                    var t =
                                        e.collections.map((e) => e.items.length)
                                            .reduce(
                                                (e, t, r) => {
                                                  var n = (e[r - 1] || 0) + t;
                                                  return e.push(n), e;
                                ...
                                function z(e) {
                                  var t = e.event, r = e.nextState,
                                      ...
                                      o = e.query, a = e.refresh, c = e.store,
                                      l = H(e, R);
                                ...
                                function le(e) {
                                  var t = e.props, r = e.refresh, n = e.store,
                                      u = ce(e, ee);
                                  return {
                                    getEnvironmentProps(e) {
                                      var r = e.inputElement, u = e.formElement,
                                          o = e.panelElement;
                                      return ie({
                                        onTouchStart(e) {
                                          !1 !== n.getState().isOpen &&
                                      ...
                                      r = ((e, t) => {
                                        ...
                                        return b(
                                            b({
                                              ...
                                              environment : n,
                                              shouldPanelOpen(
                                                  e) { return s(e.state) > 0; },
                                              reshape(e) { return e.sources; },
                                            },
                                              e),
                                            {}, {
                                              id : null !== (r = e.id) &&
                                ...
                                function Pe(e, t) {
                                  ...
                                  return function(...args) {
                                    for (var n = args.length, u = new Array(n),
                                             o = 0;
                                         o < n; o++)
                                      u[o] = args[o];
                                    r && clearTimeout(r),
                                ...
                                function Ie(e) { this._listeners[e.type](e); }
                                function ke(e, t, r) {
                                  var n, u, o = e[t];
                                  if ("style" === t)
                                    if ("string" == typeof r)
                                ...
                                function Ge(e) {
                                  var t = e.autocomplete,
                                      ...
                                      n = e.classNames, u = e.environment,
                                      o = e.isDetached, i = e.placeholder,
                                      a = void 0 === i ? "Search" : i,
                                      c = e.propGetters, l = e.setIsModalOpen,
                                      s = e.state, p = e.translations,
                                      f = Ue(u),
                                      d = c.getRootProps(ze({
                                        state : s,
                                      ...
                                      O = ((e) => {
                                        var t = e.autocompleteScopeApi,
                                            ...
                                            o = e.onDetachedEscape, i = e.state,
                                            a = Qe(e, He),
                                            c = Ue(r)("input", a),
                                            l = n(Ve({
                                              state : i,
                                ...
                                function it(e, t, r) {
                                  ...
                                  if (arguments.length > 3)
                                    for (r = [ r ], o = 3; o < arguments.length;
                                         o++)
                                      r.push(i[o]);
                                  ...
                                  if ("string" == typeof r) e.style.cssText = r;
                                    ...
                                    if (r)
                                      ...
                                      r ? n || e.addEventListener(
                                                   t, o ? bt : gt, o)
                                        : e.removeEventListener(t, o ? bt : gt,
                                                                o);
                                ...
                                function At(e, t, r, n, u, o, i, a) {
                                  ...
                                  if (null === m)
                                    ...
                                    if (((o = o && rt.slice.call(e.childNodes)),
                                         (l = (f = r.props || tt)
                                                  .dangerouslySetInnerHTML),
                                         (s = d.dangerouslySetInnerHTML), !a)) {
                                      if (null != o)
                                        for (f = {}, p = 0;
                ...
                : []
                                ...
                                function xt(e) {
                                  var t = e.hit, r = e.attribute,
                                      ...
                                      u = jt(t, [ "_highlightResult" ].concat(
                                                    It(n), [ "value" ]));
                                ...
                                function br(e) {
                                  ...
                                  function O(e) {
                                    ...
                                    var t = {
                                      ...
                                      createElement : m.value.renderer.renderer
                                                          .createElement,
                                      dom : b.value,
                                      Fragment :
                                    ...
                                    !((e) => {
                                      var t = e.autocomplete,
                                          r = e.autocompleteScopeApi, n = e.dom,
                                          u = e.propGetters, o = e.state;
                                      Te(n.root, u.getRootProps(lr({
                                        state : o,
                                        props : t.getRootProps({}),
                                      },
                                                                   r))),
                                          Te(n.input, u.getInputProps(lr({
                                            state : o,
                                  ...
                                  function E(e) {
                                    requestAnimationFrame(() => {
                                      var t = m.value.core.environment.document
                                                  .body.contains(
                                      ...
                                      n(() => {
                                        var e = v.value
                                            ...
                                            t = v.value
                                                    ? b.value.detachedOverlay
                                                    : b.value.panel;
                                        return (v.value && D.current.isOpen &&
                                                    E(!0),
                                                O(D.current), () => {
                                                  e.contains(t) &&
                                                      e.removeChild(t);
                                  ...
                                  if ("string" == typeof r) e.style.cssText = r;
                                    ...
                                    if (r)
                                      ...
                                      (t = t.toLowerCase() in e
                                               ...
                                               : t.slice(2)),
                                      e.l || (e.l = {}), (e.l[t + o] = r),
                                      r ? n || e.addEventListener(t, o ? P : F,
                                                                  o)
                                        : e.removeEventListener(t, o ? P : F,
                                                                o);
                                  else if ("dangerouslySetInnerHTML" !== t) {
                                    if (u)
                                      t = t.replace(/xlink[H:h]/, "h")
