          ...
          948: (e, t, r) => {
            ...
            function z(e) {
              ...
              var s = l.setCollections,
                ...
                m = l.setStatus;
              if (
                (f(o), d(u.defaultActiveItemId), !o && !1 === u.openOnFocus)
              ) {
                var v,
              ...
              function O(e, t) {
                return Promise.all(
                  ...
                  var r = e.filter(function (e) {
                      return (function (e) {
                        return (
                          e.status === v || Date.now() - e.lastUpdate > 12e4
                        );
                      })(e);
                    }),
                    n = e.filter(function (e) {
                      return (function (e) {
                        return (
                          e.status === D && Date.now() - e.lastUpdate <= 12e4
                        );
                      })(e);
                    }),
                    u = [].concat(o(r), o(n));
                  ...
                  o = {
                    ...
                    logger:
                      ((u = L),
                      {
                        debug: function (e, t) {
                          return (
                            q >= u && console.debug(e, t), Promise.resolve()
                          );
                        },
                        info: function (e, t) {
                          return (
                            R >= u && console.info(e, t), Promise.resolve()
                          );
                        },
                        error: function (e, t) {
