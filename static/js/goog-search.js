...
var g = this || self, k = function(a, b) {
  ...
  a.j = function(e, c, f) {
    for (var h = Array(arguments.length - 2), q = 2; q < arguments.length; q++)
      h[q - 2] = arguments[q];
...
var x = function(a) {
  if (a instanceof w && a.constructor === w && a.i === v)
    return a.h;
...
var A =
        function(a) {
  if (a instanceof z && a.constructor === z)
    return a.g;
  var b = typeof a;
  r("expected object of type TrustedResourceUrl, got '" + a + "' of type " +
    ('object' != b ? b
    ...
    E =
      ...
      a = d.replace(C, function(e, c) {
        if (!Object.prototype.hasOwnProperty.call(b, c))
          throw Error('Found marker, "' + c + '", in format string, "' + d +
      ...
      if (void 0 === t) {
        ...
        if (d && d.createPolicy)
          try {
            b = d.createPolicy(
                'goog#html',
                {createHTML : l, createScript : l, createScriptURL : l});
          } catch (e) {
...
function ca(a) {
  return 'function' === typeof a                                    ? a
         : 'string' === typeof a && 'function' === typeof window[a] ? window[a]
                                                                    : null;
}
...
function N(a) {
  ...
  } if (c && 'undefined' != typeof c.HTMLLinkElement &&
        (!b || (!(b instanceof c.HTMLLinkElement) &&
                (b instanceof c.Location || b instanceof c.Element)))) {
    c = typeof b;
    if (('object' == c && null != b) || 'function' == c)
      try {
        var f = b.constructor.displayName || b.constructor.name ||
                Object.prototype.toString.call(b);
      } catch (h) {
        f = '<object could not be stringified>';
      }
    else
      f = void 0 === b ? 'undefined' : null === b ? 'null' : typeof b;
    r('Argument is not a %s (or a non-Element, non-Location mock); got: %s',
      'HTMLLinkElement', f);
  }
  b.rel = 'stylesheet';
  p(a instanceof z,
  ...
  b.href = A(a).toString();
  a: {a = ((b.ownerDocument && b.ownerDocument.defaultView) || g).document;
      if (a.querySelector &&
          (a = a.querySelector('style[nonce],link[rel="stylesheet"][nonce]')) &&
          (a = a.nonce || a.getAttribute('nonce')) && aa.test(a))
                break a;
            a = '';
        }
...
if (M()) {
  ...
  uiOptions : {
    ...
    enableOrderBy : true,
    orderByOptions :
        [ {label : 'Relevance', key : ''}, {label : 'Date', key : 'date'} ],
