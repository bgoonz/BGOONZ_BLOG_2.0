  ...
  return function(e, t) {
    ...
    for (var o = 0; o < i.length; o += 1) {
      ...
      if (!(-1 !== r.className.split(' ').indexOf(n) ||
        ...
        var d = ((r.getAttribute('height') || r.offsetHeight) /
        ...
        (a.position = 'absolute'), (a.width = '100%'), (a.height = '100%'),
            (a.left = '0'), (a.top = '0'), r.parentNode.insertBefore(f, r),
            r.parentNode.removeChild(r), f.appendChild(r);
      }
    }
  };
});
...
function docsNavToggleHandler(e) {
  ...
  document.getElementsByClassName('docs-content')[0].classList.toggle(
      'docs-menu--opened'); // can't attach to body since we limit the scope of
  ...
  if (pageToc && pageTocContainer) {
    ...
    if (pageTocLinks.length > 0) {
      let spy = new Gumshoe('#page-nav-inside a',
                            {nested : true, nestedClass : 'active-parent'});
    }
