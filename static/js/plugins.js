...
Element.prototype.closest || (Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest = function(t) {
    ...
    return function(o, c) {
        var r, l, f, d, m, v = {};
        v.setup = function() {
            r = document.querySelectorAll(o), l = [], Array.prototype.forEach.call(r, (function(t) {
        ...
        v.destroy = function() {
            f && a(f, m), t.removeEventListener("scroll", p, !1), m.reflow && t.removeEventListener("resize", h, !1), l = null, r = null, f = null, d = null, m = null
        };
        return m = (function() {
            var t = {};
            return Array.prototype.forEach.call(arguments, (function(e) {
        ...
        })(e, c || {}), v.setup(), v.detect(), t.addEventListener("scroll", p, !1), m.reflow && t.addEventListener("resize", h, !1), v
    }
}));
/*!
 * clipboard.js v2.0.4
