...
!(function (e, t) {
  ...
  return function (e, s) {
    return void 0 === s && (s = 'js-reframe'), ('string' == typeof e
      ? t (document.querySelectorAll (e))
      : 'length' in e ? t (e) : [e]).forEach (function (e) {
      var t, n, i, o, r, f, d, l;
      -1 !== e.className.split (' ').indexOf (s) ||
        -1 < e.style.width.indexOf ('%') ||
        ((i = e.getAttribute ('height') || e.offsetHeight), (o =
          e.getAttribute ('width') || e.offsetWidth), (r =
          ('string' == typeof i ? parseInt (i) : i) /
          ('string' == typeof o ? parseInt (o) : o) *
          100), ((f = document.createElement ('div')).className = s), ((d =
          f.style).position =
          'relative'), (d.width = '100%'), (d.paddingTop = r + '%'), ((l =
          e.style).position =
          'absolute'), (l.width = '100%'), (l.height = '100%'), (l.left =
          '0'), (l.top = '0'), null !== (t = e.parentNode) &&
          void 0 !== t &&
          t.insertBefore (f, e), null !== (n = e.parentNode) &&
          void 0 !== n &&
          n.removeChild (e), f.appendChild (e));
    });
  };
});
...
window.Element &&
  ...
  function (q) {
    ...
    var I = {
      ...
      x = function (e) {
        return e
          ? ((t = e), parseInt (q.getComputedStyle (t).height, 10) +
              e.offsetTop)
          : 0;
        var t;
      },
    ...
    return function (o, e) {
      ...
      (M.cancelScroll = function (e) {
        ...
        if (u || t) {
          ...
          var n,
            ...
            g = u
              ...
              : (function (e, t, n, o) {
                  ...
                  return (a = Math.max (a - t - n, 0)), o &&
                    (a = Math.min (a, L () - q.innerHeight)), a;
                }) (
                  t,
                  p,
                  parseInt (
                    'function' == typeof s.offset ? s.offset (i, c) : s.offset,
                    10
                  ),
                  s.clip
                ),
            ...
            v = L (),
            w = 0,
            S = ((n = y), (a = (o = s).speedAsDuration
              ? o.speed
              : Math.abs (n / 1e3 * o.speed)), o.durationMax &&
              a > o.durationMax
              ? o.durationMax
            ...
            E = function (e, t) {
              ...
              if (e == t || r == t || (l < t && q.innerHeight + r) >= v)
                return M.cancelScroll (!0), (o = t), (a = u), 0 === (n = i) &&
                  document.body.focus (), a ||
                  (n.focus (), document.activeElement !== n &&
                    (n.setAttribute (
                      'tabindex',
                      '-1'
                    ), n.focus (), (n.style.outline = 'none')), q.scrollTo (
                    0,
                    o
            ...
            b = function (e) {
              ...
              m || (m = e), (w += e - m), (d =
                ...
                y *
                  ((n = r = 1 < (r = 0 === S ? 0 : w / S)
                    ? 1
                    : r), 'easeInQuad' === (t = s).easing &&
                    (o = n * n), 'easeOutQuad' === t.easing &&
                    (o = n * (2 - n)), 'easeInOutQuad' === t.easing &&
                    (o = n < 0.5
                      ? 2 * n * n
                      : (4 - 2 * n) * n - 1), 'easeInCubic' === t.easing &&
                    (o = n * n * n), 'easeOutCubic' === t.easing &&
                    (o = --n * n * n + 1), 'easeInOutCubic' === t.easing &&
                    (o = n < 0.5
                      ? 4 * n * n * n
                      : (n - 1) * (2 * n - 2) * (2 * n - 2) +
                          1), 'easeInQuart' === t.easing &&
                    (o = n * n * n * n), 'easeOutQuart' === t.easing &&
                    (o = 1 - --n * n * n * n), 'easeInOutQuart' === t.easing &&
                    (o = n < 0.5
                      ? 8 * n * n * n * n
                      : 1 - 8 * --n * n * n * n), 'easeInQuint' === t.easing &&
                    (o = n * n * n * n * n), 'easeOutQuint' === t.easing &&
                    (o = 1 + --n * n * n * n * n), 'easeInOutQuint' ===
                    t.easing &&
                    (o = n < 0.5
                      ? 16 * n * n * n * n * n
                      : 1 + 16 * --n * n * n * n * n), t.customEasing &&
                    (o = t.customEasing (n)), o || n)), q.scrollTo (
                0,
                Math.floor (d)
              ), E (d, g) || ((C = q.requestAnimationFrame (b)), (m = e));
            };
          0 === q.pageYOffset && q.scrollTo (0, 0), (f = i), (h = s), u ||
            (history.pushState &&
              h.updateURL &&
              history.pushState (
            ...
            : (H ('scrollStart', s, i, c), M.cancelScroll (
                !0
      ...
      return (function () {
        ...
        M.destroy (), (A = F (I, e || {})), (O = A.header
          ? document.querySelector (A.header)
          : null), document.addEventListener ('click', t, !1), A.updateURL &&
          A.popstate &&
...
Element.prototype.closest ||
  (Element.prototype.matches ||
    (Element.prototype.matches =
      ...
      Element.prototype
        .webkitMatchesSelector), (Element.prototype.closest = function (t) {
    var e = this;
    ...
    var e = {
      ...
      a = function (t, e) {
        if (t) {
          ...
          o &&
            (o.classList.remove (e.navClass), t.content.classList.remove (
              e.contentClass
    ...
    return function (o, c) {
      ...
      (v.setup = function () {
        (r = document.querySelectorAll (
          o
        )), (l = []), Array.prototype.forEach.call (r, function (t) {
          ...
          ? (f && t.content === f.content) ||
              (a (f, m), (function (t, e) {
                if (t) {
                  var o = t.nav.closest ('li');
                  o &&
                    (o.classList.add (e.navClass), t.content.classList.add (
                      e.contentClass
                    ), u (o, e), n ('gumshoeActivate', o, {
                      link: t.nav,
                      content: t.content,
                      settings: e,
                    }));
      ...
      var p = function (e) {
        d && t.cancelAnimationFrame (d), (d = t.requestAnimationFrame (
          v.detect
        ));
      },
        h = function (e) {
      ...
      v.destroy = function () {
        f && a (f, m), t.removeEventListener ('scroll', p, !1), m.reflow &&
          t.removeEventListener (
            'resize',
            h,
            !1
          ), (l = null), (r = null), (f = null), (d = null), (m = null);
      };
      return (m = (function () {
        var t = {};
        return Array.prototype.forEach.call (arguments, function (e) {
        ...
        p,
        !1
      ), m.reflow && t.addEventListener ('resize', h, !1), v;
    };
  }
);
  ...
  return (function (n) {
          ...
          [
            {
              ...
              value: function () {
                ...
                (this.action = 'function' == typeof t.action
                  ...
                  typeof t.text
                  ? t.text
                  : this.defaultText), (this.container = 'object' ===
                  r (t.container)
                  ? t.container
                  : document.body);
              },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                this.clipboardAction &&
                  (this.clipboardAction = null), (this.clipboardAction = new a.default (
                  {
        ...
        return i (e, [
          {
            ...
            value: function () {
              var t = 0 < arguments.length && void 0 !== arguments[0]
                ? arguments[0]
                : {};
              (this.action = t.action), (this.container =
                t.container), (this.emitter = t.emitter), (this.target =
                t.target), (this.text = t.text), (this.trigger =
                t.trigger), (this.selectedText = '');
            },
          },
          {
            key: 'initSelection',
            ...
            value: function () {
              this.fakeHandler &&
                (this.container.removeEventListener (
                  'click',
                  this.fakeHandlerCallback
                ), (this.fakeHandler = null), (this.fakeHandlerCallback = null)), this
                .fakeElem &&
          ...
          },
          {
            ...
            set: function () {
              var t = 0 < arguments.length && void 0 !== arguments[0]
                ...
                : 'copy';
              if (
                ((this._action = t), 'copy' !== this._action &&
                  'cut' !== this._action)
              )
                throw new Error (
    ...
    function (t, e) {
      t.exports = function (t) {
        ...
        if ('SELECT' === t.nodeName) t.focus (), (e = t.value);
          ...
          n ||
            t.setAttribute ('readonly', ''), t.select (), t.setSelectionRange (
            0,
            t.value.length
          ...
          r.selectNodeContents (t), o.removeAllRanges (), o.addRange (
            r
          ), (e = o.toString ());
        }
        return e;
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        if (d.nodeList (t))
          return (a = t), (c = e), (u = n), Array.prototype.forEach.call (
            a,
            function (t) {
    ...
    function (t, e, n) {
      ...
      function i (t, e, n, o, r) {
        var i = function (e, n, t, o) {
          return function (t) {
            (t.delegateTarget = a (t.target, n)), t.delegateTarget &&
              o.call (e, t);
          };
