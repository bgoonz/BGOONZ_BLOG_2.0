...
window.Element && !Element.prototype.closest &&
    ...
    (function() {
      for (var r = 0, e = [ 'ms', 'moz', 'webkit', 'o' ], t = 0;
      ...
      window.requestAnimationFrame ||
          (window.requestAnimationFrame =
               function(e, t) {
                 var n = new Date().getTime(), o = Math.max(0, 16 - (n - r)),
         ...
         var I = {
           ...
           emitEvents : !0
             ...
             F = function() {
               ...
               for (var t, n = String(e), o = n.length, a = -1, r = '',
                           i = n.charCodeAt(0);
                    ++a < o;) {
               ...
               return e ? ((t = e), parseInt(q.getComputedStyle(t).height, 10) +
                                        e.offsetTop)
                        : 0;
               var t;
             }, H = function(e, t, n, o) {
               if (t.emitEvents && 'function' == typeof q.CustomEvent) {
                 var a = new CustomEvent(
                     e, {bubbles : !0, detail : {anchor : n, toggle : o}});
         ...
         return function(o, e) {
             ...
             if (u || t) {
               ...
               var n, o, a, m, r, d, f, h,
                   ...
                   g = u ? i
                         : (function(e, t, n, o) {
                             ...
                             return (a = Math.max(a - t - n, 0)),
                              ...
                              parseInt('function' == typeof s.offset
                                           ? s.offset(i, c)
                                           : s.offset,
                                       10),
                              s.clip),
                   ...
                   S = ((n = y),
                        ...
                        o.durationMax && a > o.durationMax   ? o.durationMax
                        : o.durationMin && a < o.durationMin ? o.durationMin
                                                             : parseInt(a, 10)),
                   E = function(e, t) {
                     var n, o, a, r = q.pageYOffset;
                     if (e == t || r == t || (l < t && q.innerHeight + r) >= v)
                       return (M.cancelScroll(!0), (o = t), (a = u),
                               0 === (n = i) && document.body.focus(),
                               a ||
                                   (n.focus(),
                                    document.activeElement !== n &&
                                        (n.setAttribute('tabindex', '-1'),
                                         n.focus(), (n.style.outline = 'none')),
                                    q.scrollTo(0, o)),
               ...
               0 === q.pageYOffset && q.scrollTo(0, 0), (f = i), (h = s),
                   u || (history.pushState && h.updateURL &&
                         history.pushState(
                             {smoothScroll : JSON.stringify(h), anchor : f.id},
                             document.title,
                             f === document.documentElement ? '#top'
                                                            : '#' + f.id)),
                   'matchMedia' in q &&
                           q.matchMedia('(prefers-reduced-motion)').matches
                       ? q.scrollTo(0, Math.floor(g))
                       : (H('scrollStart', s, i, c), M.cancelScroll(!0),
           ...
           var t = function(e) {
             if (!e.defaultPrevented &&
                 ...
                 'closest' in e.target && (a = e.target.closest(o)) &&
                 'a' === a.tagName.toLowerCase() &&
                 !e.target.closest(A.ignore) &&
                 a.hostname === q.location.hostname &&
                 a.pathname === q.location.pathname && /#/.test(a.href)) {
               var t, n = r(a.hash);
               if ('#' === n) {
                 if (!A.topOnEmptyHash)
                   return;
               ...
               (t = t || '#top' !== n ? t : document.documentElement) &&
                   (e.preventDefault(), (function(e) {
                      if (history.replaceState && e.updateURL &&
                          !history.state) {
             ...
             if (null !== history.state && history.state.smoothScroll &&
           ...
           M.destroy = function() {
             A && (document.removeEventListener('click', t, !1),
                   q.removeEventListener('popstate', n, !1), M.cancelScroll(),
                   (C = O = a = A = null));
           };
           return (
               (function() {
                 if (!('querySelector' in document && 'addEventListener' in q &&
      ...
      : 'object' == typeof exports ? (module.exports = e(t))
       ...
       function(t) {
             ...
             n = function(t, e, n) {
               if (n.settings.events) {
                 var o = new CustomEvent(
                     t, {bubbles : !0, cancelable : !0, detail : n});
                 e.dispatchEvent(o);
               }
             }, o = function(t) {
               var e = 0;
               ...
               t && t.sort(function(
                        t, e) { return o(t.content) < o(e.content) ? -1 : 1; });
             }, c = function(e, n, o) {
               ...
               return o ? parseInt(s.bottom, 10) <
                              (t.innerHeight ||
                               document.documentElement.clientHeight)
                        : parseInt(s.top, 10) <= c;
             }, r = function() {
               return (t.innerHeight + t.pageYOffset >=
               ...
               var n = t[t.length - 1];
               if ((function(t, e) { return !(!r() || !c(t.content, e, !0)); })(
                       n, e))
                 return n;
               ...
               if (t) {
                 ...
                 o && (o.classList.remove(e.navClass),
                       t.content.classList.remove(e.contentClass), l(o, e),
                       n('gumshoeDeactivate', o,
                         {link : t.nav, content : t.content, settings : e}));
               }
             }, u = function(t, e) {
               if (e.nested) {
                 var n = t.parentNode.closest('li');
         ...
         return function(o, c) {
           var r, l, f, d, m, v = {};
           (v.setup = function() {
             (r = document.querySelectorAll(o)), (l = []),
           ...
           var p = function(e) {
             ...
             d && t.cancelAnimationFrame(d),
                 (d = t.requestAnimationFrame(
                      function() { s(l), v.detect(); }));
           };
           v.destroy = function() {
             f && a(f, m), t.removeEventListener('scroll', p, !1),
                 m.reflow && t.removeEventListener('resize', h, !1), (l = null),
                 (r = null), (f = null), (d = null), (m = null);
           };
           return ((m = (function() {
                      var t = {};
                      return (
                   ...
                   v.setup(), v.detect(), t.addEventListener('scroll', p, !1),
...
!(function(t, e) {
  ...
  : 'object' == typeof exports                ? (exports.ClipboardJS = e())
                                              : (t.ClipboardJS = e());
})(this, function() {
  return (function(n) {
    var o = {};
        ...
        return (
            ...
            i(o,
              [
                ...
                },
                {
                  ...
                  value : function(t) {
                    ...
                    this.listener = (0, u.default)(
                        t, 'click', function(t) { return e.onClick(t); });
                  }
                },
                {
                  key : 'onClick',
                ...
                {
                  key : 'defaultAction',
                  value : function(t) { return s('action', t); }
                },
                {
                  key : 'defaultTarget',
                  value : function(t) {
                ...
                {
                  key : 'defaultText',
                  value : function(t) { return s('text', t); }
                },
                {
                  key : 'destroy',
                  value : function() {
              ...
              [ {
                ...
                value : function() {
                  ...
                  return (
                      e.forEach(function(
                          t) { n = n && !!document.queryCommandSupported(t); }),
                      n);
                }
              } ]),
            o);
              ...
              [
                {
                  ...
                  value : function() {
                    ...
                    (this.action = t.action), (this.container = t.container),
                        ...
                        (this.text = t.text), (this.trigger = t.trigger),
                        (this.selectedText = '');
                  }
                },
                {
                  ...
                  value : function() {
                    ...
                    this.removeFake(),
                        (this.fakeHandlerCallback =
                             function() { return t.removeFake(); }),
                        (this.fakeHandler =
                             this.container.addEventListener(
                                 'click', this.fakeHandlerCallback) ||
                             !0),
    ...
    function(t, e) {
      t.exports = function(t) {
        ...
        if ('SELECT' === t.nodeName)
          ...
          n || t.setAttribute('readonly', ''), t.select(),
              t.setSelectionRange(0, t.value.length),
              n || t.removeAttribute('readonly'), (e = t.value);
        } else {
          t.hasAttribute('contenteditable') && t.focus();
          var o = window.getSelection(), r = document.createRange();
          r.selectNodeContents(t), o.removeAllRanges(), o.addRange(r),
              (e = o.toString());
        }
        return e;
      };
    ...
    function(t, e) {
      ...
      (n.prototype = {
        ...
        emit : function(t) {
          for (var e = [].slice.call(arguments, 1),
                   n = ((this.e || (this.e = {}))[t] || []).slice(), o = 0,
                   r = n.length;
               o < r; o++)
      ...
      t.exports = function(t, e, n) {
        ...
        if (d.node(t))
          return ((s = e), (f = n), (l = t).addEventListener(s, f),
                  {destroy : function() { l.removeEventListener(s, f); }});
        if (d.nodeList(t))
          return ((a = t), (c = e), (u = n),
                  Array.prototype.forEach.call(
                      a, function(t) { t.addEventListener(c, u); }),
                  {
                    destroy : function() {
                      Array.prototype.forEach.call(
                          a, function(t) { t.removeEventListener(c, u); });
                    }
                  });
        if (d.string(t))
    ...
    function(t, e, n) {
      ...
      function i(t, e, n, o, r) {
        ...
        return (t.addEventListener(n, i, r),
                {destroy : function() { t.removeEventListener(n, i, r); }});
      }
               ...
               : 'function' == typeof n
                   ...
                   : ('string' == typeof t &&
                      ...
                      Array.prototype.map.call(
                          t, function(t) { return i(t, e, n, o, r); }));
      };
    },
    function(t, e) {
      if ('undefined' != typeof Element && !Element.prototype.matches) {
        ...
        n.matches = n.matchesSelector || n.mozMatchesSelector ||
                    n.msMatchesSelector || n.oMatchesSelector ||
