...
!(function (t, e) {
                ...
                ? (function (t, e, i) {
                      return function s(n) {
                          ...
                          for (let { target: r } = n; r && r !== this; r = r.parentNode)
                              for (let a = o.length; a--; ) if (o[a] === r) return (n.delegateTarget = r), s.oneOff && H.off(t, n.type, e, i), i.apply(r, [n]);
                          return null;
                      };
                  })(t, i, s)
                : (function (t, e) {
    ...
    class et extends R {
        ...
        pause(t) {
            t || (this._isPaused = !0),
                V.findOne('.carousel-item-next, .carousel-item-prev', this._element) && (r(this._element), this.cycle(!0)),
...
!(function (e, t) {
    ...
    function u(e, n, r) {
        ...
        return (
            (u || (!u && !r)) &&
                (('body' !== s(n) || l(c)) && (d = n !== t(n) && o(n) ? { scrollLeft: n.scrollLeft, scrollTop: n.scrollTop } : a(n)),
    ...
    function d(e) {
        var t = i(e),
            ...
            o = e.offsetHeight;
        return (
            1 >= Math.abs(t.width - n) && (n = t.width), 1 >= Math.abs(t.height - o) && (o = t.height), { x: e.offsetLeft, y: e.offsetTop, width: n, height: o }
        );
    }
