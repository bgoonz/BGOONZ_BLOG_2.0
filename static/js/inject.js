  ...
  class pt extends R {
    ...
    show() {
      ...
      this._inNavbar ? K.setDataAttribute( this._menu, 'popper', 'none' ) : this._createPopper( e ),
        ...
        !e.closest( '.navbar-nav' ) && [].concat( ...document.body.children ).forEach( ( t ) => H.on( t, 'mouseover', g ) ),
        this._element.focus(),
    ...
    _getPopperConfig() {
      ...
      return (
        'static' === this._config.display && ( t.modifiers = [ {
          name: 'applyStyles',
          enabled: !1
        } ] ), {
          ...t,
...
!( function ( e, t ) {
  ...
  function d( e ) {
    var t = i( e ),
      ...
      o = e.offsetHeight;
    return (
      1 >= Math.abs( t.width - n ) && ( n = t.width ), 1 >= Math.abs( t.height - o ) && ( o = t.height ), {
        x: e.offsetLeft,
        y: e.offsetTop,
        width: n,
        height: o
    ...
    re = {
      ...
      fn: function ( e ) {
        ...
        if ( ( ( e = L( s ) ), ( s = 0 <= [ 'left', 'right' ].indexOf( s ) ? 'height' : 'width' ), i && a ) ) {
          r = P(
            'number' != typeof ( r = 'function' == typeof ( r = r.padding ) ? r( Object.assign( {}, n.rects, {
