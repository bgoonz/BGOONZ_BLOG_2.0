...
!(function(t, e) {
    ...
    return (t && Object.keys(t).forEach(function(i) {
      if ('default' !== i) {
        ...
        Object.defineProperty(
            e, i,
            s.get ? s : {enumerable : !0, get : function() { return t[i]; }});
      }
    }),
  ...
  const s =
      (t) => {
        ...
        l = (t) =>
            (a(t)                                   ? (t.jquery ? t[0] : t)
             : 'string' == typeof t && t.length > 0 ? document.querySelector(t)
                                                    : null),
        c =
            (t, e, i) => {
              Object.keys(i).forEach((s) => {
                ...
                if (!new RegExp(n).test(r))
                  throw new TypeError(`${t.toUpperCase()}: Option "${
                      s}" provided type "${r}" but expected type "${n}".`);
              });
            },
        h = (t) =>
            !(!a(t) || 0 === t.getClientRects().length) &&
            'visible' === getComputedStyle(t).getPropertyValue('visibility'),
        d = (t) => !t || t.nodeType !== Node.ELEMENT_NODE ||
        ...
        u =
            (t) => {
              ...
              return t instanceof ShadowRoot ? t
                     : t.parentNode          ? u(t.parentNode)
                                             : null;
            },
        g = () => {}, p = (t) => { t.offsetHeight; },
        f =
            () => {
            ...
            (t) => {
              ...
              (e =
                  ...
                  'loading' === document.readyState
                      ? (_.length || document.addEventListener(
                                         'DOMContentLoaded',
                                         () => { _.forEach((t) => t()); }),
                         _.push(e))
                      : e();
            },
        v = (t) => { 'function' == typeof t && t(); }, w = (t, e, i = !0) => {
          if (!i)
            return void v(t);
          const s =
              ((t) => {
                ...
                return s || n ? ((e = e.split(',')[0]), (i = i.split(',')[0]),
  ...
  function x(t, e, i, s, n) {
    ...
    const [o, r, a] = P(e, i, s), l = D(t), c = l[a] || (l[a] = {}),
                 h = I(c, r, o ? i : null);
    if (h)
  ...
  const H = {
    on(t, e, i, s) { x(t, e, i, s, !1); },
    one(t, e, i, s) { x(t, e, i, s, !0); },
    off(t, e, i, s) {
      if ('string' != typeof e || !t)
        return;
      const [n, o, r] = P(e, i, s), a = r !== e, l = D(t),
                   c = e.startsWith('.');
      if (void 0 !== o) {
        if (!l || !l[r])
          return;
    ...
    trigger(t, e, i) {
      ...
      return (
          o && s &&
              ((a = s.Event(e, i)), s(t).trigger(a),
               (l = !a.isPropagationStopped()),
               (c = !a.isImmediatePropagationStopped()),
               (h = a.isDefaultPrevented())),
          r ? ((d = document.createEvent('HTMLEvents')), d.initEvent(n, l, !0))
  ...
  class q extends R {
    ...
    _destroyElement() {
      this._element.remove(), H.trigger(this._element, 'closed.bs.alert'),
          this.dispose();
    }
  ...
  H.on(document, 'click.bs.button.data-api', '[data-bs-toggle="button"]',
       (t) => {
         t.preventDefault();
  ...
  class et extends R {
    ...
    _addEventListeners() {
      this._config.keyboard &&
          ...
          'hover' === this._config.pause &&
              (H.on(this._element, 'mouseenter.bs.carousel',
                    (t) => this.pause(t)),
               H.on(this._element, 'mouseleave.bs.carousel',
                    (t) => this.cycle(t))),
    ...
    _slide(t, e) {
      ...
      if (this._element.classList.contains('slide')) {
        ...
        const t = () => {
          o.classList.remove(c, h), o.classList.add('active'),
              s.classList.remove('active', h, c), (this._isSliding = !1),
              setTimeout(u, 0);
        };
        this._queueCallback(t, s, !0);
      } else
        s.classList.remove('active'), o.classList.add('active'),
            (this._isSliding = !1), u();
      a && this.cycle();
    }
    _directionToOrder(t) {
    ...
    static jQueryInterface(t) {
      return this.each(function() { et.carouselInterface(this, t); });
    }
    static dataApiClickHandler(t) {
      ...
      s && (i.interval = !1), et.carouselInterface(e, i),
          s && et.getInstance(e).to(s), t.preventDefault();
    }
  }
  H.on(document, 'click.bs.carousel.data-api',
       '[data-bs-slide], [data-bs-slide-to]', et.dataApiClickHandler),
  ...
  class nt extends R {
    ...
    hide() {
      ...
      (this._element.style[t] =
          ...
          p(this._element), this._element.classList.add('collapsing'),
    ...
    _getConfig(t) {
      return ((t = {...it, ...K.getDataAttributes(this._element), ...t})
                  .toggle = Boolean(t.toggle)),
             (t.parent = l(t.parent)), c('collapse', t, st), t;
    }
    _getDimension() {
  ...
  H.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]',
       function(t) {
         ('A' === t.target.tagName ||
         ...
         const e = n(this);
         V.find(e).forEach(
             (t) => { nt.getOrCreateInstance(t, {toggle : !1}).toggle(); });
       }),
      b(nt);
  ...
  class pt extends R {
    ...
    show() {
      ...
      this._inNavbar ? K.setDataAttribute(this._menu, 'popper', 'none')
    ...
    _getConfig(t) {
      if (((t = {
           ...
           'object' == typeof t.reference && !a(t.reference) &&
    ...
    _createPopper(t) {
      ...
      : a(this._config.reference)         ? (e = l(this._config.reference))
                                  : 'object' == typeof this._config.reference &&
                                        (e = this._config.reference);
      const s = this._getPopperConfig(),
            n = s.modifiers.find((t) => 'applyStyles' === t.name &&
                                        !1 === t.enabled);
  ...
  H.on(document, 'keydown.bs.dropdown.data-api', '[data-bs-toggle="dropdown"]',
       pt.dataApiKeydownHandler),
      H.on(document, 'keydown.bs.dropdown.data-api', '.dropdown-menu',
           pt.dataApiKeydownHandler),
      H.on(document, 'click.bs.dropdown.data-api', pt.clearMenus),
      H.on(document, 'keyup.bs.dropdown.data-api', pt.clearMenus),
      H.on(document, 'click.bs.dropdown.data-api',
    ...
    hide() {
      ...
      this._disableOverFlow(),
          ...
          this._setElementAttributes(
              ...
              'paddingRight', (e) => e + t),
          this._setElementAttributes('.sticky-top', 'marginRight',
                                     (e) => e - t);
    }
    _disableOverFlow() {
  ...
  class bt {
    ...
    show(t) {
      this._config.isVisible
          ? (this._append(), this._config.isAnimated && p(this._getElement()),
             this._getElement().classList.add('show'),
             this._emulateAnimation(() => { v(t); }))
          : v(t);
    }
    hide(t) {
      this._config.isVisible
          ? (this._getElement().classList.remove('show'),
             this._emulateAnimation(() => { this.dispose(), v(t); }))
          : v(t);
    }
    _getElement() {
      if (!this._element) {
    ...
    _getConfig(t) {
      return ((t = {..._t, ...('object' == typeof t ? t : {})}).rootElement =
                  l(t.rootElement)),
             c('backdrop', t, mt), t;
    }
    _append() {
  ...
  class yt {
    ...
    activate() {
      ...
      this._isActive || (e && t.focus(), H.off(document, '.bs.focustrap'),
                         H.on(document, 'focusin.bs.focustrap',
                              (t) => this._handleFocusin(t)),
                         H.on(document, 'keydown.tab.bs.focustrap',
    ...
    _handleFocusin(t) {
      ...
      0 === s.length                             ? i.focus()
      : 'backward' === this._lastTabNavDirection ? s[s.length - 1].focus()
                                                 : s[0].focus();
    }
    _handleKeydown(t) {
      'Tab' === t.key &&
  ...
  class Tt extends R {
    ...
    _showElement(t) {
      ...
      (this._element.parentNode &&
       this._element.parentNode.nodeType === Node.ELEMENT_NODE) ||
          ...
          e && p(this._element), this._element.classList.add('show'),
          this._queueCallback(() => {
      ...
      (this._element.style.display = 'none'),
          ...
          this._backdrop.hide(() => {
            document.body.classList.remove('modal-open'),
                this._resetAdjustments(), this._scrollBar.reset(),
    ...
    _triggerBackdropTransition() {
      ...
      (!s && 'hidden' === i.overflowY) || t.contains('modal-static') ||
          (s || (i.overflowY = 'hidden'), t.add('modal-static'),
           this._queueCallback(() => {
             t.remove('modal-static'),
                 s || this._queueCallback(() => { i.overflowY = ''; },
                                          this._dialog);
  ...
  H.on(document, 'click.bs.modal.data-api', '[data-bs-toggle="modal"]',
       function(t) {
         const e = o(this);
    ...
    show(t) {
      this._isShown || H.trigger(this._element, 'show.bs.offcanvas', {
          ...
          ((this._isShown = !0), (this._element.style.visibility = 'visible'),
           this._backdrop.show(), this._config.scroll || new ft().hide(),
           this._element.removeAttribute('aria-hidden'),
           this._element.setAttribute('aria-modal', !0),
           this._element.setAttribute('role', 'dialog'),
      ...
      this._isShown &&
          (H.trigger(this._element, 'hide.bs.offcanvas').defaultPrevented ||
           (this._focustrap.deactivate(), this._element.blur(),
            (this._isShown = !1), this._element.classList.remove('show'),
  ...
  H.on(document, 'click.bs.offcanvas.data-api', '[data-bs-toggle="offcanvas"]',
       function(t) {
         const e = o(this);
      ...
      H.on(window, 'load.bs.offcanvas.data-api',
           () => V.find('.offcanvas.show')
                     .forEach((t) => Lt.getOrCreateInstance(t).show())),
      F(Lt), b(Lt);
  const St = new Set([
  ...
  class Bt extends R {
    ...
    dispose() {
      clearTimeout(this._timeout),
          H.off(this._element.closest('.modal'), 'hide.bs.modal',
      ...
      z.set(n, this.constructor.DATA_KEY, this),
          ...
          this._popper ? this._popper.update()
                       : (this._popper = i.createPopper(
                              this._element, n, this._getPopperConfig(a))),
    ...
    hide() {
      ...
      this._queueCallback(() => {
        this._isWithActiveTrigger() ||
            ('show' !== this._hoverState && t.remove(), this._cleanTipClass(),
    ...
    getTipElement() {
      ...
      return this.setContent(e), e.classList.remove('fade', 'show'),
             (this.tip = e), this.tip;
    }
    setContent(t) {
    ...
    _setListeners() {
      this._config.trigger.split(' ').forEach((t) => {
        if ('click' === t)
          H.on(this._element, this.constructor.Event.CLICK,
               this._config.selector, (t) => this.toggle(t));
        else if ('manual' !== t) {
          const e = 'hover' === t ? this.constructor.Event.MOUSEENTER
                                  : this.constructor.Event.FOCUSIN,
                i = 'hover' === t ? this.constructor.Event.MOUSELEAVE
                                  : this.constructor.Event.FOCUSOUT;
          H.on(this._element, e, this._config.selector, (t) => this._enter(t)),
              H.on(this._element, i, this._config.selector,
                   (t) => this._leave(t));
        }
      }),
          (this._hideModalHandler = () => { this._element && this.hide(); }),
          H.on(this._element.closest('.modal'), 'hide.bs.modal',
               this._hideModalHandler),
    ...
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
          t && (e._activeTrigger['focusout' === t.type ? 'focus' : 'hover'] =
    ...
    _getConfig(t) {
      ...
      return (
          Object.keys(e).forEach((t) => { Pt.has(t) && delete e[t]; }),
          ((t = {
             ...this.constructor.Default,
             ...e,
             ...('object' == typeof t && t ? t : {})
  ...
  b(qt);
  const Wt = {offset : 10, method : 'auto', target : ''}, $t = {
    offset : 'number',
    method : 'string',
  ...
  class Kt extends R {
    ...
    refresh() {
      const t = this._scrollElement === this._scrollElement.window ? 'offset'
                                                                   : 'position',
  ...
  class Vt extends R {
    ...
    show() {
      ...
      const s = t ? H.trigger(t, 'hide.bs.tab', {relatedTarget : this._element})
                  : null;
    ...
    _activate(t, e, i) {
      ...
      s && n ? (s.classList.remove('show'), this._queueCallback(o, t, !0))
             : o();
    }
    _transitionComplete(t, e, i) {
      ...
      t.classList.add('active'),
          ...
          p(t), t.classList.contains('fade') && t.classList.add('show');
      let s = t.parentNode;
  ...
  class Qt extends R {
    ...
    show() {
      H.trigger(this._element, 'show.bs.toast').defaultPrevented ||
          (this._clearTimeout(),
           ...
           this._element.classList.remove('hide'), p(this._element),
    ...
    _setListeners() {
      H.on(this._element, 'mouseover.bs.toast',
           (t) => this._onInteraction(t, !0)),
          H.on(this._element, 'mouseout.bs.toast',
               (t) => this._onInteraction(t, !1)),
          H.on(this._element, 'focusin.bs.toast',
               (t) => this._onInteraction(t, !0)),
          H.on(this._element, 'focusout.bs.toast',
               (t) => this._onInteraction(t, !1));
    }
...
!(function(e, t) {
  ...
  : 'function' == typeof define && define.amd
      ? define([ 'exports' ], t)
      : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self)
               .Popper = {}));
})(this, function(e) {
  function t(e) {
  ...
  function l(e) {
    return (e = c(e)), /auto|scroll|overlay|hidden/.test(
        ...
        (u || (!u && !r)) &&
            (('body' !== s(n) || l(c)) &&
                 (d = n !== t(n) && o(n)
                          ...
                          : a(n)),
             o(n) ? (((h = i(n, !0)).x += n.clientLeft), (h.y += n.clientTop))
                  : c && (h.x = p(c))),
        {
  ...
  function v(e, n) {
    ...
    return ((e = r === (null == (o = e.ownerDocument) ? void 0 : o.body)),
            ...
            (n = n.concat(r)), e ? n : n.concat(v(h(r))));
  }
  ...
  function y(e) {
    ...
    if (!r)
      e: {if (((r = -1 !==
               ...
               -1 === navigator.userAgent.indexOf('Trident') || !o(e) ||
                   'fixed' !== c(e).position))
                    for (e = h(e); o(e) && 0 > ['html', 'body'].indexOf(s(e)); ) {
        var i = c(e);
        if ('none' !== i.transform || 'none' !== i.perspective ||
            'paint' === i.contain ||
    ...
    function t(e) {
      o.add(e.name),
          [].concat(e.requires || [], e.requiresIfExists || [])
              .forEach(function(e) { o.has(e) || ((e = n.get(e)) && t(e)); }),
          r.push(e);
    }
    var n = new Map(), o = new Set(), r = [];
    return (e.forEach(function(e) { n.set(e.name, e); }),
            e.forEach(function(e) { o.has(e.name) || t(e); }), r);
  }
  ...
  function w(e) {
    ...
    return function() {
      return (
          t || (t = new Promise(function(n) {
                  Promise.resolve().then(function() { (t = void 0), n(e()); });
                })),
          t);
    };
  }
  ...
  function E(e, n) {
    if ('viewport' === n) {
      ...
      o(n) ? (((e = i(n)).top += n.clientTop), (e.left += n.clientLeft),
              (e.bottom = e.top + n.clientHeight),
              (e.right = e.left + n.clientWidth), (e.width = n.clientWidth),
              (e.height = n.clientHeight), (e.x = e.left), (e.y = e.top))
           : ((u = f(e)), (e = f(u)), (s = a(u)),
              (n = null == (r = u.ownerDocument) ? void 0 : r.body),
              (r = U(e.scrollWidth, e.clientWidth, n ? n.scrollWidth : 0,
                     n ? n.clientWidth : 0)),
              (l = U(e.scrollHeight, e.clientHeight, n ? n.scrollHeight : 0,
                     n ? n.clientHeight : 0)),
              (u = -s.scrollLeft + p(u)), (s = -s.scrollTop),
              'rtl' === c(n || e).direction &&
  ...
  function D(e, t, r) {
    return (
        (t = 'clippingParents' === t ? (function(e) {
           var t = v(h(e)),
               r = 0 <= [ 'absolute', 'fixed' ].indexOf(c(e).position) && o(e)
                       ? y(e)
                       : e;
           return n(r) ? t.filter(function(
                             e) { return n(e) && O(e, r) && 'body' !== s(e); })
                       : [];
         })(e)
                                     : [].concat(t)),
        ((r = (r = [].concat(t, [ r ]))
                  .reduce(
                      function(t, n) {
                        return ((n = E(e, n)), (t.top = U(n.top, t.top)),
                                (t.right = z(n.right, t.right)),
                                (t.bottom = z(n.bottom, t.bottom)),
                                (t.left = U(n.left, t.left)), t);
                      },
                      E(e, r[0])))
             .width = r.right - r.left),
        (r.height = r.bottom - r.top), (r.x = r.left), (r.y = r.top), r);
  }
  ...
  function k(e, t) {
    return t.reduce(function(t, n) { return (t[n] = e), t; }, {});
  }
  ...
  function W(e, t) {
    ...
    o = P('number' != typeof (o = void 0 === (o = o.padding) ? 0 : o)
              ? o
              : k(o, N));
    var l = e.elements.reference;
    (p = e.rects.popper),
        (a = D(n((c = e.elements[c ? ('popper' === r ? 'reference' : 'popper')
                                   : r]))
                   ? c
  ...
  function A() {
    ...
    return !t.some(function(
        e) { return !(e && 'function' == typeof e.getBoundingClientRect); });
  }

  function B(e) {
    void 0 === e && (e = {});
    var t = e.defaultModifiers, o = void 0 === t ? [] : t,
        r = void 0 === (e = e.defaultOptions) ? X : e;
    return function(e, t, i) {
      function a() {
        f.forEach(function(e) { return e(); }), (f = []);
      }
      void 0 === i && (i = r);
      var s = {
        placement : 'bottom',
        ...
        styles : {}
          ...
          f = [], p = !1, c = {
            ...
            setOptions : function(i) {
              return (
                  a(), (s.options = Object.assign({}, r, s.options, i)),
                  (s.scrollParents = {
                    reference : n(e)               ? v(e)
                  ...
                  (i = (function(e) {
                     ...
                     return _.reduce(function(e, n) {
                       return e.concat(
                           t.filter(function(e) { return e.phase === n; }));
                     }, []);
                   })((function(e) {
                  ...
                  (s.orderedModifiers =
                       i.filter(function(e) { return e.enabled; })),
              ...
              if (!p) {
                ...
                if (A(t, (e = e.popper)))
                  for (s.rects = {
                      ...
                      s.reset = !1, s.placement = s.options.placement,
                      s.orderedModifiers.forEach(function(e) {
                        return (s.modifiersData[e.name] =
                                    Object.assign({}, e.data));
                      }),
                      t = 0;
                       t < s.orderedModifiers.length; t++)
                    if (!0 === s.reset)
                      (s.reset = !1), (t = -1);
                    else {
      ...
      return A(e, t)
                 ? (c.setOptions(i).then(function(
                        e) { !p && i.onFirstUpdate && i.onFirstUpdate(e); }),
                    c)
                 : c;
    };
  }
  ...
  function H(e) {
    var n, o = e.popper, r = e.popperRect, i = e.placement, a = e.offsets,
           s = e.position, p = e.gpuAcceleration, l = e.adaptive;
    ...
    return (
        ...
        p ? Object.assign(
          ...
          : Object.assign({}, o,
                          (((n = {})[v] = a ? u + 'px' : ''),
                           (n[m] = d ? e + 'px' : ''), (n.transform = ''), n)));
  }

  function T(e) {
    return e.replace(/left|right|bottom|top/g, function(e) { return ee[e]; });
  }

  function R(e) {
    return e.replace(/start|end/g, function(e) { return te[e]; });
  }
  ...
  function C(e) {
    return [ 'top', 'right', 'bottom', 'left' ].some(function(
        t) { return 0 <= e[t]; });
  }
  var q = Math.round, N = [ 'top', 'bottom', 'right', 'left' ],
      V = N.reduce(
          function(e, t) {
      ...
      _ = 'beforeRead read afterRead beforeMain main afterMain beforeWrite write afterWrite'
              .split(' '),
      U = Math.max, z = Math.min, F = Math.round,
      ...
      Y = {passive : !0}, G = {
        ...
        fn : function() {},
        effect : function(e) {
          var n = e.state, o = e.instance, r = (e = e.options).scroll,
              i = void 0 === r || r, a = void 0 === (e = e.resize) || e,
              s = t(n.elements.popper),
              f = [].concat(n.scrollParents.reference, n.scrollParents.popper);
          return (
              i && f.forEach(function(
                       e) { e.addEventListener('scroll', o.update, Y); }),
              a && s.addEventListener('resize', o.update, Y), function() {
                i && f.forEach(function(
                         e) { e.removeEventListener('scroll', o.update, Y); }),
      ...
      K = {top : 'auto', right : 'auto', bottom : 'auto', left : 'auto'}, Q = {
        ...
        fn : function(e) {
          ...
          var o = n.adaptive;
          (o = void 0 === o || o), (n = void 0 === (n = n.roundOffsets) || n),
              (e = {
              ...
              null != t.modifiersData.popperOffsets &&
                  (t.styles.popper = Object.assign(
                       {}, t.styles.popper, H(Object.assign({}, e, {
              ...
              null != t.modifiersData.arrow &&
                  (t.styles.arrow = Object.assign(
                       {}, t.styles.arrow, H(Object.assign({}, e, {
      ...
      Z = {
        ...
        fn : function(e) {
          ...
          Object.keys(t.elements).forEach(function(e) {
            var n = t.styles[e] || {}, r = t.attributes[e] || {},
                i = t.elements[e];
            o(i) && s(i) &&
                (Object.assign(i.style, n), Object.keys(r).forEach(function(e) {
                  var t = r[e];
                  !1 === t ? i.removeAttribute(e)
        ...
        effect : function(e) {
          ...
          return (
              Object.assign(t.elements.popper.style, n.popper), (t.styles = n),
              t.elements.arrow &&
              ...
              function() {
                Object.keys(t.elements).forEach(function(e) {
                  ...
                  (e = Object
                           .keys(t.styles.hasOwnProperty(e) ? t.styles[e]
                                                            : n[e])
        ...
        fn : function(e) {
          ...
          if (((e = e.name), !t.modifiersData[e]._skip)) {
            ...
            var i = n.fallbackPlacements, a = n.padding, s = n.boundary,
                ...
                l = void 0 === c || c, u = n.allowedAutoPlacements;
            ...
            var d = [ n ].concat(i).reduce(function(e, n) {
              return e.concat('auto' === x(n) ? (function(e, t) {
                void 0 === t && (t = {});
                var n = t.boundary, o = t.rootBoundary, r = t.padding,
                    i = t.flipVariations, a = t.allowedAutoPlacements,
                    s = void 0 === a ? I : a, f = t.placement.split('-')[1];
                0 === (i = (t = f ? i ? V : V.filter(function(e) {
                             return e.split('-')[1] === f;
                           })
                                  : N)
                               .filter(function(
                                   e) { return 0 <= s.indexOf(e); }))
                            .length &&
                    (i = t);
                ...
                return Object.keys(p).sort(function(e,
                                                    t) { return p[e] - p[t]; });
              })(t, {
                placement : n,
                boundary : s,
            ...
            for (var m = d[0], v = 0; v < d.length; v++) {
              var g = d[v], y = x(g), b = 'start' === g.split('-')[1],
                  w = 0 <= [ 'top', 'bottom' ].indexOf(y),
                  O = w ? 'width' : 'height', j = W(t, {
                                                placement : g,
                                                boundary : s,
                                                rootBoundary : f,
                                                altBoundary : p,
              ...
              if (((b = w   ? (b ? 'right' : 'left')
                        : b ? 'bottom'
                            : 'top'),
                   n[O] > i[O] && (b = T(b)), (O = T(b)), (w = []),
                   o && w.push(0 >= j[y]), r && w.push(0 >= j[b], 0 >= j[O]),
            ...
            if (c)
              for (o = function(e) {
                     var t = d.find(function(t) {
                       if ((t = h.get(t)))
                         return t.slice(0, e).every(function(e) { return e; });
                     });
                     if (t)
                       return (m = t), 'break';
        ...
        fn : function(e) {
          ...
          if (((s = {x : 0, y : 0}), a)) {
            if (r || i) {
              var v = 'y' === l ? 'top' : 'left',
                  g = 'y' === l ? 'bottom' : 'right',
                  b = 'y' === l ? 'height' : 'width', w = a[l], O = a[l] + f[v],
                  j = a[l] - f[g], E = o ? -h[b] / 2 : 0,
                  D = 'start' === p ? u[b] : h[b];
              (p = 'start' === p ? -h[b] : -u[b]), (h = t.elements.arrow),
                  (h = o && h ? d(h) : {width : 0, height : 0});
              var M = t.modifiersData['arrow#persistent']
                          ? t.modifiersData['arrow#persistent'].padding
                          : {top : 0, right : 0, bottom : 0, left : 0};
              (v = M[v]), (g = M[g]), (h = U(0, z(u[b], h[b]))),
                  ...
                  (m = t.modifiersData.offset
                           ...
                           : 0),
                  (c = a[l] + D - m -
                       (c ? ('y' === l ? c.clientTop || 0 : c.clientLeft || 0)
                          : 0)),
                  (u = a[l] + u - m),
                  r && ((r = o ? z(O, c) : O), (j = o ? U(j, u) : j),
                        (r = U(r, z(w, j))), (a[l] = r), (s[l] = r - w)),
                  i && ((r = (i = a[n]) + f['x' === l ? 'top' : 'left']),
                        (f = i - f['x' === l ? 'bottom' : 'right']),
                        (r = o ? z(r, c) : r), (o = o ? U(f, u) : f),
                        (o = U(r, z(i, o))), (a[n] = o), (s[n] = o - i));
            }
            t.modifiersData[e] = s;
          }
        },
      ...
      re = {
        ...
        fn : function(e) {
          var t, n = e.state, o = e.name, r = e.options, i = n.elements.arrow,
                 a = n.modifiersData.popperOffsets, s = x(n.placement);
          if (((e = L(s)),
               (s = 0 <= [ 'left', 'right' ].indexOf(s) ? 'height' : 'width'),
               i && a)) {
            r = P('number' != typeof (r = 'function' == typeof (r = r.padding)
                                              ? r(Object.assign(
                                                    {}, n.rects,
                      ...
                      ? r
                      : k(r, N));
            var f = d(i), p = 'y' === e ? 'top' : 'left',
                c = 'y' === e ? 'bottom' : 'right',
                l = n.rects.reference[s] + n.rects.reference[e] - a[e] -
                    n.rects.popper[s];
            (a = a[e] - n.rects.reference[e]),
                (a = (i = (i = y(i)) ? ('y' === e ? i.clientHeight || 0
                                                  : i.clientWidth || 0)
                                     : 0) /
                         2 -
                     f[s] / 2 + (l / 2 - a / 2)),
      ...
      ie = {
        ...
        fn : function(e) {
          var t = e.state;
          e = e.name;
          var n = t.rects.reference, o = t.rects.popper,
              r = t.modifiersData.preventOverflow,
              i = W(t, {elementContext : 'reference'}),
              a = W(t, {altBoundary : !0});
          (n = S(i, n)), (o = S(a, o, r)), (r = C(n)), (a = C(o)),
              (t.modifiersData[e] = {
      ...
      se = [ G, J, Q, Z, $, ne, oe, re, ie ], fe = B({defaultModifiers : se});
  (e.applyStyles = Z), (e.arrow = re), (e.computeStyles = Q),
      (e.createPopper = fe), (e.createPopperLite = ae),
      (e.defaultModifiers = se), (e.detectOverflow = W), (e.eventListeners = G),
      (e.flip = ne), (e.hide = ie), (e.offset = $), (e.popperGenerator = B),
      (e.popperOffsets = J), (e.preventOverflow = oe),
