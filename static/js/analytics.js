...
*/
  ...
  ja(
    ...
    function (a) {
      ...
      b.race = function (g) {
        return new b(function (h, k) {
          for (var l = q(g), m = l.next(); !m.done; m = l.next())
            d(m.value).ga(h, k);
        });
      };
      b.all = function (g) {
    ...
    Object.isFrozen(a) ||
      (fb
        ...
        : Object.defineProperties(a, {
            h: { value: 1, configurable: !0, writable: !0, enumerable: !1 },
          }));
    return a;
  }
  function ib(a) {
  ...
  function mb(a, b) {
    ...
    e = {};
    for (c in a)
      Object.prototype.hasOwnProperty.call(a, c) && (e[c] = lb(a[c], b));
    return e;
  }
  function nb(a) {
    a = kb(a);
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        (a = c[b]),
          a < this.m
            ? ((a += this.l),
              (d = this.i[a]) ? Array.isArray(d) && hb(d) : (this.i[a] = qb))
            : (rb(this),
              (d = this.j[a]) ? Array.isArray(d) && hb(d) : (this.j[a] = qb));
  }
  ...
  function wb(a, b, c, d) {
    (c = xb(a, c)) &&
      c !== b &&
      null != d &&
      (a.h && c in a.h && (a.h[c] = void 0), A(a, c, void 0));
    return A(a, b, d);
  }
  function xb(a, b) {
...
*/
  ...
  function fd() {
    if (dd && !wc(ed)) {
      ...
      var a = "." + Uc.domain;
      try {
        for (; 2 < a.split(".").length && !wc(ed); )
          (Uc.domain = a = a.substr(a.indexOf(".") + 1)), (ed = window.parent);
      } catch (b) {}
      wc(ed) || (ed = window);
    }
    return ed;
  ...
  function kd(a, b) {
    ...
    a &&
      ...
      (a = Wb(
        a instanceof Kb && a.constructor === Kb && a.h === Mb
          ? a.i
          : "type_error:Const"
      )),
      xc(d, a));
    ...
    try {
      ...
      if (
        ...
        for (m = 1; m < b.length; ++m) {
          var r = b[m];
          r.url ||
            ((r.url = k.location.ancestorOrigins[m - 1] || ""), (r.Ia = !0));
        }
      ...
      try {
        zd(
          this.m,
          e,
          { context: "ecmserr", rctx: a, msg: Md(pc), url: F && F.h.url },
          this.j,
          c
        );
      } catch (qo) {}
  ...
  function He(a, b, c, d) {
    var e = (d = void 0 === d ? 0 : d),
      ...
      g;
    L(Ie).j[e] =
      null != (g = null == (f = L(Ie).j[e]) ? void 0 : f.add(b))
        ? g
        : new n.Set().add(b);
    e = Ge();
      ...
      Ua(a, function (l) {
        ...
        if (r) {
          ...
          if (!e) {
            var B, F;
            L(Ie).i[h] =
              null != (F = null == (B = L(Ie).i[h]) ? void 0 : B.add(r))
                ? F
                : new n.Set().add(r);
          }
          k[r] = l.toJSON();
  ...
  function mf(a) {
    ...
    N(
      ...
      function (b) {
        for (
          var c = L(Ce), d = q([Wd, Xd, Yd]), e = d.next();
          !e.done;
          e = d.next()
        )
  ...
  function rf(a) {
    ...
    v.google_measure_js_timing ||
      ...
      a.events != a.i.google_js_reporting_queue &&
        (Hd() && Ua(a.events, Jd), (a.events.length = 0)));
  }
  (function (a) {
    yd = a || new wd();
  ...
  function wf(a, b, c, d) {
    ...
    return 0 == e.indexOf("TagError")
      ? ((c = b instanceof ld ? b.error : b),
        c.pbr || ((c.pbr = !0), qf.I(a, b, 0.1, d, "puberror")),
        !1)
      : qf.I(a, b, c, d);
  }
  var xf = {
  ...
  function Af(a) {
    a.google_reactive_ads_global_state
      ? null == a.google_reactive_ads_global_state.floatingAdsStacking &&
        (a.google_reactive_ads_global_state.floatingAdsStacking = new zf())
  ...
  Pf.prototype.map = function (a) {
    return null != this.h
      ? ((a = a(this.h.value)), a instanceof Pf ? a : Sf(a))
      : this;
  };
  function Tf(a, b) {
    null != a.h || b(a.i);
  ...
  var ig = {},
    jg = new eg(
      ["google-auto-placed"],
      ((ig.google_reactive_ad_format = 40), (ig.google_tag_origin = "qs"), ig)
    );
  function kg(a) {
    y.call(this, a);
  }
  ...
  function Yh(a, b) {
    return !(
      (Kc.test(b.google_ad_width) || Jc.test(a.style.width)) &&
      (Kc.test(b.google_ad_height) || Jc.test(a.style.height))
    );
  }
  function Zh(a, b) {
  ...
  function ni(a, b) {
    ...
    c = Infinity;
    do
      (d = b.style && I(b.style.height)) && (c = Math.min(c, d)),
        (d = hi(b, a, "maxHeight", I)) && (c = Math.min(c, d));
        ...
        if (null == a) var b = null;
          ...
          (b = G(a, Yf, 1)),
            null == b
              ? (b = null)
              : ((a = z(a, 2)),
                (b = null == a ? null : new $f({ Ea: [b], Na: a })));
        return null != b
          ? Sf(b)
          : Uf(Error("Missing dimension when creating placement id"));
      case 3:
  ...
  function Gi(a, b) {
    ...
    b.forEach(function (e) {
      if (Gb(e, mg, 1, pg)) {
        ...
        if (
          ...
          if (f && g)
            for (
              f = q(
                Ei(
                  { anchor: f, position: z(G(e, kg, 1), 2) },
                  { anchor: g, position: z(G(e, kg, 2), 2) }
                )
              ),
                g = f.next();
              !g.done;
        ...
        G(e, kg, 3) &&
          G(G(e, kg, 3), Yf, 1) &&
          (f = Hi(a, G(G(e, kg, 3), Yf, 1))) &&
          c.set(Aa(f), z(G(e, kg, 3), 2));
  ...
  function Qi(a, b) {
    ...
    if (null !== f && D(f, 2, !1))
      return (Bi(a.h).eatf = !0), kd(7, [!0, 0, !1]), !0;
    f = new Wf([2]);
    for (e = 0; e < c.length; e++) {
      ...
      if (
        !G(h, dg, 4) ||
        !f.contains(z(G(h, dg, 4), 1)) ||
        1 !== z(h, 8) ||
        (h && null != z(h, 4) && d[z(G(h, dg, 4), 2)])
      )
        g = null;
      else {
        g.i++;
  ...
  function Ri(a, b, c, d) {
    if ((b && null != z(b, 4) && d[z(G(b, dg, 4), 2)]) || 1 != z(b, 8))
      return null;
    d = G(b, Yf, 1);
    if (!d) return null;
    d = xi(d);
  ...
  function Xi() {
    ...
    return null != b &&
      ...
      "object" == typeof b.S
      ? (Yi = b)
      : (a.google_persistent_state_async = Yi = new Wi());
  }
  function Zi(a) {
  ...
  var Yi = null,
    bj = {},
    $i =
      ((bj[8] = "google_prev_ad_formats_by_region"),
      (bj[9] = "google_prev_ad_slotnames_by_region"),
      bj);
  function cj(a) {
    this.h = a || { cookie: "" };
  }
  ...
  cj.prototype.clear = function () {
    ...
    for (a = b.length - 1; 0 <= a; a--)
      (c = b[a]),
        this.get(c),
        this.set(c, "", { eb: 0, path: void 0, domain: void 0 });
  };
  function dj(a) {
    y.call(this, a);
  }
      ...
      if (
        ...
        0 === b
          ...
          ? ((b = a.vendor.consents),
            ...
            ((Q(Fh) ? 0 : "DE" === a.publisherCC) || "CH" === a.publisherCC)
              ? (a = !0)
  ...
  function Fj(a) {
    this.h = a;
    this.i = a.document;
    this.j = (a = (a = Dj(this.i)) ? G(a, Cj, 5) || null : null)
      ? z(a, 2)
      : null;
  ...
  function Vj(a) {
    ...
    return a.remove_ads_by_default
      ? { Da: !0, ob: b, oa: a.ablation_viewport_offset }
      : null;
  }
  function Wj(a, b) {
    a = U(a);
    ...
    if (!U(J).ama_ran_on_page) {
      ...
      if (d) {
        if (null != z(d, 24)) {
          ...
          c.availableAbg = !0;
          var e, f;
          c.ablationFromStorage = !!(null == (e = G(d, tg, 24))
            ? 0
            : null == (f = G(e, vg, 3))
            ? 0
            : Gb(f, wg, 2, xg));
        ...
        if ((g = G(d, Eg, 13)) && 1 === z(g, 1)) {
          ...
          (Ci(a).ablatingThisPageview = !0), Xj(a, 1);
        kd(3, [d.toJSON()]);
...
*/
  ...
  function Fk(a, b) {
    ...
    if ("pedestal" == b.google_content_recommendation_ui_type)
      return new tk(9, new Ek(a, Math.floor(a * b.google_phwr)));
    var c = rc();
    468 > a
      ? c
        ? ((c = a - 8 - 8),
          (c =
            ...
            Math.floor(
              11 *
                (c * wk.mobile_banner_image_sidebyside +
                  yk.mobile_banner_image_sidebyside) +
                96
            )),
          (a = {
            X: a,
  ...
  function Tk(a, b, c, d, e, f) {
    ...
    null != e.google_max_responsive_height &&
      l.push(mi(e.google_max_responsive_height));
    var m = [
      function (t) {
        return !t.cb;
      },
  ...
  function Xk(a, b, c, d, e) {
    ...
    g = g.C;
    if (!0 !== g || a == f)
      return new tk(12, new S(a, d), null, null, !0, g, 100);
    a = Tk(f, "auto", b, c, e, !0);
  ...
  function El(a, b) {
    return b
      ? 13 === xb(b, yl)
        ...
        : 14 === xb(b, yl) &&
          "" !== a &&
          1 === sb(Gb(b, ml, 14, yl), 1).length &&
          sb(Gb(b, ml, 14, yl), 1)[0] === a
  ...
  function Sl() {
    ...
    this[Xd] =
      ...
      (a[11] = function (b) {
        ...
        b = void 0 === b ? "" : b;
        c = void 0 === c ? window : c;
        b = (c = (c = c.location.href.match(tc)[3] || null) ? decodeURI(c) : c)
          ? Fc(c + b)
          : null;
  ...
  function lm(a, b, c, d) {
    ...
    var f =
      void 0 === f
        ? new ye(
            null != (im = null == (fm = G(a, wl, 5)) ? void 0 : C(fm, 2, 0))
              ? im
              : 0,
            null != (jm = null == (gm = G(a, wl, 5)) ? void 0 : C(gm, 4, 0))
              ? jm
              : 0,
            null != (km = null == (hm = G(a, wl, 5)) ? void 0 : D(hm, 3))
              ? km
              : !1
          )
        : f;
  ...
  function om(a, b, c) {
    ...
    if (d.plle) mm(Ql(a), 1);
      ...
      lm(
        d,
        Pl(c, b),
        { Ha: e && !!a.google_disable_experiments, bb: e },
        Ql(a)
      );
  ...
  function Im() {
    ...
    try {
      ...
      for (
        var b = googletag.pubads(), c = q(b.getSlots()), d = c.next();
        !d.done;
        d = c.next()
      )
            ...
            switch (((e = e.value), e.entryType)) {
              case "layout-shift":
                ...
                if (!e.hadRecentInput && (!Q(Bh) || 0.01 < e.value)) {
                  ...
                  var g = Km(e, c, d);
                  g && ((f.m += e.value), f.xa++);
                  if (5e3 < e.startTime - f.wa || 1e3 < e.startTime - f.za)
                    (f.wa = e.startTime), (f.h = 0), (f.i = 0);
                  f.za = e.startTime;
                  f.h += e.value;
                  g && (f.i += e.value);
                  f.h > f.R &&
        ...
        .catch(function (e) {
          if (
            ...
            if ("number" === typeof e.state && e.error instanceof Error) {
              ...
              var f = R(Mh);
              Math.random() <= f &&
                Zc({ state: e.state, err: e.error.toString() }, "dtt_err");
            } else throw Error(e);
          else throw e;
        });
    }
  ...
  function mn() {
    return J.navigator &&
      J.navigator.userAgentData &&
      "function" === typeof J.navigator.userAgentData.getHighEntropyValues
  ...
  function on(a, b, c) {
    c = void 0 === c ? "" : c;
    J.google_sa_impl &&
      !J.document.getElementById("google_shimpl") &&
      ((J.google_sa_queue = null),
      (J.google_sl_win = null),
      (J.google_sa_impl = null));
    J.google_sa_queue ||
      ((J.google_sa_queue = []),
      (J.google_sl_win = J),
  ...
  function sn() {
    ...
    if ((a = J.document.querySelector(".adsbygoogle[data-ad-client]")))
  ...
  function un(a) {
    ...
    if (a instanceof bc) {
      var k;
      h = ec(a);
      a = (null === (k = Zb()) || void 0 === k ? 0 : k.isScriptURL(h))
  ...
  function xn(a, b, c) {
    ...
    d =
      ...
      (!pk[c.google_ad_width + "x" + c.google_ad_height] &&
  ...
  function Dn(a, b, c, d) {
    ...
    !(g = Q(gh) || (!(488 > Cf(c)) && !Q(oh))) &&
      ...
      ((g = c.top == c),
      g ||
        (wc(c.top) && c.top ? (b.gfwrnwer = 3) : (b.gfwrnwer = 16), (g = !1)),
      (g = !g));
    if (g) d = !1;
    else {
      g = hd(c) || c;
  ...
  function Nn(a, b, c) {
    ...
    if (!On(a, b, d)) {
      ...
      if (e) {
        ...
        if (
          U(J).page_contains_reactive_tag &&
          !U(J).allow_second_reactive_tag
        ) {
          if (e.pltais) {
            Yj(!1);
            return;
  ...
  function Xn(a, b) {
    ...
    if (c) {
      ...
      ((null == (g = Gb(b, ll, 13, yl)) ? 0 : D(g, 3)) && Q(uh))
        ? Zn(f, a)
        : En(function () {
            Zn(f, a);
          });
  ...
  function Yn(a) {
    ...
    if (
      (a = vc(c) || a.getAttribute("data-ad-client") || "") &&
    ...
    if (0 !== e)
      Q(jh) &&
        ...
        d.first_slotcar_request_processing_time ||
          ...
          (d.adsbygoogle_execution_start_time = Ja))),
        null == Hn
          ? (bo(a), In.push(a))
          : 3 === e
          ? sf(787, function () {
      ...
      if (e) fo(a, d, b);
        ...
        if (!b.google_ad_client)
          throw new K("Ad client is missing from the slot.");
  ...
  function ao(a, b, c) {
    Q(hh) &&
      ...
      ((io = !0),
      (a = co(a)) || (a = sn()),
      uf("predictive_abg", { a_c: a, p_c: b, b_v: c }, 0.01));
  }
  function co(a) {
  ...
  function go(a) {
    if (a) {
      if (!Ln(a) && (a.id ? (a = Pn(a.id)) : (a = null), !a))
        throw new K("'element' has already been filled.");
      if (!("innerHTML" in a))
        throw new K("'element' is not a good DOM element.");
    } else if (((a = Pn()), !a))
      throw new K(
  ...
  function jo() {
    ...
    (f =
      ...
      (b.h ? (b = b.h) : ((b.h = Mc(b.i, "__uspapiLocator")), (b = b.h)),
      (f = null != b));
    c.l ||
      (c.i || (c.i = c.h.googlefc ? c.h : Mc(c.h, "googlefcPresent")),
      (c.l = !0));
    uf(
      "cmpMet",
  ...
  function po() {
    for (
      var a = q(p(Jn, "keys").call(Jn)), b = a.next();
      !b.done;
      b = a.next()
    ) {
      b = b.value;
      ...
      Jn.has(b) ||
        ...
        sf(
          ...
          (function (d) {
            return function () {
              3 === d.da
                ? Hn.handleAdConfig(d.Y)
                : 2 === d.da && Hn.handleAdBreakBeforeReady(d.Y).catch(vf(730));
            };
          })(a)
        ));
  }
...
*/
  ...
  var rb = function (a, b) {
      for (
        var c, d = 0;
        d < b.length && !((c = qb(a, b[d])), c instanceof pa);
        d++
      );
      return c;
    },
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    Vf = function (a, b) {
      ...
      for (var e = {}, f = 0; f < c.length; f++)
        Oa(c[f].Ib, function (u, q) {
          null != q &&
            ((e[u] = e[u] || {}), (e[u][String(q)] = e[u][String(q)] + 1 || 1));
        });
      var g = {};
      Oa(e, function (u, q) {
        var v,
  ...
  J.W = "dataLayer";
  J.Eh =
    "ChEIgMuHjQYQ6auAt+KMqta9ARIlAAai/dXD98B8b5appURw8YZvQjvOBYao+bTswv4OmJIDjb9oMxoCGlo\x3d";
  var Xg = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
          ...
          if (void 0 !== ml[f]) {
            ...
            if (h) {
              ...
              b: {
                ...
                if (Uj(m))
                  for (
                    var r = Xj(g, H.cookie, void 0, "ad_storage"), t = 0;
                    t < r.length;
                    ++t
                  )
                    if (Al(r[t]) > p) {
  ...
  var Pr = {
      ...
      event: function (a) {
        ...
        if (!(2 > a.length) && Ga(b)) {
          ...
          0 < r.length
            ? (d.eventModel[R.xb] = u.join())
            : delete d.eventModel[R.xb];
          Kr || Ug(43);
          return d;
        }
      },
  ...
  var Ew = function () {
    ...
    Lg(a, "internal.evaluateMatchingRules", Kv),
      Lg(a, "internal.registerGtagCommandListener", ow);
  ...
  l.B = function (a) {
    return void 0 !== this.K[a]
      ? this.K[a]
      : void 0 !== this.o.getWithConfig(a)
      ? this.o.getWithConfig(a)
      : void 0 !== this.N[a]
      ? this.N[a]
      : Zx[a];
  };
  l.getRemoteConfig = function (a) {
    return void 0 !== this.o.remoteConfig[a]
      ? this.o.remoteConfig[a]
      : this.N[a];
  };
  l.Md = function (a) {
  ...
  var Ly = !1,
    My = function (a) {
      ...
      if (b[R.O]) {
        ...
        Jy
          ? fl(f, b[R.O], b[R.Ub], !!b[R.vb], Iy)
          : fl(f, b[R.O], b[R.Ub], !!b[R.vb]);
      }
    },
    Oy = function (a) {
      if (!a.B(R.hb)) return {};
  ...
  var sz = function (a, b, c, d) {
      ...
      if (b || c) {
        ...
        b &&
          ...
          fi("https://stats.g.doubleclick.net/g/collect?v=2&" + f.join("&")));
        if (c) {
          f.push("z=" + Ka());
          var g = nz(d);
          g && ec(g + f.join("&"));
  ...
  var tz = window,
    ...
    vz = function (a) {
      ...
      for (
        var d = Tj("AMP_TOKEN", String(uz.cookie), !0), e = 0;
        e < d.length;
        e++
      )
  ...
  l.Ij = function (a) {
    ...
    try {
      ...
      0 <= wz.ji.replace(/\s+/g, "").split(",").indexOf(a.eventName) &&
        (Ug(33), a.abort());
      var b = a.Md();
      ...
      a.eventName == R.za &&
        ...
        a.B(R.Vb) || a.abort(),
        a.o.eventModel[R.X] &&
          ((a.o.containerConfig[R.X] = a.o.eventModel[R.X]),
          (a.o.eventModel[R.X] = void 0)),
        (a.eventName = R.mc));
      var k = this.o,
        n = this.s,
        p = this.C,
      ...
      v ||
        ((y = a.td = !0),
        (v = { sessionId: String(a.C), Af: 1, Td: !1, lf: a.C, Oc: !1 }));
      a.C > v.lf + 60 * u &&
        ((y = !0), (v.sessionId = String(a.C)), v.Af++, (v.Td = !1));
      if (y) (a.F = !0), r.lj(a);
      ...
      if (a.B(R.sa)) {
        ...
        a.K._fplc =
          Fe || (0 < Xj("FPLC", void 0, void 0, R.I).length ? void 0 : "0");
      }
      if (void 0 === a.B(R.ue)) {
        var ic = a.B(R.nd),
          Ge,
        ...
        a: {
          if (Ly) {
            ...
            if (He && He[R.O])
              for (
                var Rc = tj(vj(a.B(R.Qa)), "host", !0), Rd = He[R.O], md = 0;
                md < Rd.length;
                md++
              )
          ...
          if (Qy) nd = !1;
            ...
            if ("none" !== Sc)
              if ("auto" !== Sc) Td = Sc;
                ...
                if (!Sy) {
                  for (
                    var Of = String(a.B(R.ab)), Ud = dk(), jc = 0;
                    jc < Ud.length;
                    jc++
                  )
                    if ("none" !== Ud[jc]) {
                      ...
                      if (
                        0 === gk(Pf, Ry, { Ka: R.I, domain: Ud[jc], path: Of })
                      ) {
        ...
        if (!(Ge = nd)) {
          ...
          if ((xa = ic))
            a: {
              for (
                var oa = ic.include_conditions || [], Za = 0;
                Za < oa.length;
                Za++
              )
      ...
      if (a.K[R.Ad]) delete a.K[R.Ad];
        ...
        if (Dc) {
            ...
            a: {
              ...
              if (ky(Ua, ob)) {
                if (ob.new_event_name) {
                  var W =
                    "string" === typeof ob.new_event_name
                      ? String(ob.new_event_name)
                      : hy(Ua.eventName, Ua.K, ob.new_event_name);
                  if (fy(W)) break a;
          ...
          for (
            var Ke = Dc.synthesis_rules || [], od = 0;
            od < Ke.length;
            od++
          ) {
            var pd = a,
      ...
      oi([R.I], function () {
        ...
        if (b ^ c && a.g && a.C && a.o) {
          ...
          if (c) {
            var e = wy(a.g);
            e
              ? ((a.o = e), (a.C = Dy(a.g)), a.g.g && (a.s = vy(a.g)))
              : (zy(a.o, a.g),
                Cy(a.C, a.g),
                qy(a.o, !0),
                a.g.g && a.s && ty(a.s, a.g));
          } else {
            a.C = void 0;
            a.o = void 0;
            a.s = void 0;
  ...
  (Y.h.ytl = ["google"]),
    (function () {
      ...
      function d(q, v) {
        if (
          !q.getAttribute("data-gtm-yt-inspected-" + v.Cf) &&
          (q.setAttribute("data-gtm-yt-inspected-" + v.Cf, "true"), c(q, v.Ic))
        ) {
          q.id || (q.id = a());
          var w = V("YT"),
            y = w.get(q.id);
        ...
        function C(U) {
          ...
          switch (U) {
            ...
            case r.BUFFERING:
              ...
              ka =
                1 < Math.abs(((et().getTime() - Da) / 1e3) * Z - Fa)
                  ? "seek"
                  : ka || "buffering";
        ...
        function M() {
          if (O.length && 0 !== Z) {
            ...
            w = function () {
              ...
              0 < O.length &&
                O[0].ca === ka.ca &&
                (O.shift(), jt(P.createEvent("progress", ka.Rc, ka.Uc)));
              M();
            };
            y = dt(w, 1e3 * U);
          }
        ...
        if (v || w || y || x.length || z.length) {
          ...
          if (E) E.ready && E.ready(D);
            ...
            I(function () {
              ...
              for (
                var L = N.getElementsByTagName("iframe"), T = L.length, Z = 0;
                Z < T;
                Z++
              )
                if (!u && c(L[Z], C.Ic)) {
  ...
  (Y.h.get = ["google"]),
    (function () {
      (function (a) {
        ...
        (a.vtp_deferrable
          ? Fz
          : Ez)(String(b.streamId), String(a.vtp_eventName), b.eventParameters || {});
        a.vtp_gtmOnSuccess();
      });
    })();
  ...
  (function (a) {
    ...
    var f = function (r) {
        ...
        var v = {
          ...
          data: { scriptSource: Xb, containerProduct: t, debug: !1, id: J.J },
        };
