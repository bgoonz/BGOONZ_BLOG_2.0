...
*/
  ...
  function hb( a ) {
    Object.isFrozen( a ) ||
      ( fb ? ( a[ fb ] |= 1 ) : void 0 !== a.h ? ( a.h |= 1 ) : Object.defineProperties( a, {
        h: {
          value: 1,
          configurable: !0,
          writable: !0,
...
*/
  ...
  function Xk( a, b, c, d, e ) {
    ...
    488 > Cf( b ) ?
      ...
      ( ( e.google_full_width_responsive_allowed = !0 ), gi( b, c ), ( f = {
        B: f,
        C: !0
      } ) ) :
      ( f = {
...
*/
  ...
  ( function () {
    ...
    ( function ( d ) {
      ...
      p && ( p.length && 'object' === typeof p[ 0 ] && ( p = c( p ) ), ( e[ R.nd ] = {
