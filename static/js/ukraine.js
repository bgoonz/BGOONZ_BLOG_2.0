!(function () {
    ...
    return k(
      ...
      f(
        ...
        f(
          ...
          f("div", { class: "huww-half-flag-top" }),
          f("div", { class: "huww-half-flag-bottom" })
        )
      ),
      j(),
      z()
  ...
  function E() {
    return f(
      "div",
      { class: "huww-flag" },
      f("div", { class: "huww-flag-top" }),
      f("div", { class: "huww-flag-bottom" })
    );
  }
  function j() {
    return f(
    ...
    document.querySelectorAll(".huww-widget").forEach(function (e) {
      return (function (e) {
        var t = e.querySelectorAll(".huww-trigger"),
          ...
          r = T.get();
        !window.__HELPUKRAINEWIDGET_DISABLE_PERSISTENCE &&
          r &&
          (e.dataset.huwwSlide = r);
        t.forEach(function (t) {
          t.addEventListener("click", function (i) {
            ...
            try {
              window.plausible &&
                window.plausible("ChangeState", { props: { state: r } });
            } catch (e) {}
          });
        }),
  ...
  var C,
    ...
    I = (function () {
      ...
      {
        widgetPosition: c(
          null == C ? void 0 : C.getAttribute("data-position"),
          n,
          u
        ),
        widgetType: D,
        ...
        widgetDomain:
          (null == C ? void 0 : C.getAttribute(p)) || window.location.hostname,
      })
    );
  function R() {
    var t, i, r, o;
    !(function () {
      ...
      e.setAttribute(
        "src",
        "https://analytics.helpukrainewinwidget.org/js/script.js"
      ),
        e.setAttribute("defer", ""),
        e.setAttribute(
          "data-domain",
          w(I.widgetDomain.split(","))
            .concat(["rollup-analytics.helpukrainewinwidget.org"])
            .join(",")
        ),
      ...
      document.body.append(
        ...
        (r = I.widgetPosition),
        (o = I.widgetLayout),
        { one: x, two: m, three: y, four: v }[i](r, o))
      ),
      O();
  }
})();
