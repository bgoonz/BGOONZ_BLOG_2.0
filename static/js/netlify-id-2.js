            ...
            if (!e._disable) {
                ...
                if (
                    ...
                    if ((w && U(w), (e.base = I), I && !r)) {
                        for (var k = e, Y = e;
                            (Y = Y._parentComponent);)(k = Y).base = I;
                        (I._component = k), (I._componentConstructor = k.constructor);
                    }
                }
                for (
                    !y || t ? p.push(e) : A || (e.componentDidUpdate && e.componentDidUpdate(N, D, d), o.afterUpdate && o.afterUpdate(e)); e._renderCallbacks.length;
                )
...
***************************************************************************** */
                ...
                function at(e, n) {
                    ...
                    try {
                        for (
                            var r = v(e.interceptors || []), o = 0, i = r.length; o < i && (a(!(n = r[o](n)) || n.type, 'Intercept handlers should return nothing or a change object'), n); o++
                        );
                        return n;
                    } finally {
                        Ne(t);
                            ...
                            (w.onload = function() {
                                ...
                                w.contentDocument.head.appendChild(e),
                                    (E = (0, r.render)((0, r.h)(i.Provider, {
                                        store: u.default
                                    }, (0, r.h)(a.default, null)), w.contentDocument.body, E)),
                                    m();
                            }),
                            p(w, x),
                            (w.src = 'about:blank');
...
//# sourceMappingURL=netlify-identity-widget.js.map                'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ?
function(e) {
    return typeof e;
}:
function(e) {
