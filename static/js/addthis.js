            ...
            o &&
              ...
              ( 'follow' !== l && p.indexOf( o ) !== -1 ?
                ...
                ( ( 0, d.default )( o, 'follow' === l ? 1 : 0, s, u ),
                  t && t.fire( 'addthis.menu.' + l, n, ( 0, r.default )( {}, s, {
                    service: o,
    ...
    function ( e, t, n ) {
      ...
      e.exports = function ( e ) {
        ...
        function n( t ) {
          d[ t ] ?
            o( this, t, d[ t ] ) :
            ( c[ t ] ? c[ t ].push( this ) : ( c[ t ] = [ this ] ), e.contentWindow.postMessage( JSON.stringify( {
    ...
    function ( e, t, n ) {
      ...
      function _( e, t, a, i, o ) {
        var s,
          ...
          v = function ( e, t, n ) {
            ...
            return (
              ( a = d( e ) ? 32 : u( e ) ? 20 : 16 ),
              n && n.code ? ( ( l = _( n.code, n.icon, a ) ), ( s = p( n.code, l ) ) ) : ( s = f( {
                code: t,
                size: a + 'px'
              } ) ),
              s
            ...
            function s( e, t ) {
              ...
              if ( c.length > 0 ) {
                ...
                var o =
                  ...
                  ( i.xck ? '&xck=1' : '' ) +
                  ( _ate.dr ? '&dr=' + window.encodeURIComponent( _ate.track.mgu( _ate.dr, {
                    defrag: 1
                  } ) ) : '' ) +
              ...
              if ( !t.ost ) {
                ...
                if ( ( ( passthrough = _ate.util.toKV( r ) ), ( _ate.ufbl = 1 ), e() ) ) {
                  ...
                  ( a.src =
                    ...
                    window.encodeURIComponent( _ate.track.mgu( n.share.url, {
                      defrag: 1
                    } ) ) +
      ...
      sn.addthis && sn.addthis.timer && ( sn.addthis.timer.core = new Date().getTime() ),
        ...
        _ate._rec.push( function ( e ) {
          ...
          if (
            ( e.uid && ( ( _ate.uid = e.uid ), _ate.ed.fire( 'addthis-internal.data.uid', {}, {
                uid: e.uid
              } ) ),
      ...
      if (
        ( _adr.bindReady(),
          ...
          ( un.user = ( function () {
            ...
            function u( e ) {
              if (
                ( _ate.uud || _ate.ed.fire( 'addthis-internal.api', window.addthis || {}, {
                    call: 'rdy'
                  } ),
                  ( _ate.uud = 1 ),
