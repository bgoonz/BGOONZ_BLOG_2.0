!(function (e) {
  ...
  function (e, t, n) {
        ...
        var f = (function e(n, l, u, f, p) {
          for (
            ...
            if (
              ...
              if (
                D === H &&
                (0 < A && (B = B.replace(c, "")), 0 < B.trim().length)
              ) {
                switch (h) {
                  case 32:
                  case 9:
              ...
              switch (h) {
                case 123:
                  for (
                    d = (B = B.trim()).charCodeAt(0), m = 1, V = ++D;
                    D < F;
                  ...
                  switch (
                    ...
                    case 64:
                      switch (
                        (0 < A && (B = B.replace(c, "")), (h = B.charCodeAt(1)))
                      ) {
                        case 100:
                        case 109:
                        case 115:
                ...
                case 59:
                  if (
                    1 < (V = (B = (0 < A ? B.replace(c, "") : B).trim()).length)
                  )
                    switch (
                      (0 === R &&
                        ((d = B.charCodeAt(0)),
                      ...
                      0 < M &&
                        void 0 !==
                          (w = a(1, B, l, n, C, T, U.length, f, p, f)) &&
                        0 === (V = (B = w.trim()).length) &&
                        (B = "\0\0"),
                      (d = B.charCodeAt(0)),
                      (h = B.charCodeAt(1)),
          ...
          if (0 < (V = U.length)) {
            if (
              ((A = l),
              0 < M &&
                void 0 !== (w = a(2, U, A, n, C, T, V, f, p, f)) &&
                0 === (U = w).length)
            )
              return $ + U + W;
            if (((U = A.join(",") + "{" + U + "}"), 0 != P * j)) {
    ...
    var l = { current: null },
      ...
      d = Object(r.createContext)(
        "undefined" != typeof HTMLElement ? s() : null
      ),
      ...
      y = function (e, t, n, o) {
        ...
        "string" == typeof t.className
          ? (u = Object(c.a)(e.registered, l, t.className))
          ...
          (i.insertStyles = function () {
            if (
              (void 0 !== this.props.serialized.next &&
                Object(c.b)(this.props.cache, this.props.serialized.next, !0),
  ...
  function (e, t, n) {
    ...
    var m = function (e, t, n) {
      ...
      for (var l = 1; l < e.length; l++)
        (i += p(n, t, e[l], 46 === i.charCodeAt(i.length - 1))),
          o && (i += a[l]);
      h.lastIndex = 0;
  ...
  function (e, t, n) {
    ...
    const h = {
      fieldLabel: (0, o.css)(
        "font-size:12px;text-transform:uppercase;font-weight:600;color:",
        c.controlLabel,
        ";;label:fieldLabel;"
      ),
    };
    ...
    const g = {
      ...
      b = (0, o.css)(
        g,
        ";display:block;border-radius:",
        f.borderRadius,
        ";padding:4px 10px;text-align:center;;label:backgroundBadge;"
      ),
      y = (0, o.css)(
        g,
        ";display:inline-block;font-weight:700;text-transform:uppercase;;label:textBadge;"
      ),
      x = (0, o.css)(
        d.dropMain,
        ";border-radius:5px;background-color:#fff;;label:card;"
      ),
      w = {
        button: (0, o.css)(
        ...
        medium: {
          name: "17u3ojd-medium",
          styles:
            "height:27px;line-height:27px;font-size:12px;font-weight:600;border-radius:3px;padding:0 24px 0 14px;;label:medium;",
        },
        small: {
          name: "1ryj6xw-small",
    ...
    const k = (0, o.css)(
        "color:",
        s.white,
        ";width:0;height:0;border:5px solid transparent;border-radius:2px;;label:caret;"
      ),
      O = {
        card: x,
        caretDown: (0, o.css)(
          k,
          ";border-top:6px solid currentColor;border-bottom:0;;label:caretDown;"
        ),
        caretRight: (0, o.css)(
          k,
          ";border-left:6px solid currentColor;border-right:0;;label:caretRight;"
        ),
        badge: (0, o.css)(
          b,
          ";color:",
        ...
        badgeDanger: (0, o.css)(
          ...
          ";color:",
          s.red,
          ";background-color:#fbe0d7;;label:badgeDanger;"
        ),
        textBadge: (0, o.css)(y, ";color:", c.infoText, ";;label:textBadge;"),
        textBadgeSuccess: (0, o.css)(
          y,
          ";color:",
          c.successText,
          ";;label:textBadgeSuccess;"
        ),
        textBadgeDanger: (0, o.css)(
          y,
          ";color:",
          s.red,
          ";;label:textBadgeDanger;"
        ),
        loaderSize: {
        ...
        cardTop: (0, o.css)(
          ...
          ";width:",
          f.topCardWidth,
          ";max-width:100%;padding:18px 20px;margin-bottom:28px;;label:cardTop;"
        ),
        cardTopHeading: {
          name: "wfgyt-cardTopHeading",
          styles:
            "font-size:22px;font-weight:600;line-height:37px;margin:0;padding:0;;label:cardTopHeading;",
        },
        cardTopDescription: (0, o.css)(
          "max-width:480px;color:",
          c.text,
          ";font-size:14px;margin-top:8px;;label:cardTopDescription;"
        ),
        objectWidgetTopBarContainer: (0, o.css)(
          "padding:",
          f.objectWidgetTopBarContainerPadding,
          ";;label:objectWidgetTopBarContainer;"
        ),
        dropdownList: (0, o.css)(
          d.dropDeep,
          ";background-color:",
          s.white,
          ";border-radius:",
          f.borderRadius,
          ";overflow:hidden;;label:dropdownList;"
        ),
        ...
        viewControlsText: (0, o.css)(
          "font-size:14px;color:",
          c.text,
          ";margin-right:12px;white-space:nowrap;;label:viewControlsText;"
        ),
      };
    t.components = O;
    const S = {
      control: (e) =>
        a(
          a({}, e),
          {},
          { border: 0, boxShadow: "none", padding: "9px 0 9px 12px" }
        ),
      option: (e, t) =>
        a(
          a({}, e),
      ...
      indicatorSeparator: (e, t) =>
        t.hasValue && t.selectProps.isClearable
          ? a(a({}, e), {}, { backgroundColor: "" + c.textFieldBorder })
          : { display: "none" },
      ...
      multiValueLabel: (e) =>
        a(a({}, e), {}, { color: c.textLead, fontWeight: 500 }),
      multiValueRemove: (e) =>
        a(
          a({}, e),
          {},
      ...
      return function () {
          ...
          return Object(i.createElement)(
            ...
            function (r) {
              ...
              "string" == typeof e.className
                ? (s = Object(c.a)(t.registered, m, e.className))
        ...
        return (
          ...
          (x.withComponent = function (t, r) {
            return e(t, void 0 !== r ? v({}, n || {}, {}, r) : n).apply(
              void 0,
              g
            );
          }),
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
      ...
      (null !== o
        ...
        r || null === o
          ? (function (e) {
              return (
                !!U.call($, e) ||
                (!U.call(W, e) && (B.test(e) ? ($[e] = !0) : ((W[e] = !0), !1)))
              );
            })(t) &&
            ...
            !(function (e, t, n, r, o) {
              switch (t) {
                ...
                case "gotpointercapture":
                  return (
                    (i = o.pointerId),
                    St.set(i, _t(St.get(i) || null, e, t, n, r, o)),
                    !0
                  );
              }
              return !1;
            ...
            i
              ? (er &&
                  ...
                  (ar || i !== nr.compositionStart
                    ...
                    : ((Vn = "value" in (Nn = r) ? Nn.value : Nn.textContent),
                      (ar = !0))),
    ...
    function fr(e, t, n) {
      return (
        ((e = Wn.getPooled(cr.change, e, t, n)).type = "change"), M(n), An(e), e
      );
    }
    var pr = null,
      dr = null;
    ...
    function Vr(e, t) {
      ...
      for (r = 0; r < n.length; r++)
        if (!Nr.call(t, n[r]) || !Ar(e[n[r]], t[n[r]])) return !1;
      return !0;
    }
    ...
    function qa(e, t, n) {
      var r = t.pendingProps,
        o = r.revealOrder,
        i = r.tail;
      if ((za(e, t, r.children, n), 0 != (2 & (r = Di.current))))
              ...
              : ((n = null !== r),
                ...
                n &&
                  ...
                  0 != (1 & Di.current)
                    ? Cl === xl && (Cl = wl)
                    : ((Cl !== xl && Cl !== wl) || (Cl = kl),
                      0 !== Ml && null !== Sl && (Lu(Sl, Tl), Iu(Sl, Ml)))),
                (n || r) && (t.effectTag |= 4),
                null)
          );
        case 4:
    ...
    function Kl(e, t) {
      ...
      return (
        null !== o && (Sl === o && (au(t), Cl === kl && Lu(o, Tl)), Iu(o, t)), o
      );
    }
    function Gl(e) {
      ...
      if (0 !== n) {
        ...
        if ((mu(), (e === Sl && n === Tl) || nu(e, n), null !== El)) {
          ...
          if ((ei(), (Ol = r), (bl.current = o), 1 === Cl))
            throw ((t = jl), nu(e, n), Lu(e, n), Xl(e), t);
          if (null === El)
            switch (
    ...
    function Jl(e) {
      ...
      if ((mu(), (e === Sl && t === Tl) || nu(e, t), null !== El)) {
        ...
        if ((ei(), (Ol = n), (bl.current = r), 1 === Cl))
          throw ((n = jl), nu(e, t), Lu(e, t), Xl(e), n);
      ...
      (t.unstable_scheduleCallback = function (e, n, a) {
        ...
        return (
          ...
          u > l
            ? ((e.sortIndex = u),
              E(_, e),
              null === T(P) && e === T(_) && (D ? i() : (D = !0), o(N, u - l)))
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, d, h, m) {
      ...
      if (k && !x)
        return (
          m || (m = new r()),
          v || c(e) ? o(e, t, n, d, h, m) : i(e, t, b, n, d, h, m)
        );
      if (!(1 & n)) {
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n) {
      ...
      return f || ++s != c
        ? f
        : !!(c = null == e ? 0 : e.length) && l(c) && a(p, c) && (i(e) || o(e));
    };
  },
  function (e, t) {
    e.exports = function (e) {
  ...
  function (e, t, n) {
    ...
    var b = function (e) {
      return (0, o.jsx)(
        "svg",
        e,
        (0, o.jsx)("path", { d: "M3 15v-2h18v2H3zm0-4V9h18v2H3z" })
      );
    };
  ...
  function (e, t, n) {
    ...
    function R(e) {
      ...
      switch (o) {
        ...
        case "bottom":
          ...
          if (O >= d && !a)
            return i && _(u, S, 160), { placement: "bottom", maxHeight: t };
          if ((!a && O >= r) || (a && w >= r))
            return (
              i && _(u, S, 160),
              { placement: "bottom", maxHeight: a ? w - b : O - b }
            );
          if ("auto" === o || a) {
            var T = t,
              P = a ? x : k;
            return (
              P >= r && (T = Math.min(P - b - l.controlHeight, t)),
              { placement: "top", maxHeight: T }
            );
          }
          if ("bottom" === o)
            return j(u, S), { placement: "bottom", maxHeight: t };
          break;
        case "top":
          if (x >= d) return { placement: "top", maxHeight: t };
          if (k >= d && !a)
            return i && _(u, E, 160), { placement: "top", maxHeight: t };
          if ((!a && k >= r) || (a && x >= r)) {
            var z = t;
            return (
              ((!a && k >= r) || (a && x >= r)) && (z = a ? x - y : k - y),
              i && _(u, E, 160),
    ...
    var ye = {
      ...
      Group: function (e) {
        ...
        return Object(v.jsx)(
          ...
          Object(v.jsx)(
            i,
            a({}, l, { selectProps: c, theme: s, getStyles: o, cx: r }),
            u
          ),
      ...
      GroupHeading: function (e) {
        var t = e.className,
          ...
          l =
            (e.selectProps,
            i(e, ["className", "cx", "getStyles", "theme", "selectProps"]));
        return Object(v.jsx)(
          "div",
          a(
            {
      ...
      Placeholder: function (e) {
        ...
        return Object(v.jsx)(
          "div",
          a(
            { css: o("placeholder", e), className: r({ placeholder: !0 }, n) },
            i
          ),
          t
        );
    ...
    for (
      ...
      for (var _e = Te[Pe], ze = 0; ze < _e.letters.length; ze++)
        je[_e.letters[ze]] = _e.base;
    var Me = function (e) {
        ...
        function n(e) {
          ...
          l(this, n),
            ...
            (r.cacheComponents = function (e) {
              var t;
              r.components =
                ((t = { components: e }), be(be({}, ye), t.components));
            }),
            ...
            (r.announceAriaLiveContext = function (e) {
              ...
              r.setState({
                ariaLiveContext: rt(
                  t,
                  st(st({}, n), {}, { label: r.props["aria-label"] })
                ),
              });
            }),
                ...
                a = function (e, n) {
                  ...
                  if (
                    !(
                      ...
                      !r.filterOption({ label: l, value: u, data: e }, o)
                    )
                  ) {
                    var s = i
                        ? void 0
          ...
          r.buildMenuOptions = Ee(r.buildMenuOptions, function (e, t) {
            ...
            return (
              Y(o, i[1]) &&
              Y(r.inputValue, a.inputValue) &&
              Y(r.options, a.options)
            );
          }).bind(d(r));
          var a = e.menuIsOpen
    ...
    const jt = Object(St.default)("div", {
      ...
      zt = Object(St.default)(_t, { target: "e28231i3", label: "CaretDown" })(
        Ot.components.caretDown,
        ";color:currentColor;"
      ),
      Mt = Object(St.default)(_t, { target: "e28231i4", label: "CaretRight" })(
        Ot.components.caretRight,
        ";color:currentColor;left:2px;"
      ),
      ...
      It = (e) => {
        var t;
        return (
          (null === (t = e.children.find((e) => !e.isDir && e.title)) ||
          void 0 === t
            ? void 0
            : t.title) || e.title
        );
    ...
    class At extends o.a.Component {
      ...
      onToggle({ node: e, expanded: t }) {
        ...
        ((e, t) => {
          ...
          n.path === e.path &&
            ((!n.selected && n.expanded) || (n.expanded = t)),
            (n.selected = n.path == e.path);
        }),
      ...
      render() {
        ...
        return o.a.createElement(Rt, {
          ...
          treeData: e,
          onToggle: ({ node: e, expanded: t }) =>
            this.onToggle({ node: e, expanded: t }),
        });
      }
    }
    ...
    class Ft extends o.a.Component {
      constructor(e) {
        super(e),
          (this.state = { title: "", optionsLoaded: !1, options: [] }),
          (this.selectRef = o.a.createRef());
      }
      handleChange(e) {
      ...
      async componentDidMount() {
        if (this.isNewRecord()) {
          ...
          document
            .querySelector("[id*=title-field]")
            .addEventListener("input", (e) => {
              var t;
              const n = e.target.value;
              this.setState({ title: n });
              const r =
                (null === (t = this.selectRef.current.props.value) ||
                void 0 === t
                  ? void 0
                  : t.value) || "/";
              this.handleChange(r);
    ...
    class Ht extends o.a.Component {
      ...
      render() {
        return o.a.createElement(
          "div",
          { className: "text" },
          o.a.createElement("p", null, "File Path: " + this.getFullPath())
        );
      }
    }
    "undefined" != typeof window &&
      (window.NetlifyCmsWidgetParent = { control: Ft, preview: Ht });
  },
]);
