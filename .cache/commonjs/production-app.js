...
(0, _apiRunnerBrowser.apiRunnerAsync)(`onClientEntry`).then(() => {
    ...
    class GatsbyRoot extends _react.default.Component {
        render() {
            ...
            return /*#__PURE__*/ _react.default.createElement(_reachRouter.Location, null, ({ location }) =>
                /*#__PURE__*/ _react.default.createElement(
    ...
    class LocationHandler extends _react.default.Component {
        render() {
            return /*#__PURE__*/ _react.default.createElement(DataContext.Consumer, null, ({ pageResources, location }) =>
                /*#__PURE__*/ _react.default.createElement(
    ...
    _loader.publicLoader.loadPage(browserLoc.pathname).then((page) => {
        ...
        const renderer = (0, _apiRunnerBrowser.apiRunner)(
            ...
            undefined,
            _reactDom.default.hydrateRoot ? _reactDom.default.hydrateRoot : _reactDom.default.hydrate
        )[0];
