        ...
        function onHydrated() {
            ...
            if (process.env.GATSBY_QUERY_ON_DEMAND_LOADING_INDICATOR && process.env.GATSBY_QUERY_ON_DEMAND_LOADING_INDICATOR === `true`) {
                ...
                if (renderer === _reactDom.default.hydrateRoot) {
                    _reactDom.default
                        .createRoot(indicatorMountElement)
                        .render(/*#__PURE__*/ _react.default.createElement(_loadingIndicator.LoadingIndicatorEventHandler, null));
                } else {
                    _reactDom.default.render(
                        /*#__PURE__*/ _react.default.createElement(_loadingIndicator.LoadingIndicatorEventHandler, null),
