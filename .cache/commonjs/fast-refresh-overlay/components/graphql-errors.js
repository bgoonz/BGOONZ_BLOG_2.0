...
function WrappedAccordionItem({ error, open }) {
    ...
    const title =
        (error === null || error === void 0 ? void 0 : (_error$error = error.error) === null || _error$error === void 0 ? void 0 : _error$error.message) ||
    ...
    const columnNumber =
        error === null || error === void 0
            ...
            ? void 0
            : (_error$location2$star = _error$location2.start) === null || _error$location2$star === void 0
            ? void 0
