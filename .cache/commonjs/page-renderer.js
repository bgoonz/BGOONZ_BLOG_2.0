...
class PageRenderer extends _react.default.Component {
    render() {
        const props = {
            ...this.props,
            params: { ...(0, _findPath.grabMatchParams)(this.props.location.pathname), ...this.props.pageResources.json.pageContext.__params }
        };
        const pageElement = /*#__PURE__*/ (0, _react.createElement)(this.props.pageResources.component, {
            ...props,
