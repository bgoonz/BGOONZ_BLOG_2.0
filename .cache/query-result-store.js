...
const getPathFromProps = (props) => (props.pageResources && props.pageResources.page ? normalizePagePath(props.pageResources.page.path) : undefined);
...
export class PageQueryStore extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        return (
            ...
            this.state.pageQueryData[normalizePagePath(nextState.path)] !== nextState.pageQueryData[normalizePagePath(nextState.path)]
        );
    }
...
export class StaticQueryStore extends React.Component {
    ...
    render() {
        return <StaticQueryContext.Provider value={this.state.staticQueryData}>{this.props.children}</StaticQueryContext.Provider>;
    }
}
