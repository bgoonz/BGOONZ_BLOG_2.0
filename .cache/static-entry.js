...
const { get, merge, isObject, flatten, uniqBy, flattenDeep, replace, concat, memoize } = require(`lodash`);
...
export default (pagePath, callback) => {
    ...
    staticQueryUrls.forEach((staticQueryUrl) =>
        headComponents.push(<link as="fetch" rel="preload" key={staticQueryUrl} href={staticQueryUrl} crossOrigin="anonymous" />)
    );
