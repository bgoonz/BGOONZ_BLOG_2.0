        ...
        dangerouslySetInnerHTML={{
            __html: css`
                ...
                [data-gatsby-overlay='root'] {
                    font: 18px/1.5 -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji',
                    ...
                    box-shadow: rgba(46, 41, 51, var(--rootBoxShadowOpacity)) 0px 7px 19px 11px, rgba(71, 63, 79, var(--rootBoxShadowOpacity)) 0px 2px 4px;
                ...
                header[data-gatsby-error-type='runtime-error'] [data-gatsby-overlay='header__cause-file'] h1,
                header[data-gatsby-error-type='graphql-error'] [data-gatsby-overlay='header__cause-file'] h1 {
