...
export function AccordionItem({ children, disabled = false, open = false, title = `title`, ...rest }) {
    ...
    return (
        <li data-gatsby-overlay="accordion__item" data-accordion-active={isOpen ? `true` : `false`} {...rest}>
            <button
