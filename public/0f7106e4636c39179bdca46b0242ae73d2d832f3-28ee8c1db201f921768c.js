                    ...
                    (e.exports = (function () {
                        ...
                        function P(e, t) {
                            var n,
                                s = h({}, e);
                            for (n in t)
                                d(t, n) && (r(e[n]) && r(t[n]) ? ((s[n] = {}), h(s[n], e[n]), h(s[n], t[n])) : null != t[n] ? (s[n] = t[n]) : delete s[n]);
                                  ...
                                  (E[t] =
                                      ...
                                      (function (e) {
                                          ...
                                          for (t = 0, n = i.length; t < n; t++)
                                              I[i[t]]
                                                  ? (i[t] = I[i[t]])
                                                  : (i[t] = (s = i[t]).match(/\[[\s\S]/) ? s.replace(/^\[|\]$/g, '') : s.replace(/\\/g, ''));
                                          return function (t) {
                                              var s,
                                                  r = '';
                        ...
                        function Le(e, t, n, s, i) {
                            ...
                            return (
                                o <= 0 ? (a = ye((r = e - 1)) + o) : o > ye(e) ? ((r = e + 1), (a = o - ye(e))) : ((r = e), (a = o)), { year: r, dayOfYear: a }
                            );
                        }
                        function Ue(e, t, n) {
                            var s,
                        ...
                        function wt(e) {
                            ...
                            if (u) {
                                ...
                                if (
                                    !(function (e, t, n) {
                                        return (
                                            !e || Ve.indexOf(e) === new Date(t[0], t[1], t[2]).getDay() || ((f(n).weekdayMismatch = !0), (n._isValid = !1), !1)
                                        );
                                    })(u[1], l, e)
                                )
                                    return;
