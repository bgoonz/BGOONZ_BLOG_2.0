    ...
    return(function (e) {
        ...
        function (e, t, n) {
            ...
            function H(e) {
                ...
                return(p(o), d(u.defaultActiveItemId), o || !1 !== u.openOnFocus ? (v('loading'), (U = u.environment.setTimeout(function () {
                    ...
                    return(v('loading'), Promise.all(e.map(function (e) {
                        ...
                        v('idle'),
                        s(e);
                        var l = u.shouldPanelOpen({state: a.getState()});
                    ...
                    return R(R({}, e), {}, {items: []});
                })), f(null !== (l = r.isOpen) && void 0 !== l ? l : u.shouldPanelOpen({state: a.getState()})), Promise.resolve()));
            }
                ...
                return {
                            ...
                            onKeyDown: function (e) {
                                !(function (e) {
                                    ...
                                    if ('ArrowUp' === t.key || 'ArrowDown' === t.key) {
                                        ...
                                        t.preventDefault(),
                                        !1 === u.getState().isOpen && (n.openOnFocus || Boolean(u.getState().query)) ? H(V({
                                            event: t,
                                            props: n,
                                            ...
                                            u.dispatch(t.key, {nextActiveItemId: n.defaultActiveItemId}),
                                            a(),
                                            setTimeout(i, 0);
                                        ...
                                        if (t.metaKey || t.ctrlKey) 
                                            void 0 !== f && (p.onSelect(V({
                                                ...
                                                source: p,
                                                state: u.getState()
                                            }, o)), n.navigator.navigateNewTab({itemUrl: f, item: l, state: u.getState()}));
                                         else if (t.shiftKey) 
                                            void 0 !== f && (p.onSelect(V({
                                                event: t,
                                                item: l,
                                                ...
                                                source: p,
                                                state: u.getState()
                                            }, o)), n.navigator.navigateNewWindow({itemUrl: f, item: l, state: u.getState()}));
                                         else if (t.altKey) 
                                         else {
                                            if (void 0 !== f) 
                                                return(p.onSelect(V({
                                                    ...
                                                    source: p,
                                                    state: u.getState()
                                                }, o)), void n.navigator.navigate({itemUrl: f, item: l, state: u.getState()}));
                    ...
                    getItemProps: function (e) {
                        ...
                        return K({
                            ...
                            onClick: function (e) {
                                var a = i.getItemInputValue({item: o, state: r.getState()}),
                                    c = i.getItemUrl({item: o, state: r.getState()});
            ...
            var ue = function (e, t) {
                switch (t.type) {
                    case 'setActiveItemId':
                        return ne(ne({}, e), {}, {activeItemId: t.payload});
                    case 'setQuery':
                        return ne(ne({}, e), {}, {
                            query: t.payload,
                            completion: null
                    ...
                    case 'setCollections':
                        return ne(ne({}, e), {}, {collections: t.payload});
                    case 'setIsOpen':
                        return ne(ne({}, e), {}, {isOpen: t.payload});
                    case 'setStatus':
                        return ne(ne({}, e), {}, {status: t.payload});
                    case 'setContext':
                        return ne(ne({}, e), {}, {
                    ...
                    case 'mousemove':
                        return ne(ne({}, e), {}, {activeItemId: t.payload});
                    case 'mouseleave':
                        return ne(ne({}, e), {}, {activeItemId: t.props.defaultActiveItemId});
                    default:
            ...
            function se(e, t) {
                var n = void 0;
                return function () {
                    for (var r = arguments.length, u = new Array(r), o = 0; o < r; o++) 
                        u[o] = arguments[o];
            ...
            function De(e, t, n) {
                ...
                if ('style' === t) 
                    ...
                    for (t in n) 
                        (o && n[t] === o[t]) || ve(e.style, t, n[t]);
                    
                 else 
                    'o' === t[0] && 'n' === t[1] ? ((r = t !== (t = t.replace(/Capture$/, ''))), (u = t.toLowerCase()) in e && (t = u), (t = t.slice(2)), e._listeners || (e._listeners =
                        {}), (e._listeners[t] = n), n ? o || e.addEventListener(t, me, r) : e.removeEventListener(t, me, r)) : 'list' !== t && 'tagName' !== t && 'form' !== t && 'type' !== t && 'size' !== t && 'download' !== t && 'href' !== t && t in e ? (e[t] = null == n ? '' : n) : 'function' != typeof n && 'dangerouslySetInnerHTML' !== t && (null == n || (!1 === n && !/^ar/.test(t)) ? e.removeAttribute(t) : e.setAttribute(t, n));
            ...
            function Ue(e, t, n) {
                var r,
                    ...
                    a = {};
                for (o in t) 
                    'key' == o ? (r = t[o]) : 'ref' == o ? (u = t[o]) : (a[o] = t[o]);
            ...
            function He(e, t, n, r, u) {
                ...
                return null != Ie.vnode && Ie.vnode(o),
                o;
            }
            ...
            function Ke(e, t, n, r, u, o, i, a, c, l) {
                ...
                for (n.__k =[], s = 0; s < t.length; s++) 
                    if (null != (d = n.__k[s] = null == (d = t[s]) || 'boolean' == typeof d ? null : 'string' == typeof d || 'number' == typeof d || 'bigint' == typeof d ? He(null, d, null, null, d) : Array.isArray(d) ? He(We, {
                        ...
                        if (((d.__ = n), (d.__b = n.__b + 1), null === (p = h[s]) || (p && d.key == p.key && d.type === p.type))) 
                            h[s] = void 0;
                         else 
                            for (f = 0; f < y; f++) {
                        ...
                        null != v ? (null == m && (m = v), 'function' == typeof d.type && null != d.__k && d.__k === p.__k ? (d.__d = c = Ge(d, c, e)) : (c = Xe(e, d, p, h, v, c)), l || 'option' !== n.type ? 'function' == typeof n.type && (n.__d = c) : (e.value = '')) : c && p.__e == c && c.parentNode != e && (c = Je(p));
                    }
            ...
            function Ze(e, t, n, r, u) {
                ...
                e: if ('style' === t) 
                    ...
                    if (u) 
                     ...
                     catch (e) {}'function' == typeof n || (null != n && (!1 !== n || ('a' === t[0] && 'r' === t[1])) ? e.setAttribute(t, n) : e.removeAttribute(t));
                }
            }
            ...
            function nt(e, t, n, r, u, o, i, a, c) {
                ...
                null != n.__h && ((c = n.__h), (a = t.__e = n.__e), (t.__h = null), (o =[a])),
                (l = Ie.__b) && l(t);
                try {
                    e: if ('function' == typeof b) {
                        if (((D = t.props), (h =( l = b.contextType) && r[l.__c]), (y = l ? (h ? h.props.value : l.__) : r), n.__c ? (m =( s = t.__c = n.__c).__ = s.__E) : ('prototype' in b && b.prototype.render ? (t.__c = s = new b(D, y)) : ((t.__c = s = new Ve(D, y)), (s.constructor = b), (s.render = at)), h && h.sub(s), (s.props = D), s.state || (s.state =
                            {}), (s.context = y), (s.__n = r), (f = s.__d =! 0), (s.__h =[])), null == s.__s && (s.__s = s.state), null != b.getDerivedStateFromProps && (s.__s == s.state && (s.__s = Le({}, s.__s)), Le(s.__s, b.getDerivedStateFromProps(D, s.__s))), (p = s.props), (d = s.state), f)) 
                        ...
                        null == o && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = ut(n.__e, t, n, r, u, o, i, c));
            ...
            function ut(e, t, n, r, u, o, i, a) {
                ...
                if (null === v) 
                    ...
                    if (((function (e, t, n, r, u) {
                        var o;
                        for (o in n) 
                            'children' === o || 'key' === o || o in t || Ze(e, o, null, n[o], r);
                        
                        for (o in t) 
                            (u && 'function' != typeof t[o]) || 'children' === o || 'key' === o || 'value' === o || 'checked' === o || n[o] === t[o] || Ze(e, o, t[o], n[o], r);
            ...
            function ct(e, t, n) {
                ...
                (o =[]),
                nt(t, (e =((! r && n) || t).__k = Ue(We, null, [e])), u || Te, Te, void 0 !== t.ownerSVGElement, ! r && n ? [n] : u ? null : t.firstChild ? qe.slice.call(t.childNodes) : null, o, ! r && n ? n : u ? u.__e : t.firstChild, r),
                rt(o, e);
            }
            ...
            function lt(e, t) {
                ...
                __e: function (e, t) {
                    for (var n, r, u; (t = t.__);) 
                        if ((n = t.__c) && ! n.__) 
                            try {
                                if (((r = n.constructor) && null != r.getDerivedStateFromError && (n.setState(r.getDerivedStateFromError(e)), (u = n.__d)), null != n.componentDidCatch && (n.componentDidCatch(e), (u = n.__d)), u)) 
                                    return(n.__E = n);
            ...
            function vt(e) {
                ...
                return('string' != typeof u && (u = lt(t, r) || ''), ft({highlightedValue: u}));
            }
            var mt = {
                    '&amp;': '&',
                    '&lt;': '<',
            ...
            function wt(e) {
                ...
                return function (e) {
                    var r = e.hit,
                        ...
                        o = e.tagName,
                        i = void 0 === o ? 'mark' : o;
                    return t(n, {}, Pt({hit: r, attribute: u}).map(function (e, n) {
            ...
            function Yt(e) {
                                    ...
                                    Highlight: (
                                        ...
                                        function (e) {
                                            var t = e.hit,
                                                ...
                                                r = e.tagName,
                                                u = void 0 === r ? 'mark' : r;
                                            return C(F, {}, vt({hit: t, attribute: n}).map(function (e, t) {
                ...
                function _() {
                    ye(b.value.panel, {
                        style: m.value ? {} : Lt(
                            {panelPlacement: v.value.renderer.panelPlacement, container: b.value.root, form: b.value.form, environment: v.value.core.environment}
                        )
                    });
                }
                    ...
                    (function (e, t) {
                        ...
                        if (s.isOpen) {
                            ...
                            var p = s.collections.filter(function (e) {
                                ...
                                }, p), o('div', {className: 'aa-GradientBottom'})),
                            ...
                            c.contains(i.panel) && c.removeChild(i.panel);
                ...
                function A() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    u(),
                    (f.current = zt(v.value.renderer, v.value.core, {
                ...
                return(r(function () {
                    var e = D.value.getEnvironmentProps({formElement: b.value.form, panelElement: b.value.panel, inputElement: b.value.input});
                    return(ye(v.value.core.environment, e), function () {
                    ...
                    return(m.value && h.current.isOpen && E(!0), O(h.current), function () {
                    ...
                    return((d.current = function (t) {
                        ...
                        n.query !== r.query && v.value.core.environment.document.querySelectorAll('.aa-Panel--scrollable').forEach(function (e) {
            ...
            function _(e) {
                var t = h({
                    ...
                    n = e.queries.map(function (e) {
                        return g(g({}, e), {}, {type: 'facet'});
                    });
                return t(g(g({}, e), {}, {queries: n}));
            }
            var O = h({
                transformResponse: function (e) {
                    return e.hits;
                    ...
                    return((t = e), (n =[
                        {
                            ...
                            value: function () {
                                ...
                                if (t) {
                                    ...
                                    console.error('[algoliasearch-netlify] no element '.concat(this.options.selector, ' found'));
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return e.addAlgoliaAgent('Netlify integration '.concat(a.version)),
                                e;
                            }
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return {
                                    ...
                                    templates: {
                                        ...
                                        footer: function () {
                                            return t ? c.templates.poweredBy({hostname: window.location.host}) : '';
                                        }
                                    }
                                };
                            }
        ...
        function (e, t, n) {
            ...
            var o = n(5);
            for (var i in o) 
                ['default', 'autocomplete', 'getAlgoliaFacets', 'getAlgoliaResults'].indexOf(i) < 0 && (function (e) {
                    n.d(t, e, function () {
                        return o[e];
                    });
                })(i);
        ...
        function (e, t, n) { /*! algoliasearch-lite.umd.js | 4.10.3 | © Algolia, inc. | https://github.com/algolia/algoliasearch-client-javascript */
            e.exports = (function () {
                'use strict';
                    ...
                    return void 0 === n ? {
                        ...
                        get: function (e, r) {
                            ...
                            return n.get(e, r, u).catch(function () {
                                return a({caches: t}).get(e, r, u);
                            });
                        },
                        set: function (e, r) {
                            return n.set(e, r).catch(function () {
                                return a({caches: t}).set(e, r);
                            });
                        },
                        delete: function (e) {
                            return n.delete(e).catch(function () {
                                return a({caches: t}).delete(e);
                            });
                        },
                        clear: function () {
                            return n.clear().catch(function () {
                                return a({caches: t}).clear();
                            });
                        }
                    };
                }
                        ...
                        d = function t(n, o) {
                            ...
                            var d = {
                                ...
                                m = {
                                    ...
                                    onRetry: function (r) {
                                        var u = v(r);
                                        return(r.isTimedOut && p++, Promise.all([
                                            e.logger.info('Retryable failure', j(u)),
                                            e.hostsCache.set(s, y(s, r.isTimedOut ? h : D))
                                        ]).then(function () {
                                            return t(n, o);
                                        }));
                                    },
                                    onFail: function (e) {
                                        throw((v(e), (function (e, t) {
                                            var n = e.content,
                                                r = e.status,
                                                u = n;
                                            try {
                    ...
                    var u,
                        o = {
                            ...
                            logger: (
                                ...
                                {
                                    debug: function (e, t) {
                                        return T >= u && console.debug(e, t),
                                        Promise.resolve();
                                    },
                                    info: function (e, t) {
                                        return q >= u && console.info(e, t),
                                        Promise.resolve();
                                    },
                                    error: function (e, t) {
        ...
        function (e, t, n) {
            ...
            function u(e, t) {
                ...
                for (var o = 1; o < 7 && u < 3; ++ o) 
                    e.hierarchy['lvl'.concat(o)] && e.hierarchy['lvl'.concat(o)].length > 0 && (u > 0 && n.push(' > '), n.push(r.jsx(t.Highlight, {
                        hit: e,
            ...
            t.templates = {
                poweredBy: function (e) {
                    ...
                    return r.jsxs('div', Object.assign({
                        ...
                        children: [
                            'Search by', r.jsx('a', Object.assign({
                            ...
                            children: [
                                ...
                                r.jsxs('div', {
                                    children: [
                                        ...
                                        e.hierarchy && r.jsx('div', Object.assign({
        ...
        function (e, t, n) {
            ...
            function _(e, t, n, r, u, o, i, a, c, f) {
                ...
                for (n.__k =[], p = 0; p < t.length; p++) 
                    if (null != (y = n.__k[p] = null == (y = t[p]) || 'boolean' == typeof y ? null : 'string' == typeof y || 'number' == typeof y || 'bigint' == typeof y ? v(null, y, null, null, y) : Array.isArray(y) ? v(m, {
                        ...
                        if (((y.__ = n), (y.__b = n.__b + 1), null === (D = E[p]) || (D && y.key == D.key && y.type === D.type))) 
                            E[p] = void 0;
                         else 
                            for (d = 0; d < C; d++) {
                        ...
                        null != g ? (null == b && (b = g), 'function' == typeof y.type && null != y.__k && y.__k === D.__k ? (y.__d = c = O(y, c, e)) : (c = A(e, y, D, E, g, c)), f || 'option' !== n.type ? 'function' == typeof n.type && (n.__d = c) : (e.value = '')) : c && D.__e == c && c.parentNode != e && (c = h(D));
                    }
            ...
            function C(e, t, n, r, u) {
                ...
                e: if ('style' === t) 
                    ...
                    if (('string' == typeof r && (e.style.cssText = r = ''), r)) 
                        for (t in r) 
                            (n && t in n) || E(e.style, t, '');
                        
                    
                    if (n) 
                        for (t in n) 
                            (r && n[t] === r[t]) || E(e.style, t, n[t]);
            ...
            function j(e, t, n, r, o, i, a, c, l) {
                ...
                try {
                    e: if ('function' == typeof C) {
                        if (((b = t.props), (O =( s = C.contextType) && r[s.__c]), (A = s ? (O ? O.props.value : s.__) : r), n.__c ? (g =( f = t.__c = n.__c).__ = f.__E) : ('prototype' in C && C.prototype.render ? (t.__c = f = new C(b, A)) : ((t.__c = f = new D(b, A)), (f.constructor = C), (f.render = k)), O && O.sub(f), (f.props = b), f.state || (f.state =
                            {}), (f.context = A), (f.__n = r), (d = f.__d =! 0), (f.__h =[])), null == f.__s && (f.__s = f.state), null != C.getDerivedStateFromProps && (f.__s == f.state && (f.__s = p({}, f.__s)), p(f.__s, C.getDerivedStateFromProps(b, f.__s))), (v = f.props), (h = f.state), d)) 
                        ...
                        null == i && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = S(n.__e, t, n, r, o, i, a, l));
            ...
            function S(e, t, n, u, o, i, a, c) {
                ...
                if (null == e) {
                    ...
                    (e = o ? document.createElementNS('http://www.w3.org/2000/svg', D) : document.createElement(D, m.is && m)),
                    (i = null),
                    (c =! 1);
                }
                if (null === D) 
                    v === m || (c && e.data === m) || (e.data = m);
                 else {
                    if (((i = i && r.call(e.childNodes)), (f =( v = n.props || l).dangerouslySetInnerHTML), (p = m.dangerouslySetInnerHTML), ! c)) {
                        if (null != i) 
                            for (v =
                                {}, y = 0; y < e.attributes.length; y++) 
                    ...
                    if (((function (e, t, n, r, u) {
                        var o;
                        for (o in n) 
                            'children' === o || 'key' === o || o in t || C(e, o, null, n[o], r);
                        
                        for (o in t) 
                            (u && 'function' != typeof t[o]) || 'children' === o || 'key' === o || 'value' === o || 'checked' === o || n[o] === t[o] || C(e, o, t[o], n[o], r);
            ...
            function I(e, t, n) {
                ...
                if ((r = e.__k)) 
                    for (o = 0; o < r.length; o++) 
                        r[o] && I(r[o], t, 'function' != typeof e.type);
