...
*/
var _self = 'undefined' != typeof window ? window
            : 'undefined' != typeof WorkerGlobalScope && self instanceof
                                                             WorkerGlobalScope
                ? self
                : {},
    Prism = (function(e) {
      var n = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, t = 0, r = {}, a = {
        ...
        util : {
          encode : function e(n) {
            return n instanceof i     ? new i(n.type, e(n.content), n.alias)
            ...
            case 'Array':
              return ((i = a.util.objId(n)),
                      t[i]
                          ? t[i]
                          : ((r = []), (t[i] = r),
                             n.forEach(function(n, a) { r[a] = e(n, t); }), r));
            default:
              return n;
            }
          },
        ...
        highlightElement : function(n, t, r) {
          ...
          function u(e) {
            (s.highlightedCode = e), a.hooks.run('before-insert', s),
                ...
                a.hooks.run('after-highlight', s), a.hooks.run('complete', s),
                r && r.call(s.element);
          }
          ...
          if ((a.hooks.run('before-highlight', s), s.grammar))
            if (t && e.Worker) {
              ...
              (c.onmessage = function(e) { u(e.data); }),
        ...
        highlight : function(e, n, t) {
          ...
          if ((a.hooks.run('before-tokenize', r), !r.grammar))
            throw new Error('The language "' + r.language +
                            '" has no grammar.');
        ...
        for (var f in t)
          if (t.hasOwnProperty(f) && t[f]) {
            ...
            for (var d = 0; d < h.length; ++d) {
              if (g && g.cause == f + ',' + d)
                return;
              var v = h[d], p = v.inside, m = !!v.lookbehind, y = !!v.greedy,
                  k = v.alias;
              if (y && !v.pattern.global) {
                var x = v.pattern.toString().match(/[imsuy]*$/)[0];
                v.pattern = RegExp(v.pattern.source, x + 'g');
              }
              for (var b = v.pattern || v, w = r.next, A = s;
                ...
                if (!(E instanceof i)) {
                  ...
                  if (y) {
                    ...
                    continue;
                  S = P.index;
                  var N = P[0], _ = E.slice(0, S), M = E.slice(S + N.length),
                      W = A + E.length;
                  g && W > g.reach && (g.reach = W);
                  var z = w.prev;
                  if ((_ && ((z = u(n, z, _)), (A += _.length)), c(n, z, L),
      ...
      if (((e.Prism = a), (i.stringify = function e(n, t) {
             ...
             var i = {
               ...
               language : t
                 ...
                 l = n.alias;
             l && (Array.isArray(l) ? Array.prototype.push.apply(i.classes, l)
                                    : i.classes.push(l)),
                 a.hooks.run('wrap', i);
             var o = '';
                          ...
                          e.addEventListener('message',
                                             function(n) {
                                               var t = JSON.parse(n.data),
                                                   r = t.language, i = t.code,
                                                   l = t.immediateClose;
                                               e.postMessage(a.highlight(
                                                   i, a.languages[r], r)),
                                                   l && e.close();
                                             },
                                             !1),
...
!(function(s) {
  ...
  (s.languages.css = {
    comment : /\/\*[\s\S]*?\*\//,
    atrule : {
      pattern : RegExp('@[\\w-](?:[^;{\\s"\']|\\s+(?!\\s)|' + e.source +
                       ')*?(?:;|(?=\\s*\\{))'),
      inside : {
        rule : /^@[\w-]+/,
      ...
      if ('graphql' === n.language)
        for (var t = n.tokens.filter(function(n) {
          ...
          if ('keyword' === a.type && 'mutation' === a.content) {
            var r = [];
            if (c([ 'definition-mutation', 'punctuation' ]) &&
                '(' === l(1).content) {
              e += 2;
              var i = f(/^\($/, /^\)$/);
              if (-1 === i)
            ...
            if (c([ 'punctuation', 'property-query' ]) &&
                '{' === l(0).content &&
  ...
  (n.languages.markdown = n.languages.extend('markup', {})),
      ...
      [ 'url', 'bold', 'italic', 'strike' ].forEach(function(e) {
        ['url', 'bold', 'italic', 'strike', 'code-snippet'].forEach(function(
            t) {
          e !== t && (n.languages.markdown[e].inside.content.inside[t] =
          ...
          if (e && 'string' != typeof e)
            for (var t = 0, a = e.length; t < a; t++) {
              ...
              if ('code' === i.type) {
                ...
                if (r && o && 'code-language' === r.type &&
                    'code-block' === o.type && 'string' == typeof r.content) {
                  var l = r.content.replace(/\b#/g, 'sharp')
                              .replace(/\b\+\+/g, 'pp'),
                      s = 'language-' +
                          (l = (/[a-z][\w-]*/i.exec(l) || [ '' ])[0]
                                   .toLowerCase());
                  o.alias
                      ? ('string' == typeof o.alias ? (o.alias = [ o.alias, s ])
                                                    : o.alias.push(s))
                      : (o.alias = [ s ]);
                }
              } else
          ...
          if (p)
            ...
            (e.attributes.id = u),
                n.plugins.autoloader.loadLanguages(t, function() {
                  ...
                  e && (e.innerHTML =
                            n.highlight(e.textContent, n.languages[t], t));
                });
          }
        }
      });
          ...
          !(function c(i) {
            for (var u = 0; u < i.length && !(r >= o.length); u++) {
              ...
              if ('string' == typeof g ||
                ...
                var l = o[r], s = t.tokenStack[l],
                    f = 'string' == typeof g ? g : g.content, p = n(a, l),
                    k = f.indexOf(p);
                if (k > -1) {
                  ++r;
                  var m = f.substring(0, k),
                      d = new e.Token(a, e.tokenize(s, t.grammar),
                                      'language-' + a, s),
                      h = f.substring(k + p.length), v = [];
                  m && v.push.apply(v, c([ m ])), v.push(d),
...
!(function(e) {
  ...
  e.languages.php = {
    ...
    keyword : [
      ...
      {pattern : /(\byield\s+)from\b/i, lookbehind : !0}, /\bclass\b/i, {
        pattern :
    ...
    'argument-name' :
        {pattern : /([(,]\s*)\b[a-z_]\w*(?=\s*:(?!:))/i, lookbehind : !0},
    'class-name' : [
      {
        pattern :
...
!(function(e) {
  ...
  for (var t =
               [
                 ...
                 {filter : 'coffee', language : 'coffeescript'}, 'ejs',
                 'handlebars', 'less', 'livescript', 'markdown',
                 {filter : 'sass', language : 'scss'}, 'stylus'
               ],
           n = {}, a = 0, i = t.length;
       a < i; a++) {
    var r = t[a];
    (r = 'string' == typeof r ? {filter : r, language : r} : r),
        e.languages[r.language] && (n['filter-' + r.filter] = {
          pattern : RegExp(
              '(^([\t ]*)):<filter_name>(?:(?:\r?\n|\r(?!\n))(?:\\2[\t ].+|\\s*?(?=\r?\n|\r)))+'
                  .replace('<filter_name>', function() { return r.filter; }),
              'm'),
          lookbehind : !0,
          inside : {
            'filter-name' : {pattern : /^:[\w-]+/, alias : 'variable'},
...
(Prism.languages.python = {
  ...
  function :
      {pattern : /((?:^|\s)def[ \t]+)[a-zA-Z_]\w*(?=\s*\()/g, lookbehind : !0},
...
!(function(a) {
  ...
  a.languages.regex = {
    'char-class' : {
      ...
      inside : {
        'char-class-negation' :
            {pattern : /(^\[)\^/, lookbehind : !0, alias : 'operator'},
...
!(function(e) {
  var n = /[*&][^\s[\]{},]+/,
      ...
      t = '(?:' + r.source + '(?:[ \t]+' + n.source + ')?|' + n.source +
          '(?:[ \t]+' + r.source + ')?)',
      a = '(?:[^\\s\\x00-\\x08\\x0e-\\x1f!"#%&\'*,\\-:>?@[\\]`{|}\\x7f-\\x84\\x86-\\x9f\\ud800-\\udfff\\ufffe\\uffff]|[?:-]<PLAIN>)(?:[ \t]*(?:(?![#:])<PLAIN>|:<PLAIN>))*'
              .replace(
                  /<PLAIN>/g,
                  function() {
  ...
  function o(e, n) {
    ...
    var r =
        '([:\\-,[{]\\s*(?:\\s<<prop>>[ \t]+)?)(?:<<value>>)(?=[ \t]*(?:$|,|\\]|\\}|(?:[\r\n]\\s*)?#))'
            .replace(/<<prop>>/g, function() { return t; })
            .replace(/<<value>>/g, function() { return e; });
    return RegExp(r, n);
  }
  (e.languages.yaml = {
    scalar : {
    ...
    directive :
        {pattern : /(^[ \t]*)%.+/m, lookbehind : !0, alias : 'important'},
    datetime : {
      pattern : o(
    ...
    boolean :
        {pattern : o('false|true', 'i'), lookbehind : !0, alias : 'important'},
    ...
    (Prism.plugins.autolinker = {
      processGrammar : function(r) {
        ...
        Prism.hooks.add(
            'before-highlight',
            function(
                i) { Prism.plugins.autolinker.processGrammar(i.grammar); }),
  ...
  if ('undefined' != typeof Prism && 'undefined' != typeof document) {
    ...
    var a = (Prism.plugins.toolbar.registerButton = function(n, a) {
      ...
      (r =
          ...
          if (r && /pre/i.test(r.nodeName) &&
              !r.parentNode.classList.contains('code-toolbar')) {
            var o = document.createElement('div');
            o.classList.add('code-toolbar'), r.parentNode.insertBefore(o, r),
                o.appendChild(r);
            ...
            d && (l = d.map(function(e) { return t[e] || n; })),
                l.forEach(function(e) {
                  var t = e(a);
                  if (t) {
                    var n = document.createElement('div');
                    n.classList.add('toolbar-item'), n.appendChild(t),
                        i.appendChild(n);
                  }
                }),
                o.appendChild(i);
    ...
    if (Prism.plugins.toolbar) {
      ...
      Prism.plugins.toolbar.registerButton('show-language', function(a) {
        ...
        if (t && /pre/i.test(t.nodeName)) {
          var o, s = t.getAttribute('data-language') || e[a.language] ||
                     ((o = a.language)
...
!(function() {
  function t(t) {
    ...
    (e.value = t.getText()), (e.style.top = '0'), (e.style.left = '0'),
        (e.style.position = 'fixed'), document.body.appendChild(e), e.focus(),
        e.select();
    try {
      var o = document.execCommand('copy');
      setTimeout(function() { o ? t.success() : t.error(); }, 1);
    } catch (e) {
      setTimeout(function() { t.error(e); }, 1);
    }
      ...
      (Prism.plugins.toolbar
           ? Prism.plugins.toolbar.registerButton(
                 ...
                 function(e) {
                   ...
                   var r = document.createElement('span');
                   return (
                       c.appendChild(r), u('copy'), (function(e, o) {
                         e.addEventListener('click', function() {
                           !(function(e) {
                             navigator.clipboard
                                 ? navigator.clipboard.writeText(e.getText())
                                       .then(e.success, function() { t(e); })
                                 : t(e);
                           })(o);
                         });
                       })(c, {
                         getText : function() { return o.textContent; },
                         success : function() { u('copy-success'), i(); },
                         error : function() {
                   ...
                   function i() {
                     setTimeout(function() { u('copy'); }, n['copy-timeout']);
                   }
    ...
    Prism.plugins.toolbar.registerButton('download-file', function(t) {
      ...
      if (e && /pre/i.test(e.nodeName) && e.hasAttribute('data-src') &&
        ...
        return (a.textContent =
               ...
               a.setAttribute('download', ''), (a.href = n), a;
      }
    });
     ...
     Prism.hooks.add('wrap', function(e) {
       if ('treeview' === e.language && 'entry-name' === e.type) {
         ...
         if (n.test(e.content))
           ...
           for (var a = e.content.toLowerCase().replace(/\s+/g, '').split('.');
                a.length > 1;) {
