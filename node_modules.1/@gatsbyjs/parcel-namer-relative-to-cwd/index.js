...
var _default = new _plugin.Namer({
  async name(opts) {
    ...
    if (relativePathFromDefaultNamer) {
      ...
      const sourceRelativeToRoot = path.posix.relative(root, (0, _gatsbyCoreUtils.slash)(path.dirname(mainEntry.filePath))); // newPath will be output relative to "distDir".
