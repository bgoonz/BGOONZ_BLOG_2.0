...
export declare type ObjectTypeComposerRelationOpts<TRelationSource, TSource, TContext, TArgs = any> = ObjectTypeComposerRelationOptsWithResolver<TRelationSource, TSource, TContext, TArgs> | ObjectTypeComposerFieldConfigAsObjectDefinition<TSource, TContext, TArgs>;
export declare type ObjectTypeComposerRelationOptsWithResolver<TRelationSource, TSource, TContext, TArgs = any> = {
...
export declare class ObjectTypeComposer<TSource = any, TContext = any> {
    ...
    addRelation<TArgs = any>(fieldName: string, opts: Readonly<ObjectTypeComposerRelationOpts<any, TSource, TContext, TArgs>>): this;
