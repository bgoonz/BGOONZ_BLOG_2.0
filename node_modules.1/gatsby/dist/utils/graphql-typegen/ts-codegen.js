...
async function writeTypeScriptTypes(directory, schema, definitions) {
  const pluginConfig = {
    pluginMap: {
  ...
  const filename = (0, _path.join)(directory, OUTPUT_PATH);
  ...
  const documents = [...(0, _utils.filterTargetDefinitions)(definitions).values()].map(definitionMeta => {
    return {
      document: {
