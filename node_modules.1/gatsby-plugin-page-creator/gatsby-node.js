...
function _createPagesStatefully() {
  _createPagesStatefully = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref, _ref2, doneCb) {
    var store, actions, reporter, graphql, pagesPath, _ref2$pathCheck, pathCheck, ignore, slugifyOptions, deletePage, _store$getState, program, config, _config$trailingSlash, trailingSlash, exts, pagesDirectory, pagesGlob, files, knownFiles;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _store$getState = store.getState(), program = _store$getState.program, config = _store$getState.config;
            _config$trailingSlash = config.trailingSlash, trailingSlash = _config$trailingSlash === void 0 ? "legacy" : _config$trailingSlash;
...
function setFieldsOnGraphQLNodeType(_ref3, _ref4) {
  ...
  try {
    ...
    var _store$getState$confi = store.getState().config.trailingSlash,
        trailingSlash = _store$getState$confi === void 0 ? "legacy" : _store$getState$confi;
        ...
        gatsbyPath: {
          ...
          resolve: function resolve(source, _ref5) {
            ...
            var _derivePath = (0, _derivePath2.derivePath)(filePath, sourceCopy, reporter, slugifyOptions),
                derivedPath = _derivePath.derivedPath; // TODO(v5): Remove legacy handling


            var isLegacy = trailingSlash === "legacy";
            var hasTrailingSlash = derivedPath.endsWith("/");
            var path = (0, _gatsbyPageUtils.createPath)(derivedPath, isLegacy || hasTrailingSlash, true);
