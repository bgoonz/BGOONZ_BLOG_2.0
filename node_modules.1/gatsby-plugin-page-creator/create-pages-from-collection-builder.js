...
function createPagesFromCollectionBuilder(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
  return _createPagesFromCollectionBuilder.apply(this, arguments);
}

function _createPagesFromCollectionBuilder() {
  _createPagesFromCollectionBuilder = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(filePath, absolutePath, actions, graphql, reporter, trailingSlash, slugifyOptions) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _watchCollectionBuilder.watchCollectionBuilder)(absolutePath, "", [], actions, reporter, function () {
              return createPagesFromCollectionBuilder(filePath, absolutePath, actions, graphql, reporter, trailingSlash, slugifyOptions);
            });
          ...
          case 16:
            ...
            nodes.forEach(function (node) {
              ...
              var _derivePath = (0, _derivePath2.derivePath)(filePath, node, reporter, slugifyOptions),
                  ...
                  errors = _derivePath.errors; // TODO(v5): Remove legacy handling


              var isLegacy = trailingSlash === "legacy";
              var hasTrailingSlash = derivedPath.endsWith("/");
              var path = (0, _gatsbyPageUtils.createPath)(derivedPath, isLegacy || hasTrailingSlash, true); // We've already created a page with this path
              ...
              var modifiedPath = (0, _gatsbyPageUtils.applyTrailingSlashOption)(path, trailingSlash);
              actions.createPage({
                path: modifiedPath,
                matchPath: matchPath,
