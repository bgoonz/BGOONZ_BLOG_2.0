...
exports.addImageRoutes = exports.polyfillImageServiceDevRoutes = void 0;
...
function getRemoteFileFields(enums, actions) {
  return {
    id: `ID!`,
    mimeType: `String!`,
    filename: `String!`,
    ...
    width: `Int`,
    height: `Int`,
    publicUrl: (0, _publicUrlResolver.generatePublicUrlFieldConfig)(actions),
    resize: (0, _resizeResolver.generateResizeFieldConfig)(enums, actions),
    gatsbyImage: (0, _gatsbyImageResolver.generateGatsbyImageFieldConfig)(enums, actions)
  };
}
...
function addRemoteFilePolyfillInterface(type, {
  ...
  if (!enums) {
    ...
    types.push(schema.buildObjectType({
      ...
      name: `RemoteFile`,
      fields: getRemoteFileFields(enums, actions)
    }));
