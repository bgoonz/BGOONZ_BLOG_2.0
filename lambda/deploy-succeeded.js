    ...
    ((e) => {
        ...
        function(e, _t, r) {
            ...
            function c(e, t) {
                if (null != e)
                    if (('object' != typeof e && (e = [e]), s(e)))
                        for (r = 0, n = e.length, void 0; r < n; r++) {
                            var r;
                            var n;
                            t.call(null, e[r], r, e);
                        }
            ...
            e.exports = {
                ...
                merge: function e() {
                    ...
                    for (n = 0, o = arguments.length, void 0; n < o; n++) {
                        var n;
                        var o;
                        c(arguments[n], r);
                    }
        ...
        e => {
            ...
            e.exports = function(e, t) {
                return function() {
                    for (r = new Array(arguments.length), n = 0, void 0; n < r.length; n++) {
                        var r;
                        var n;
                        r[n] = arguments[n];
                    }
                ...
                _processResponse(e) {
                    ...
                    if (t && !1 !== this._options.followRedirects && e.statusCode >= 300 && e.statusCode < 400) {
                        if (++this._redirectCount > this._options.maxRedirects)
                            return void this.emit('error', new Error('Max redirects exceeded.'));
                        var r;
                        var o = this._options.headers;
                        if (307 !== e.statusCode && !(this._options.method in c))
                            for (r in ((this._options.method = 'GET'), (this._requestBodyBuffers = []), o))
                                /^content-/i.test(r) && delete o[r];
                        if (!this._isRedirect)
                            for (r in o)
                                /^host$/i.test(r) && delete o[r];
            ...
            function n(e) {
                ...
                function n() {
                    if (n.enabled) {
                        ...
                        for (i = new Array(arguments.length), a = 0, void 0; a < i.length; a++) {
                            var i;
                            var a;
                            i[a] = arguments[a];
                        }
        ...
        function(e, _t, r) {
            ...
            e.exports = function(e) {
                return new Promise(function(t, f) {
                    ...
                    if ((d.open(e.method.toUpperCase(), s(g, e.params, e.paramsSerializer), !0),
                            (d.timeout = e.timeout),
                        ...
                        var v = r(30);
                        var C = (e.withCredentials || u(g)) && e.xsrfCookieName ? v.read(e.xsrfCookieName) : void 0;
            ...
            e.exports = n.isStandardBrowserEnv() ?
                (function() {
                    ...
                    function s(e) {
                        ...
                        return t && (r.setAttribute('href', n), (n = r.href)),
                ...
                return new Promise(function(t, r) {
                    ...
                    if ((b['User-Agent'] || b['user-agent'] || (b['User-Agent'] = 'axios/' + d.version), y && !n.isStream(y))) {
                        ...
                        ;
                            ...
                            if (!n.isString(y))
                                return C(h('Data after transformation must be a string, an ArrayBuffer, a Buffer, or a Stream', e));
                    ...
                    var F = g.test(O);
                    var _ = F ? e.httpsAgent : e.httpAgent;
                    ...
                    if (!S && !1 !== S) {
                        ...
                        var T = process.env[B] || process.env[B.toUpperCase()];
                        if (T) {
                            var k = p.parse(T);
                            var N = process.env.no_proxy || process.env.NO_PROXY;
                            var q = !0;
                            if (N)
                                q = !N.split(',')
                                .map(function(e) {
        ...
        function(e, t, r) {
            ...
            ((t = e.exports = r(13)).init = function(e) {
                e.inspectOpts = {};
                for (r = Object.keys(t.inspectOpts), n = 0, void 0; n < r.length; n++) {
                    var r;
                    var n;
            ...
            (t.formatArgs = function(e) {
                ...
                if (this.useColors) {
                    ...
                    e[0] = (t.inspectOpts.hideDate ? '' : new Date().toISOString() + ' ') + r + ' ' + e[0];
            }),
            (t.save = function(e) {
            ...
            function a(e) {
                return (function(e) {
                    ...
                    (function(e) {
                        ...
                        if ('CI' in s)
                            return ['TRAVIS', 'CIRCLECI', 'APPVEYOR', 'GITLAB_CI'].some((e) => e in s) || 'codeship' === s.CI_NAME ? 1 : t;
                        if ('TEAMCITY_VERSION' in s)
                            return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(s.TEAMCITY_VERSION) ? 1 : 0;
                        if ('truecolor' === s.COLORTERM)
                            return 3;
